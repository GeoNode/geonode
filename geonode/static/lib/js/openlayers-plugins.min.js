...
(function(root, factory) {
    ...
    function Ba(a) {
        for (var b = Ca(), c = 0, d = a.length; c < d; ++c) Da(b, a[c]);
        return b;
    }
    function Ea(a, b, c) {
    ...
    function eb(a, b, c) {
        c = c ? c : Ca();
        fb(a, b) && (c[0] = a[0] > b[0] ? a[0] : b[0], c[1] = a[1] > b[1] ? a[1] : b[1], 
        ...
        switch (e) {
          ...
          case "MultiPolygon":
            ...
            for (e = b.length; a < e; ++a) {
                var g = b[a];
                var h = 0;
                for (f = g.length; h < f; ++h) c += rb(g[h], d);
            }
            break;
          ...
          case "GeometryCollection":
            d = a.td();
            a = 0;
            for (e = d.length; a < e; ++a) c += qb(d[a], b);
            break;
    ...
    function rb(a, b) {
        for (var c = 0, d = 0, e = a.length; d < e - 1; ++d) c += pb(a[d], a[d + 1], b);
        return c;
    }
    function pb(a, b, c) {
        var d = ua(a[1]), e = ua(b[1]), f = (e - d) / 2;
        a = ua(b[0] - a[0]) / 2;
        ...
        switch (e) {
          ...
          case "MultiPolygon":
            ...
            for (e = b.length; a < e; ++a) {
                ...
                c += Math.abs(ob(g[0], d));
                var h = 1;
                for (f = g.length; h < f; ++h) c -= Math.abs(ob(g[h], d));
            }
            break;
    ...
    function vb(a) {
        ...
        var b = a.code, c = ub || window.proj4;
    ...
    v(wb, vb);
    var zb = 6378137 * Math.PI, xb = [ -zb, -zb, zb, zb ], yb = [ -180, -85, 180, 85 ], Ab = [ new wb("EPSG:3857"), new wb("EPSG:102100"), new wb("EPSG:102113"), new wb("EPSG:900913"), new wb("urn:ogc:def:crs:EPSG:6.18:3:3857"), new wb("urn:ogc:def:crs:EPSG::3857"), new wb("http://www.opengis.net/gml/srs/epsg.xml#3857") ];
    function Bb(a, b, c) {
        var d = a.length;
        c = 1 < c ? c : 2;
    ...
    function Cb(a, b, c) {
        ...
        c = 1 < c ? c : 2;
        void 0 === b && (2 < c ? b = a.slice() : b = Array(d));
        for (var e = 0; e < d; e += c) b[e] = 180 * a[e] / zb, b[e + 1] = 360 * Math.atan(Math.exp(a[e + 1] / 6378137)) / Math.PI - 90;
        return b;
    }
    function Db(a, b) {
        vb.call(this, {
    ...
    function Mb(a, b, c, d) {
        a = Nb(a);
        var e = a.j;
        e ? b = e(b, c) : "degrees" == a.a && !d || "degrees" == d || (e = Ob(a, Nb("EPSG:4326")), 
        b = [ c[0] - b / 2, c[1], c[0] + b / 2, c[1], c[0], c[1] - b / 2, c[0], c[1] + b / 2 ], 
        b = e(b, b, 2), b = (Lb.b(b.slice(0, 2), b.slice(2, 4)) + Lb.b(b.slice(4, 6), b.slice(6, 8))) / 2, 
        a = d ? tb[d] : a.Wc(), void 0 !== a && (b /= a));
        return b;
    }
    function Pb(a) {
        a.forEach(Qb);
    ...
    function Nb(a) {
        var b = null;
        if (a instanceof vb) b = a; else if ("string" === typeof a && (b = Hb[a] || null, 
        !b)) {
    ...
    function Ob(a, b) {
        var c = a.ub, d = b.ub, e = Kb(c, d);
        if (!e) {
            var f = ub || window.proj4;
            if ("function" == typeof f) {
                var g = f.defs(c), h = f.defs(d);
                void 0 !== g && void 0 !== h && (g === h ? Pb([ b, a ]) : (e = f(d, c), Ub(b, a, e.forward, e.inverse)), 
                e = Kb(c, d));
            }
        }
        e || (e = Yb);
    ...
    function qc(a) {
        ...
        na(!this.g && this.c || this.g && !this.c, 18);
        this.i = null;
    ...
    function vc(a, b, c, d) {
        if (b[0] < a.maxZoom) {
            if (2 === a.l) return a = 2 * b[1], b = 2 * b[2], ja(a, a + 1, b, b + 1, c);
            d = a.La(b, d);
    ...
    function yc(a, b) {
        var c = a.Gc(b[0]), d = a.Sa(b[0]);
        a = Aa(a.Za(b[0]), a.f);
        return [ c[0] + (b[1] + .5) * a[0] * d, c[1] + (b[2] + .5) * a[1] * d ];
    }
    k.La = function(a, b) {
        var c = this.Gc(a[0]), d = this.Sa(a[0]), e = Aa(this.Za(a[0]), this.f), f = c[0] + a[1] * e[0] * d;
        a = c[1] + a[2] * e[1] * d;
    ...
    k.Ke = function(a, b, c) {
        var d = a[0], e = a[1];
        a = this.Bc(b);
        var f = b / this.Sa(a), g = this.Gc(a), h = Aa(this.Za(a), this.f);
    ...
    function Hc(a, b, c, d) {
        for (var e, f = 0, g = a.length; f < g; ++f) if (e = a[f], e.listener === b && e.Ah === c) return d && (e.deleteIndex = f), 
        e;
    }
    function Ic(a, b) {
    ...
    function Kc(a, b) {
        var c = Ic(a, b);
        if (c) {
            for (var d = 0, e = c.length; d < e; ++d) a.removeEventListener(b, c[d].Bh), kb(c[d]);
            c.length = 0;
            if (c = a.mb) delete c[b], 0 === Object.keys(c).length && delete a.mb;
        }
    }
    ...
    Sc.prototype.b = function(a) {
        ...
        if (c) {
            ...
            ++this.qa[a];
            for (var d = 0, e = c.length; d < e; ++d) if (!1 === c[d].call(this, b) || b.Jp) {
                var f = !1;
                break;
            }
            --this.qa[a];
    ...
    Sc.prototype.removeEventListener = function(a, b) {
        var c = this.oa[a];
        c && (b = c.indexOf(b), a in this.Va ? (c[b] = da, ++this.Va[a]) : (c.splice(b, 1), 
    ...
    k.jq = function(a, b) {
        var c = this.jc();
        if (a < c) this.c && $c(this, b, a), c = this.a[a], this.a[a] = b, this.b(new cd("remove", c)), 
        this.b(new cd("add", b)); else {
            for (;c < a; ++c) this.Qe(c, void 0);
            this.Qe(a, b);
        }
    };
    function ad(a) {
    ...
    k.Fq = function(a) {
        ...
        if (d >= b.length) {
            ...
            for (f = 0; f < e.length; ++f) this.Mf(a, e[f]);
        }
    ...
    k.Fm = function(a, b) {
        ...
        if (c) {
            ...
            b.target ? (Id(this.b, d, a), Hd(this.b, b, a)) : (b.target = e, b.relatedTarget = null, 
            this.Mf(a, b)));
            c.out = b;
            c.mj = b.target;
        }
    ...
    function Xd(a) {
        ...
        this.i = {};
        this.a = [];
        td ? Yd(this, new Md(this)) : ud ? Yd(this, new Jd(this)) : (a = new Cd(this), Yd(this, a), 
    ...
    k.$h = function(a) {
        ...
        0 === this.P && (this.i.forEach(Gc), this.i.length = 0, this.l = !1, this.c = null, 
        Pc(this.a), this.a = null);
    };
    k.gm = function(a) {
        ee(this, a);
    ...
    ge.prototype.i = function(a) {
        ...
        var b = this.s(a);
        return Infinity != b ? (this.b.push(a), this.g.push(b), this.a[this.c(a)] = !0, 
        je(this, 0, this.b.length - 1), !0) : !1;
    };
    function ie(a, b) {
    ...
    le.prototype.l = function(a) {
        a = a.target;
        var b = a.getState();
        if (2 === b || 3 === b || 4 === b || 5 === b) Mc(a, "change", this.l, this), a = a.ib(), 
        a in this.f && (delete this.f[a], --this.j), this.v();
    };
    function me(a, b, c) {
        for (var d = 0, e = !1, f, g, h; a.j < b && d < c && 0 < a.b.length; ) g = he(a)[0], 
        h = g.ib(), f = g.getState(), 5 === f ? e = !0 : 0 !== f || h in a.f || (a.f[h] = !0, 
        ++a.j, ++d, g.load());
        0 === d && e && a.v();
    }
    function ne(a) {
        return function(b) {
            if (b) return [ oa(b[0], a[0], a[2]), oa(b[1], a[1], a[3]) ];
        };
    }
    function oe(a) {
        return a;
    ...
    function pe(a) {
        return function(b, c, d) {
            if (void 0 !== b) return b = dc(a, b, d), b = oa(b + c, 0, a.length - 1), c = Math.floor(b), 
    ...
    function nf(a, b, c, d, e, f, g) {
        ...
        if (0 !== m || 0 !== n) if (f = ((e - h) * m + (f - l) * n) / (m * m + n * n), 1 < f) b = c; else if (0 < f) {
            for (e = 0; e < d; ++e) g[e] = wa(a[b + e], a[c + e], f);
            g.length = d;
            return;
        }
    ...
    function uf(a, b, c, d, e, f, g, h, l, m, n) {
        ...
        for (var q = n ? n : [ NaN, NaN ], r = b + d; r < c; ) if (nf(a, r - d, r, d, g, h, q), 
        p = ta(g, h, q[0], q[1]), p < m) {
            m = p;
    ...
    function yf(a, b, c, d, e) {
        ...
        var f = 0, g;
        var h = 0;
        for (g = c.length; h < g; ++h) b = xf(a, b, c[h], d), e[f++] = b;
        e.length = f;
        return e;
    }
    ...
    function Cf(a, b, c, d, e, f, g) {
        ...
        for (var m = 0, n; 0 < c.length; ) {
            var p = c.pop(), q = c.pop(), r = 0, u = a[q], x = a[q + 1], C = a[p], z = a[p + 1];
            for (n = q + d; n < p; n += d) {
    ...
    function Df(a, b, c, d, e, f, g, h) {
        ...
        for (l = c.length; m < l; ++m) {
            var n = c[m];
            a: {
                var p = a, q = n, r = d, u = e, x = f, C = g;
                if (b != q) {
                    var z = u * Math.round(p[b] / u), E = u * Math.round(p[b + 1] / u);
                    b += r;
                    x[C++] = z;
                    x[C++] = E;
                    do {
                    ...
                    for (;b < q; ) {
                        ...
                        b += r;
                        if (ya != V || fa != g) {
                            var pa = V - z, Ja = g - E, ma = ya - z, Sa = fa - E;
                            pa * Sa == Ja * ma && (0 > pa && ma < pa || pa == ma || 0 < pa && ma > pa) && (0 > Ja && Sa < Ja || Ja == Sa || 0 < Ja && Sa > Ja) || (x[C++] = V, 
                            x[C++] = g, z = V, E = g);
                            V = ya;
                            g = fa;
                        }
    ...
    k.Nb = function(a, b, c, d) {
        if (d < Ga(this.C(), a, b)) return d;
        this.c != this.g && (this.j = Math.sqrt(qf(this.A, 0, this.A.length, this.a, 0)), 
        this.c = this.g);
    ...
    k.$a = function() {};
    k.na = function(a, b) {
        a ? (kf(this, b, a, 1), this.A || (this.A = []), this.A.length = xf(this.A, 0, a, this.a), 
        this.u()) : Ff(this, "XY", null);
    };
    function Ff(a, b, c) {
        jf(a, b, c);
        a.u();
    ...
    k.na = function(a, b) {
        a ? (kf(this, b, a, 0), this.A || (this.A = []), this.A.length = wf(this.A, a), 
    ...
    function If(a, b, c, d, e, f) {
        if (0 === c.length || !Hf(a, b, c[0], d, e, f)) return !1;
        var g;
        b = 1;
        for (g = c.length; b < g; ++b) if (Hf(a, c[b - 1], c[b], d, e, f)) return !1;
        return !0;
    }
    ...
    function Mf(a, b, c, d, e) {
        var f = c[0];
        if (!(Lf(a, b, f, d, e) || Hf(a, b, f, d, e[0], e[1]) || Hf(a, b, f, d, e[0], e[3]) || Hf(a, b, f, d, e[2], e[1]) || Hf(a, b, f, d, e[2], e[3]))) return !1;
        if (1 === c.length) return !0;
        b = 1;
        for (f = c.length; b < f; ++b) if (Gf(a, c[b - 1], c[b], d, e)) return !1;
        return !0;
    }
    function Nf(a, b, c, d) {
        for (var e = 0, f = a[c - d], g = a[c - d + 1]; b < c; b += d) {
    ...
    function Qf(a, b, c, d) {
        var e = 0, f;
        var g = 0;
        for (f = b.length; g < f; ++g) e = Pf(a, e, b[g], c, d);
        return e;
    }
    function D(a, b) {
        gf.call(this);
    ...
    k.na = function(a, b) {
        a ? (kf(this, b, a, 2), this.A || (this.A = []), a = yf(this.A, 0, a, this.a, this.c), 
        this.A.length = 0 === a.length ? 0 : a[a.length - 1], this.u()) : this.ba("XY", null, this.c);
    };
    k.ba = function(a, b, c) {
        jf(this, a, b);
        this.c = c;
    ...
    function Rf(a, b, c, d) {
        ...
        d = [];
        var f;
        for (f = 0; f < e; ++f) ec(d, a.offset(b, c, 2 * Math.PI * f / e));
        d.push(d[0], d[1]);
        a = new D(null);
        a.ba("XY", d, [ d.length ]);
        return a;
    ...
    function Xf(a, b, c, d) {
        var e = a.da(), f = a.ja, g = a.pa(), h = a.ob(), l = e.length / g - 1;
        d = d ? d : 0;
        for (var m, n, p = 0; p <= l; ++p) n = p * g, m = d + 2 * va(p, l) * Math.PI / l, 
    ...
    function Yf(a, b) {
        ...
        if (void 0 !== b.resolutions) {
            ...
            g = Tb(b.projection);
            h = g.C();
            var l = (h ? Math.max(ab(h), bb(h)) : 360 * tb.degrees / g.Wc()) / 256 / Math.pow(2, 0), m = l / Math.pow(2, 28);
            g = b.maxResolution;
        ...
        d = void 0 === d || !0 === d ? we() : !1 === d ? te : "number" === typeof d ? ve(d) : te) : d = re;
        a.j = {
    ...
    k.animate = function(a) {
        ...
        if ($f(this)) {
            for (var d = Date.now(), e = this.wa().slice(), f = this.Qa(), g = this.Ra(), h = [], l = 0; l < b; ++l) {
                ...
                void 0 !== m.zoom ? (n.je = f, n.jd = this.constrainResolution(this.a, m.zoom - this.s, 0), 
                f = n.jd) : m.resolution && (n.je = f, n.jd = m.resolution, f = n.jd);
                void 0 !== m.rotation && (n.Bf = g, n.me = g + (va(m.rotation - g + Math.PI, 2 * Math.PI) - Math.PI), 
                g = n.me);
                n.callback = c;
            ...
            ag(this, 0, 1);
            this.Df();
        } else b = arguments[b - 1], b.center && this.tb(b.center), void 0 !== b.zoom && this.Oj(b.zoom), 
        void 0 !== b.rotation && this.ae(b.rotation), c && c(!0);
    };
    k.zc = function() {
        return 0 < this.i[0];
    };
            ...
            for (var a = Date.now(), b = !1, c = this.c.length - 1; 0 <= c; --c) {
                for (var d = this.c[c], e = !0, f = 0, g = d.length; f < g; ++f) {
                    ...
                    if (!h.complete) {
                        ...
                        b = h.easing(b);
                        if (h.he) {
                            var l = h.he[0], m = h.he[1];
                            this.set("center", [ l + b * (h.le[0] - l), m + b * (h.le[1] - m) ]);
                        }
                        h.je && h.jd && (l = 1 === b ? h.jd : h.je + b * (h.jd - h.je), h.anchor && this.set("center", bg(this, l, h.anchor)), 
                        this.set("resolution", l));
                        void 0 !== h.Bf && void 0 !== h.me && (b = 1 === b ? va(h.me + Math.PI, 2 * Math.PI) - Math.PI : h.Bf + b * (h.me - h.Bf), 
                        h.anchor && this.set("center", cg(this, b, h.anchor)), this.set("rotation", b));
                        b = !0;
                        if (!h.complete) break;
                    }
                }
    ...
    function eg(a) {
        var b = a.a, c = Math.log(b / a.f) / Math.log(2);
        return function(a) {
    ...
    k.getState = function() {
        var a = this.wa(), b = this.v, c = this.Qa(), d = this.Ra();
        return {
            center: a.slice(),
    ...
    k.Sf = function(a, b) {
        ...
        var c = b.size;
        c || (c = dg(this));
        if (a instanceof gf) if ("Circle" === a.T()) {
            a = a.C();
            var d = Sf(a);
            d.rotate(this.Ra(), cb(a));
        } else d = a; else na(Array.isArray(a), 24), na(!$a(a), 25), d = Sf(a);
    ...
    function qg(a) {
        for (var b = 0, c = a.length; b < c; ++b) pg("LAYER_RENDERER", a[b]);
    }
    function G(a) {
        Vc.call(this);
        var b = rg(a);
    ...
    k.Sc = function(a, b, c) {
        if (this.c) return a = this.Pa(a), c = void 0 !== c ? c : {}, this.oc.Ga(a, this.c, void 0 !== c.hitTolerance ? c.hitTolerance * this.c.pixelRatio : 0, b, null, void 0 !== c.layerFilter ? c.layerFilter : Qe, null);
    };
    k.Vf = function(a, b) {
        var c = null;
    ...
    k.rg = function(a, b, c, d, e) {
        if (this.c) return this.oc.Qi(a, this.c, b, void 0 !== c ? c : null, void 0 !== d ? d : Qe, void 0 !== e ? e : null);
    };
    k.lg = function(a, b) {
        if (!this.c) return !1;
        a = this.Pa(a);
    ...
    k.pm = function() {
        ...
        a ? (a.appendChild(this.a), a = this.aa ? this.aa : a, this.s = [ y(a, "keydown", this.wd, this), y(a, "keypress", this.wd, this) ], 
        this.i || (this.i = this.Mc.bind(this), window.addEventListener("resize", this.i, !1))) : (ig(this.a), 
        void 0 !== this.i && (window.removeEventListener("resize", this.i, !1), this.i = void 0));
        this.Mc();
    };
    k.qm = function() {
    ...
    k.rm = function() {
        ...
        var a = this.$();
        a && (this.a.setAttribute("data-view", w(a)), this.H = y(a, "propertychange", this.bi, this), 
        this.B = y(a, "change", this.bi, this));
        this.render();
    };
    k.Xl = function() {
    ...
    k.hq = function(a) {
        var b, c = this.Cb(), d = this.$(), e = Ca(), f = this.c, g = null;
        ...
        this.c = g;
        this.oc.ah(g);
        g && (g.animate && this.render(), Array.prototype.push.apply(this.va, g.postRenderFunctions), 
        !f || this.f && ($a(this.f) || Ra(g.extent, this.f)) || (this.b(new dd("movestart", this, f)), 
        this.f = Na(this.f)), !this.f || g.viewHints[0] || g.viewHints[1] || Ra(g.extent, this.f) || (this.b(new dd("moveend", this, g)), 
        Fa(g.extent, this.f)));
    ...
    function rg(a) {
        ...
        if (void 0 === a.logo || "boolean" === typeof a.logo && a.logo) d["data:image/png;base64,"] = "https://openlayers.org/"; else {
            var e = a.logo;
            "string" === typeof e ? d[e] = "" : e instanceof HTMLElement ? d[w(e).toString()] = e : e && (na("string" == typeof e.href, 44), 
            na("string" == typeof e.src, 45), d[e.src] = e.href);
        }
        ...
        var f;
        void 0 !== a.renderer ? (Array.isArray(a.renderer) ? f = a.renderer : "string" === typeof a.renderer ? f = [ a.renderer ] : na(!1, 46), 
        0 <= f.indexOf("dom") && (f = f.concat(sg))) : f = sg;
        e = 0;
        var g = f.length;
        a: for (;e < g; ++e) for (var h = f[e], l = 0, m = ng.length; l < m; ++l) {
            var n = ng[l];
            if (n.handles(h)) {
                var p = n;
                break a;
        ...
        if (void 0 !== a.controls) if (Array.isArray(a.controls)) var q = new A(a.controls.slice()); else na(a.controls instanceof A, 47), 
        q = a.controls;
        if (void 0 !== a.interactions) if (Array.isArray(a.interactions)) var r = new A(a.interactions.slice()); else na(a.interactions instanceof A, 48), 
        r = a.interactions;
        void 0 !== a.overlays ? Array.isArray(a.overlays) ? a = new A(a.overlays.slice()) : (na(a.overlays instanceof A, 49), 
        a = a.overlays) : a = new A();
        return {
            controls: q,
            interactions: r,
    ...
    tg.prototype.setMap = function(a) {
        ...
        for (var b = 0, c = this.s.length; b < c; ++b) Gc(this.s[b]);
        this.s.length = 0;
        if (this.a = a) (this.G ? this.G : a.v).appendChild(this.element), this.render !== da && this.s.push(y(a, "postrender", this.render, this)), 
        a.render();
    };
    ...
    function yg(a) {
        if (a = a.frameState) {
            for (var b = {}, c = [], d = a.layerStatesArray, e = a.viewState.resolution, f = 0, g = d.length; f < g; ++f) {
                var h = d[f];
                if (wg(h, e) && (h = h.layer.ia()) && (h = h.B) && (h = h(a))) if (Array.isArray(h)) for (var l = 0, m = h.length; l < m; ++l) h[l] in b || (c.push(h[l]), 
            ...
            if (!gc(c, this.H)) {
                ...
                0 === c.length && 0 < this.H.length ? this.element.classList.add("ol-logo-only") : 0 === this.H.length && 0 < c.length && this.element.classList.remove("ol-logo-only");
    ...
    function Cg(a) {
        ...
        y(h, "click", Cg.prototype.j.bind(this, c));
        d = document.createElement("button");
        d.className = b + "-out";
        d.setAttribute("type", "button");
        d.title = g;
    ...
    function eh(a) {
        ...
        this.D ? "pointerdrag" == a.type ? this.zk(a) : "pointerup" == a.type && (this.D = this.Gk(a) && 0 < this.l.length) : "pointerdown" == a.type ? (this.D = a = this.Yj(a), 
        b = this.hd(a)) : "pointermove" == a.type && this.Fk(a);
        return !b;
    }
    ...
    var zh = "boxstart", xh = "boxdrag", yh = "boxend";
    function wh(a, b, c) {
        Qc.call(this, a);
        this.coordinate = b;
    ...
    Ah.prototype.j = function() {
        var a = this.v, b = a.$(), c = a.Cb(), d = this.V().C();
        if (this.G) {
            var e = b.od(c);
    ...
    function Ch(a) {
        ...
        if ("keydown" == a.type) {
            ...
            if (this.f(a) && (40 == c || 37 == c || 39 == c || 38 == c)) {
                b = a.map.$();
                var d = b.Qa() * this.l, e = 0, f = 0;
                40 == c ? f = -d : 37 == c ? e = -d : 39 == c ? e = d : f = d;
                d = [ e, f ];
                Fe(d, b.Ra());
                c = this.j;
                if (e = b.wa()) d = b.Qc([ e[0] + d[0], e[1] + d[1] ]), c ? b.animate({
                    duration: c,
                    easing: Pe,
                    center: d
                }) : b.tb(d);
    ...
    function Kh(a) {
        ...
        if ("keydown" == a.type || "keypress" == a.type) {
            ...
            !this.f(a) || 43 != c && 45 != c || (b = 43 == c ? this.a : -this.a, c = a.map.$(), 
            Qg(c, b, void 0, this.j), a.preventDefault(), b = !0);
        }
        return !b;
    }
    function Lh(a) {
    ...
    function Mh(a) {
        ...
        if (this.l === Nh) {
            b = b.$();
            this.s ? clearTimeout(this.s) : ag(b, 1, 1);
    ...
    function Qh(a) {
        return 2 <= this.l.length ? (a = a.map, this.f = null, this.j = void 0, this.a = !1, 
        this.s = 0, this.D || ag(a.$(), 1, 1), !0) : !1;
    }
    Ph.prototype.hd = Re;
    function Th(a) {
        dh.call(this, {
    ...
    function Uh(a) {
        return 2 <= this.l.length ? (a = a.map, this.f = null, this.a = void 0, this.j = 1, 
        this.D || ag(a.$(), 1, 1), !0) : !1;
    }
    Th.prototype.hd = Re;
    function Xh(a) {
        a = a ? a : {};
        var b = new A(), c = new Eg(-.005, .05, 100);
        ...
        if (void 0 !== a.keyboard ? a.keyboard : 1) b.push(new Bh()), b.push(new Dh({
            delta: a.zoomDelta,
            duration: a.zoomDuration
        }));
    ...
    k.forEach = function(a, b) {
        for (var c = this.g; c; ) a.call(b, c.Nc, c.ic, this), c = c.hb;
    };
    k.get = function(a) {
        a = this.a[a];
        na(void 0 !== a, 15);
        if (a === this.c) return a.Nc;
    ...
    k.remove = function(a) {
        ...
        na(void 0 !== b, 15);
        if (b === this.c) {
            if (this.c = b.Pb) this.c.hb = null;
        } else if (b === this.g) {
            if (this.g = b.hb) this.g.Pb = null;
        } else b.hb.Pb = b.Pb, b.Pb.hb = b.hb;
        delete this.a[a];
        --this.i;
        return b.Nc;
    };
    ...
    var ai = [ 0, 0, 0, 1 ], bi = [], ci = [ 0, 0, 0, 1 ], di = new Zh(), ei = {}, fi = function() {
        function a(a) {
            e || (e = gg(1, 1), e.font = "32px monospace", g = e.measureText("wmytzilWMYTZIL@#/&?$%10").width);
            var b = !0;
            "monospace" != a && (e.font = "32px " + a + ",monospace", b = e.measureText("wmytzilWMYTZIL@#/&?$%10").width != g, 
            e.font = "32px monospace");
            return b;
        }
        function b() {
            var b = !0, e;
            for (e in c) 60 > c[e] && (a(e) ? (c[e] = 60, d.clear()) : (++c[e], b = !1));
            b && (window.clearInterval(f), f = void 0);
        }
        var c = ei, d = di, e, f, g;
        return function(d) {
            if (d = ug(d)) for (var e = 0, g = d.length; e < g; ++e) {
                var h = d[e];
    ...
    var ji = /^#(?:[0-9a-f]{3,4}){1,2}$/i, ki = /^([a-z]*)$/i;
    function li(a) {
    ...
    var mi = function() {
        ...
        return function(c) {
            if (a.hasOwnProperty(c)) var d = a[c]; else {
                ...
                d = c;
                ki.exec(d) && (e = document.createElement("div"), e.style.color = d, document.body.appendChild(e), 
                ...
                if (ji.exec(d)) {
                    ...
                    f = [ e, h, l, d / 255 ];
                } else 0 == d.indexOf("rgba(") ? (d = d.slice(5, -1).split(",").map(Number), f = oi(d)) : 0 == d.indexOf("rgb(") ? (d = d.slice(4, -1).split(",").map(Number), 
                d.push(1), f = oi(d)) : na(!1, 14);
                d = f;
                a[c] = d;
                ++b;
            }
    ...
    function ti(a, b, c, d) {
        ...
        if (a.qa && "" !== a.sa) {
            a.j && ui(a, a.j);
            a.l && vi(a, a.l);
            var f = a.qa, g = a.g, h = a.Va, l = f.textAlign ? f.textAlign : "center";
            ...
            g.textAlign = l, g.textBaseline = f.textBaseline, a.Va = {
                font: f.font,
                textAlign: l,
    ...
    function xi(a, b, c, d, e) {
        var f;
        var g = 0;
        for (f = d.length; g < f; ++g) c = wi(a, b, c, d[g], e, !0);
        return c;
    }
    k = ri.prototype;
    k.cc = function(a) {
    ...
    k.uc = function(a) {
        ...
        if (fb(this.c, b)) {
            if (this.b) {
                vi(this, this.b);
                b = this.g;
                var c = a.da(), d = 0, e = a.ob(), f = a.pa();
                b.beginPath();
                var g;
                var h = 0;
                for (g = e.length; h < g; ++h) d = wi(this, c, d, e[h], f, !1);
                b.stroke();
            }
    ...
    k.wc = function(a) {
        if (fb(this.c, a.C())) {
            if (this.b || this.a) {
                this.a && ui(this, this.a);
                this.b && vi(this, this.b);
                var b = this.g, c = yi(a), d = 0, e = a.rd(), f = a.pa(), g;
                b.beginPath();
                var h = 0;
                for (g = e.length; h < g; ++h) d = xi(this, c, d, e[h], f);
                this.a && b.fill();
                this.b && b.stroke();
            }
    ...
    function vi(a, b) {
        var c = a.g, d = a.O;
        d ? (d.lineCap != b.lineCap && (d.lineCap = c.lineCap = b.lineCap), od && (gc(d.lineDash, b.lineDash) || c.setLineDash(d.lineDash = b.lineDash), 
        ...
        od && (c.setLineDash(b.lineDash), c.lineDashOffset = b.lineDashOffset), c.lineJoin = b.lineJoin, 
    ...
    k.Zb = function(a) {
        if (a) {
            var b = a.Uc(), c = a.Y(1), d = a.ad(), e = a.nc();
            this.D = b[0];
            this.B = b[1];
            this.H = e[1];
            this.N = c;
    ...
    function Fi(a, b) {
        b = b.H;
        void 0 !== b && ("string" === typeof b ? a.logos[b] = "" : b && (na("string" == typeof b.href, 44), 
        na("string" == typeof b.src, 45), a.logos[b.src] = b.href));
    }
    function Gi(a, b, c, d) {
        b = w(b).toString();
        c = c.toString();
        b in a ? c in a[b] ? (a = a[b][c], d.fa < a.fa && (a.fa = d.fa), d.la > a.la && (a.la = d.la), 
        d.ea < a.ea && (a.ea = d.ea), d.ka > a.ka && (a.ka = d.ka)) : a[b][c] = d : (a[b] = {}, 
        a[b][c] = d);
    }
    function Hi(a, b, c, d, e, f, g, h, l, m) {
        ...
        for (u = c.minZoom; u <= g; ++u) {
            var x = tc(c, f, u, x);
            var C = c.Sa(u);
            for (q = x.fa; q <= x.la; ++q) for (r = x.ea; r <= x.ka; ++r) if (g - u <= h) {
                var z = b.$c(u, q, r, d, e);
    ...
    v(Ii, Ai);
    function Oi(a, b, c) {
        var d = b.pixelRatio, e = b.size[0] * d, f = b.size[1] * d, g = b.viewState.rotation, h = Ya(c), l = Xa(c), m = Wa(c);
        c = Va(c);
    ...
    Ii.prototype.v = function(a, b, c, d) {
        if (this.Ga(a, b, 0, Qe, this)) return c.call(d, this.a, null);
    };
    ...
    Ri.prototype.xg = function(a, b, c) {
        ...
        var d = this.Y();
        if (d) {
            var e = b.extent, f = void 0 !== e && !Ka(e, a.extent) && fb(e, a.extent);
            f && Oi(c, a, e);
            e = this.o();
            var g = c.globalAlpha;
    ...
    Ri.prototype.v = function(a, b, c, d) {
        if (this.Y()) {
            if (this.a.ia().Ga !== da) return Ii.prototype.v.apply(this, arguments);
    ...
    Si.prototype.Cd = function(a, b) {
        ...
        this.N && (l = this.N, e = l.C(), b = l.resolution, l = l.a, m = c * b / (g * l), 
        e = df(this.c, c * d[0] / 2, c * d[1] / 2, m, m, 0, l * (e[0] - f[0]) / b, l * (f[1] - e[3]) / b), 
        df(this.s, c * d[0] / 2 - e[4], c * d[1] / 2 - e[5], c / g, -c / g, 0, -f[0], -f[1]), 
        Fi(a, h), this.i = b * c / l);
        return !!this.N;
    };
    function Ti() {
    ...
    k.Ga = function(a, b, c, d, e, f, g) {
        function h(a, c) {
            var f = w(a).toString(), g = b.layerStates[w(c)].Se;
        ...
        for (q = p.length - 1; 0 <= q; --q) {
            var u = p[q];
            r = u.layer;
            if (wg(u, n) && f.call(g, r) && (u = Yi(this, r), r.ia() && (l = u.Ga(r.ia().D ? m : a, b, c, h, e)), 
            l)) return l;
        }
    };
    ...
    function Yi(a, b) {
        ...
        if (d) a.c[c] = d, a.v[c] = y(d, "change", a.Yl, a); else throw Error("Unable to create renderer for layer: " + b.T());
        return d;
    }
    k.Yl = function() {
        this.l.render();
    ...
    $i.prototype.Qi = function(a, b, c, d, e, f) {
        ...
        for (--l; 0 <= l; --l) {
            var m = h[l];
            var n = m.layer;
            if (wg(m, g) && e.call(f, n) && (m = Yi(this, n).v(a, b, c, d))) return m;
        }
    };
    function bj(a) {
        Ri.call(this, a);
    ...
    bj.prototype.Cd = function(a, b) {
        ...
        e = e.center;
        var h = this.a, l = h.ia(), m = l.g, n = l.bb(f), p = n.Bc(g, this.O), q = n.Sa(p), r = Math.round(g / q) || 1, u = a.extent;
        void 0 !== b.extent && (u = eb(u, b.extent));
        if ($a(u)) return !1;
        var x = tc(n, u, p), C = wc(n, p, x), z = l.Xc(c), E = {};
        E[p] = {};
        var V = this.Pf(l, f, E), ya = this.G, fa = this.ua, pa = !1, Ja, ma;
        for (Ja = x.fa; Ja <= x.la; ++Ja) for (ma = x.ea; ma <= x.ka; ++ma) {
        ...
        if (!(this.i && 16 < Date.now() - a.time && Sa || !pa && this.c && Ka(this.c, u) && this.uf == m && r == this.B && (Sa || q * c / z * r == this.i))) {
            if (Sa = this.context) ma = l.Yd(p, c, f), Ja = Math.round((x.la - x.fa + 1) * ma[0] / r), 
            ma = Math.round((x.ka - x.ea + 1) * ma[1] / r), pa = Sa.canvas, pa.width != Ja || pa.height != ma ? (this.B = r, 
            pa.width = Ja, pa.height = ma) : (this.c && !Ra(C, this.c) && Sa.clearRect(0, 0, Ja, ma), 
            r = this.B);
            this.f.length = 0;
            ...
            for (hc = pa.length; N < hc; ++N) {
                ...
                for (var pf in kc) {
                    ...
                    var Jg = V[0] * ib / r;
                    var Qd = V[1] * ib / r;
                    this.Qf(Sa, a, b, Ja, ma, Jg, Qd, jc, p === fa);
                    this.f.push(Sa);
                }
            }
            this.uf = m;
    ...
    bj.prototype.Qf = function(a, b, c, d, e, f, g, h, l) {
        if (c = a.Y(this.a)) {
            var m = w(this), n = l ? fj(a, m, b.time) : 1;
    ...
    (function(a) {
        ...
        function g(a, b, c, d, e) {
            ...
            e.la = -Infinity;
            e.ka = -Infinity;
            for (var f; b < c; b++) f = a.children[b], h(e, a.cb ? d(f) : f);
            return e;
        }
        function h(a, b) {
        ...
        e.prototype = {
            ...
            search: function(a) {
                var b = this.data, c = [], d = this.wb;
                if (!r(a, b)) return c;
                for (var e = [], f, g, h, l; b; ) {
                    f = 0;
                    for (g = b.children.length; f < g; f++) h = b.children[f], l = b.cb ? d(h) : h, 
                    r(a, l) && (b.cb ? c.push(h) : q(a, l) ? this.qh(h, c) : e.push(h));
                    b = e.pop();
                }
                return c;
            },
            Jk: function(a) {
                var b = this.data, c = this.wb;
                if (!r(a, b)) return !1;
                for (var d = [], e, f, g, h; b; ) {
                    e = 0;
                    for (f = b.children.length; e < f; e++) if (g = b.children[e], h = b.cb ? c(g) : g, 
                    r(a, h)) {
                        if (b.cb || q(a, h)) return !0;
                        d.push(g);
                    }
                    b = d.pop();
                }
            ...
            load: function(a) {
                ...
                this.data.children.length ? this.data.height === a.height ? this.xh(this.data, a) : (this.data.height < a.height && (b = this.data, 
                this.data = a, a = b), this.uh(a, this.data.height - a.height - 1, !0)) : this.data = a;
                return this;
            },
            Ca: function(a) {
            ...
            remove: function(a, b) {
                ...
                for (var c = this.data, d = this.wb(a), e = [], f = [], g, h, l, m; c || e.length; ) {
                    ...
                    m || c.cb || !q(c, d) ? h ? (g++, c = h.children[g], m = !1) : c = null : (e.push(c), 
            ...
            qh: function(a, b) {
                for (var c = []; a; ) a.cb ? b.push.apply(b, a.children) : c.push.apply(c, a.children), 
                a = c.pop();
                return b;
            },
            sh: function(a, b, c, d) {
                var e = c - b + 1, g = this.Jf;
                if (e <= g) {
            ...
            sk: function(a, b, c, d) {
                for (var e, f, g, h, l, m, p, q; ;) {
                    d.push(b);
                    if (b.cb || d.length - 1 === c) break;
                    p = q = Infinity;
                    e = 0;
                    for (f = b.children.length; e < f; e++) g = b.children[e], l = n(g), m = (Math.max(g.la, a.la) - Math.min(g.fa, a.fa)) * (Math.max(g.ka, a.ka) - Math.min(g.ea, a.ea)) - l, 
            ...
            uh: function(a, b, c) {
                ...
                e.children.push(a);
                for (h(e, c); 0 <= b; ) if (d[b].children.length > this.Jf) this.yk(d, b), b--; else break;
                this.pk(c, d, b);
            },
            yk: function(a, b) {
            ...
            qk: function(a, b, c) {
                var d = a.cb ? this.Nf : l, e = a.cb ? this.Of : m, f = this.rh(a, b, c, d);
                b = this.rh(a, b, c, e);
            ...
            rh: function(a, b, c, d) {
                ...
                for (m = c - b - 1; m >= b; m--) n = a.children[m], h(f, a.cb ? d(n) : n), l += p(f);
                return l;
            },
            pk: function(a, b, c) {
                for (;0 <= c; c--) h(b[c], a);
    ...
    function kj(a, b, c, d, e, f, g, h, l, m, n, p, q, r, u, x) {
        ...
        a = a.va;
        x = null;
        0 !== q ? (f = c + f, g = d + g, x = df(C, f, g, 1, 1, q, -f, -g), Na(a), Da(a, $e(C, [ c, d ])), 
        Da(a, $e(C, [ c + u, d ])), Da(a, $e(C, [ c + u, d + l ])), Da(a, $e(C, [ c, d + u ]))) : Ma(c, d, c + u * r, d + l * r, a);
        q = b.canvas;
        q = a[0] <= q.width && 0 <= a[2] && a[1] <= q.height && 0 <= a[3];
        if (h) {
            if (q || 1 != h[4]) Ta(h, a), h.push(q ? [ b, x ? x.slice(0) : null, m, e, n, p, u, l, c, d, r ] : null);
        } else q && ii(b, x, m, e, n, p, u, l, c, d, r);
    }
    function lj(a, b) {
        var c = a.pixelRatio;
    ...
    function mj(a, b, c, d, e, f, g) {
        var h = a.coordinates.length, l = nj(a);
        g && (c += e);
        g = [ b[c], b[c + 1] ];
        var m = [ NaN, NaN ], n = !0, p;
        for (p = c + e; p < d; p += e) {
    ...
    k.Eh = function(a, b, c) {
        pj(this, b);
        var d = a.T(), e = a.pa(), f = this.coordinates.length, g;
        if ("MultiPolygon" == d) {
            d = yi(a);
            var h = [];
        ...
        } else "Polygon" == d || "MultiLineString" == d ? (h = [], d = "Polygon" == d ? a.Xb() : a.da(), 
        oj(this, d, 0, a.ob(), e, h), this.a.push([ 4, f, h, a, c, Af ])) : "LineString" == d || "MultiPoint" == d ? (d = a.da(), 
        e = mj(this, d, 0, d.length, e, !1, !1), this.a.push([ 4, f, e, a, c, zf ])) : "Point" == d && (d = a.da(), 
        this.coordinates.push(d[0], d[1]), e = this.coordinates.length, this.a.push([ 4, f, e, a, c ]));
        qj(this, b);
    };
    function pj(a, b) {
        a.qa = [ 0, b, 0 ];
    ...
    function rj(a, b) {
        if (b && 5 < b.length) {
            ...
            if (1 == c || c == b.length - 5) {
                ...
                if (!a.ca.Jk(c)) for (a.ca.Ca(c), a = 5, c = b.length; a < c; ++a) b[a] && ii.apply(void 0, b[a]);
                b.length = 5;
                Na(b);
            }
        }
    ...
    function sj(a, b, c, d, e, f, g, h) {
        if (a.oa && gc(c, a.aa)) var l = a.oa; else a.oa || (a.oa = []), l = Se(a.coordinates, 0, a.coordinates.length, 2, c, a.oa), 
        Ze(a.aa, c);
        for (var m = !mb(e), n = 0, p = f.length, q, r, u, x, C, z, E, V, ya, fa = 0, pa = 0, Ja = a.mb, ma = {
            ...
            switch (N[0]) {
              ...
              case 2:
                q = N[1];
                var ib = l[q], jc = l[q + 1], kc = l[q + 2] - ib, pf = l[q + 3] - jc, Jg = Math.sqrt(kc * kc + pf * pf);
                b.moveTo(ib + Jg, jc);
              ...
              case 4:
                q = N[1];
                r = N[2];
                var Qd = N[4], se = 6 == N.length ? N[5] : void 0;
                ma.geometry = N[3];
                ma.feature = hc;
                n in Ja || (Ja[n] = []);
                var of = Ja[n];
              ...
              case 6:
                ...
                x = N[5];
                ya = N[6];
                var Eh = N[7], Gk = N[8], rf = N[9], hu = N[10], ap = N[12], iu = N[13], ju = N[14], ku = N[15];
              ...
              case 5:
                var bp = N[1], cp = N[2], Hk = N[3];
                ya = N[4];
                var lu = N[5], mu = N[6], nu = N[7], dp = N[8], ep = N[9], ou = N[10], fp = N[11], gp = N[12], pu = N[13], hp = N[14], ip = ij(l, bp, cp, 2), jp = dp(gp);
                if (lu || jp <= ip) {
                    a: {
                        var Ji = void 0, Uf = void 0, sf = l, ue = bp, kp = cp, lp = gp, qu = dp, mp = (ip - jp) * pu, ru = nu, Ik = [], Fh = sf[ue] > sf[kp - 2], np = lp.length, Gh = sf[ue], Hh = sf[ue + 1];
                        ue += 2;
                        for (var Lg = sf[ue], Mg = sf[ue + 1], Jk = 0, Ki = Math.sqrt(Math.pow(Lg - Gh, 2) + Math.pow(Mg - Hh, 2)), Vf = "", Kk = 0, Li = 0; Li < np; ++Li) {
                            var su = Fh ? np - Li - 1 : Li;
                            var Lk = lp.charAt(su);
                            Vf = Fh ? Lk + Vf : Vf + Lk;
                            var Ng = qu(Vf) - Kk;
                            Kk += Ng;
                            for (var op = mp + Ng / 2; ue < kp - 2 && Jk + Ki < op; ) Gh = Lg, Hh = Mg, ue += 2, 
                            Lg = sf[ue], Mg = sf[ue + 1], Jk += Ki, Ki = Math.sqrt(Math.pow(Lg - Gh, 2) + Math.pow(Mg - Hh, 2));
                            var tu = op - Jk, Og = Math.atan2(Mg - Hh, Lg - Gh);
                            ...
                            var pp = tu / Ki, qp = wa(Gh, Lg, pp), rp = wa(Hh, Mg, pp);
                            Ji == Og ? (Fh && (Uf[0] = qp, Uf[1] = rp, Uf[2] = Ng / 2), Uf[4] = Vf) : (Vf = Lk, 
                            Kk = Ng, Uf = [ qp, rp, Ng / 2, Og, Vf ], Fh ? Ik.unshift(Uf) : Ik.push(Uf), Ji = Og);
                            mp += Ng;
                        }
                        Pg = Ik;
                    }
                    if (Pg) {
                        ...
                        if (mu) for (Wf = 0, Ni = Pg.length; Wf < Ni; ++Wf) ce = Pg[Wf], Mk = ce[4], Me = a.Y(Mk, !0, !1), 
                        u = ce[2], x = Hk * Me.height - ep, kj(a, b, ce[0], ce[1], Me, u, x, ya, Me.height, 1, 0, 0, ce[3], hp, !1, Me.width);
                    }
                }
                rj(a, ya);
                ++n;
              ...
              case 9:
                ...
                for (q += 2; q < r; q += 2) if (Ih = l[q], Jh = l[q + 1], E = Ih + .5 | 0, V = Jh + .5 | 0, 
                q == r - 2 || E !== C || V !== z) b.lineTo(Ih, Jh), C = E, z = V;
                ++n;
                break;
    ...
    k.Oa = function(a, b) {
        ...
        b ? (a = b.a, c.strokeStyle = pi(a ? a : ci), a = b.f, c.lineCap = void 0 !== a ? a : "round", 
        a = b.g, c.lineDash = a ? a.slice() : bi, a = b.i, c.lineDashOffset = a ? a : 0, 
        a = b.j, c.lineJoin = void 0 !== a ? a : "round", a = b.c, c.lineWidth = void 0 !== a ? a : 1, 
        b = b.l, c.miterLimit = void 0 !== b ? b : 10, c.lineWidth > this.O && (this.O = c.lineWidth, 
        this.i = null)) : (c.strokeStyle = void 0, c.lineCap = void 0, c.lineDash = null, 
    ...
    function uj(a, b, c) {
        ...
        b.Rk == d && b.Lk == e && gc(b.Mk, f) && b.Nk == g && b.Ok == h && b.Pk == l && b.Qk == m || (c && (void 0 != b.Zd && b.Zd != a.coordinates.length && (a.a.push([ 12 ]), 
        b.Zd = a.coordinates.length), b.Zd = 0), a.a.push([ 11, d, l * a.pixelRatio, e, h, m, lj(a, f), g * a.pixelRatio ]), 
        c && a.a.push([ 1 ]), b.Rk = d, b.Lk = e, b.Mk = f, b.Nk = g, b.Ok = h, b.Pk = l, 
        b.Qk = m);
    }
    function qj(a, b) {
        a.qa[2] = a.a.length;
    ...
    vj.prototype.Zb = function(a, b) {
        var c = a.Uc(), d = a.nc(), e = a.Dg(1), f = a.Y(1), g = a.ad();
        this.g = c[0];
        this.c = c[1];
        this.H = b;
        this.Va = e;
    ...
    wj.prototype.tc = function(a, b) {
        ...
        void 0 !== c.strokeStyle && void 0 !== d && (uj(this, c, !0), pj(this, b), this.b.push([ 11, c.strokeStyle, c.lineWidth, c.lineCap, c.lineJoin, c.miterLimit, c.lineDash, c.lineDashOffset ], [ 1 ]), 
        c = a.da(), xj(this, c, 0, c.length, a.pa()), this.b.push([ 12 ]), qj(this, b));
    };
    wj.prototype.uc = function(a, b) {
        ...
        if (void 0 !== c.strokeStyle && void 0 !== d) {
            ...
            var e = 0, f;
            var g = 0;
            for (f = c.length; g < f; ++g) e = xj(this, d, e, c[g], a);
            this.b.push([ 12 ]);
            qj(this, b);
        }
    };
    ...
    yj.prototype.wc = function(a, b) {
        ...
        if (void 0 !== c.fillStyle || void 0 !== d) {
            ...
            var e = 0, f;
            var g = 0;
            for (f = c.length; g < f; ++g) e = zj(this, d, e, c[g], a);
            qj(this, b);
        }
    };
    ...
    var Bj = "Polygon Circle LineString Image Text Default".split(" "), Cj = {
        left: 0,
        end: 0,
        center: .5,
        right: 1,
    ...
    var Ej = function() {
        ...
        return function(c) {
            var d = b[c];
            void 0 == d && (a || (a = document.createElement("span"), a.textContent = "M", a.style.margin = a.style.padding = "0 !important", 
            a.style.position = "absolute !important", a.style.left = "-99999px !important"), 
            a.style.font = c, document.body.appendChild(a), d = b[c] = a.offsetHeight, document.body.removeChild(a));
            return d;
        };
    }(), Fj = function() {
        var a, b;
    ...
    Dj.prototype.Wb = function(a, b) {
        ...
        if ("" !== this.sa && e && (c || d)) {
            ...
            if ("line" === e.placement) {
                ...
                d = a.da();
                h = a.pa();
                if ("LineString" == f) var l = [ d.length ]; else if ("MultiLineString" == f) l = a.ob(); else if ("Polygon" == f) l = a.ob().slice(0, 1); else if ("MultiPolygon" == f) {
                    var m = a.rd();
                    l = [];
                    g = 0;
                    for (a = m.length; g < a; ++g) l.push(m[g][0]);
                }
                pj(this, b);
                a = e.textAlign;
                var n = 0, p;
                ...
                for (f = l.length; m < f; ++m) {
                    if (void 0 == a) {
                        for (var q, r, u = void 0, x = void 0, C = g = r = q = void 0, z = p = n, E = 0, V = 0, ya = n; n < l[m]; n += h) {
                            var fa = d[n], pa = d[n + 1];
                            void 0 !== r && (r = fa - r, q = pa - q, g = Math.sqrt(r * r + q * q), void 0 !== x && (V += C, 
                            u = Math.acos((x * r + u * q) / (C * g)), u > e.maxAngle && (V > E && (E = V, p = ya, 
                            z = n), V = 0, ya = n - h)), C = g, x = r, u = q);
                            r = fa;
                            q = pa;
                        }
                        g = V + g > E ? [ ya, n ] : [ p, z ];
    ...
    Dj.prototype.Y = function(a, b, c) {
        ...
        if (!di.a.hasOwnProperty(d)) {
            var e = this.g, f = this.c, g = this.f, h = g.scale * this.pixelRatio, l = Cj[g.textAlign || "center"], m = c && e.lineWidth ? e.lineWidth : 0;
            a = a.split("\n");
            var n = a.length, p = [], q = g.font;
            var r = a.length;
            var u = 0;
            var x;
            for (x = 0; x < r; ++x) {
            ...
            1 != h && r.scale(h, h);
            r.font = g.font;
            c && (r.strokeStyle = e.strokeStyle, r.lineWidth = m * (kd ? h : 1), r.lineCap = e.lineCap, 
            r.lineJoin = e.lineJoin, r.miterLimit = e.miterLimit, od && e.lineDash.length && (r.setLineDash(e.lineDash), 
            ...
            e = .5 - l;
            h = l * u.width / h + e * m;
            if (c) for (c = 0; c < n; ++c) r.strokeText(a[c], h + e * p[c], .5 * m + c * q);
            if (b) for (c = 0; c < n; ++c) r.fillText(a[c], h + e * p[c], .5 * m + c * q);
        }
        return di.get(d);
    };
    function Gj(a, b, c, d) {
        var e = a.pixelRatio, f = a.g, g = !!a.c, h = !!f, l = a.f, m = Cj[l.textBaseline], n = a.j * e, p = Cj[l.textAlign || "center"], q = a.sa, r = l.font, u = l.scale;
    ...
    function Kj(a) {
        if (void 0 !== Ij[a]) return Ij[a];
        for (var b = 2 * a + 1, c = Array(b), d = 0; d < b; d++) c[d] = Array(b);
        b = a;
        for (var e = d = 0; b >= d; ) Jj(c, a + b, a + d), Jj(c, a + d, a + b), Jj(c, a - d, a + b), 
        Jj(c, a - b, a + d), Jj(c, a - b, a - d), Jj(c, a - d, a - b), Jj(c, a + d, a - b), 
        Jj(c, a + b, a - d), d++, e += 1 + 2 * d, 0 < 2 * (e - b) + 1 && (--b, e += 1 - 2 * b);
        return Ij[a] = c;
    }
    function Lj(a, b, c, d, e) {
        for (var f = Object.keys(a).map(Number).sort(bc), g = 0, h = f.length; g < h; ++g) for (var l = a[f[g].toString()], m = l.length - 1; 0 <= m; ) {
            var n = l[m--], p = l[m--];
            if (n = sj(p, b, n, c, {}, p.b, d, e)) return n;
        }
    }
    k = Hj.prototype;
    k.Vb = function(a) {
    ...
    k.Ga = function(a, b, c, d, e, f, g) {
        ...
        d = Math.round(d);
        var l = 2 * d + 1, m = df(this.j, d + .5, d + .5, 1 / b, -1 / b, -c, -a[0], -a[1]), n = this.f;
    ...
    k.Ja = function(a, b) {
        ...
        c = a[b];
        void 0 === c && (c = new Pj[b](this.o, this.c, this.v, this.s, this.l, this.g), 
        a[b] = c);
        return c;
    };
    k.wg = function() {
        ...
        for (m = l.length - 1; 0 <= m; --m) {
            ...
            for (n = Bj.length - 1; 0 <= n; --n) {
                ...
                if (void 0 !== u) if (!h || "Image" != r && "Text" != r) {
                    if (u = sj(u, b, c, d, e, u.b, f, g)) return u;
    ...
    function Sj(a, b, c, d, e, f) {
        ...
        if (e = (0, c.ab)(b)) if (d = e.Vd(d), c.He()) Tj(a, d, c, b); else (0, Uj[d.T()])(a, d, c, b);
        return g;
    }
    function Tj(a, b, c, d) {
        if ("GeometryCollection" == b.T()) {
            b = b.td();
            for (var e = 0, f = b.length; e < f; ++e) Tj(a, b[e], c, d);
    ...
    var Uj = {
        Point: function(a, b, c, d) {
            ...
            if (f = c.Ka()) c = a.Ja(c.Ba(), "Text"), c.kb(f, a.Vb(!!e)), c.Wb(b, d);
        },
        LineString: function(a, b, c, d) {
            ...
            if (e = c.Ka()) c = a.Ja(c.Ba(), "Text"), c.kb(e, a.Vb(!1)), c.Wb(b, d);
        },
        ...
        GeometryCollection: function(a, b, c, d) {
            ...
            var e;
            var f = 0;
            for (e = b.length; f < e; ++f) (0, Uj[b[f].T()])(a, b[f], c, d);
        },
    ...
    k.xg = function(a, b, c) {
        var d = a.extent, e = a.pixelRatio, f = b.Se ? a.skippedFeatureUids : {}, g = a.viewState, h = g.projection, l = g.rotation, m = h.C(), n = this.a.ia(), p = Qi(this, a, 0);
        Pi(this, "precompose", c, a, p);
        var q = b.extent;
        (g = void 0 !== q) && Oi(c, a, q);
        var r = this.c;
        if (r && !r.wg()) {
            var u = q = 0, x = 1 !== b.opacity, C = Tc(this.a, "render");
            if (x || C) {
            ...
            if (n.D && h.g && !Ka(m, d)) {
                h = d[0];
                n = ab(m);
                for (var ya = 0; h < m[0]; ) --ya, p = n * ya, p = Qi(this, a, p), r.Ma(z, p, l, f), 
                h += n;
                ya = 0;
                for (h = d[2]; h > m[2]; ) ++ya, p = n * ya, p = Qi(this, a, p), r.Ma(z, p, l, f), 
                h -= n;
                p = Qi(this, a, 0);
            }
            gi(z, l, V / 2, e / 2);
            z != c && (C && Pi(this, "render", z, a, p), x ? (d = c.globalAlpha, c.globalAlpha = b.opacity, 
            c.drawImage(z.canvas, -q, -u), c.globalAlpha = d) : c.drawImage(z.canvas, -q, -u), 
            z.translate(-q, -u));
            x || (z.globalAlpha = E);
        }
        g && c.restore();
    ...
    k.Cd = function(a) {
        var b = this.a, c = b.ia();
        Fi(a, c);
        var d = a.viewHints[0], e = a.viewHints[1], f = b.aa, g = b.ca;
        ...
        f = Ea(f, n * l);
        n = h.projection.C();
        c.D && h.projection.g && !Ka(n, a.extent) && (a = Math.max(ab(f) / 2, ab(n)), f[0] = n[0] - a, 
        f[2] = n[2] + a);
        if (!this.f && this.o == l && this.P == d && this.s == e && Ka(this.l, f)) return !0;
        this.c = null;
        this.f = !1;
        var p = new Hj(.5 * l / m, f, l, m, c.aa, this.i, b.f);
        c.$d(f, l, g);
        a = function(a) {
            var c = a.fb();
            if (c) var d = c.call(a, l); else (c = b.fb()) && (d = c(a, l));
            if (d) {
                if (d) {
                    c = !1;
                    if (Array.isArray(d)) for (var e = 0, f = d.length; e < f; ++e) c = Sj(p, a, d[e], Rj(l, m), this.Ti, this) || c; else c = Sj(p, a, d, Rj(l, m), this.Ti, this);
                    a = c;
                } else a = !1;
                this.f = this.f || a;
            }
    ...
    k.Cd = function(a, b) {
        var c = this.a, d = c.g;
        this.H != d && (this.f.length = 0, c = c.o, this.context || "vector" == c || (this.context = gg()), 
        this.context && "vector" == c && (this.context = null));
        this.H = d;
        return bj.prototype.Cd.apply(this, arguments);
    };
    k.Qf = function(a, b, c, d, e, f, g, h, l) {
        var m = a, n = this.a, p = b.pixelRatio, q = b.viewState.projection, r = n.g, u = n.get(Wj) || null, x = ak(m, n);
        if (x.Ae || x.uf != r || x.dh != u) {
            var C = n.ia(), z = C.tileGrid, E = C.bb(q), V = E.Sa(m.xa[0]);
            E = E.La(m.l);
            for (var ya = 0, fa = m.a.length; ya < fa; ++ya) {
                var pa = m.c[m.a[ya]];
                if (3 != pa.getState()) {
                    var Ja = z.La(pa.xa), ma = eb(E, Ja), Sa = Ra(Ja, ma) ? null : Ea(ma, n.f * V), N = pa.o, hc = !1;
                    Wb(q, N) || (hc = !0, pa.tg(q));
                    x.Ae = !1;
                    ma = new Hj(0, ma, V, p, C.s, this.l, n.f);
                    var ib = Rj(V, p), jc = pa.a;
                    u && u !== x.dh && jc.sort(u);
                    for (var kc, pf = 0, Jg = jc.length; pf < Jg; ++pf) if (kc = jc[pf], hc && ("tile-pixels" == N.a && (N.Nj(Ja), 
                    N.Pi(pa.C())), kc.V().jb(N, q)), !Sa || fb(Sa, kc.C())) {
                        var Qd = void 0, se = kc.fb();
                        ...
                        if (Qd) {
                            ...
                            if (Qd) {
                                var Kg = !1;
                                if (Array.isArray(Qd)) for (var Eh = 0, Gk = Qd.length; Eh < Gk; ++Eh) Kg = Sj(of, kc, Qd[Eh], se, this.Vi, this) || Kg; else Kg = Sj(of, kc, Qd, se, this.Vi, this);
                                kc = Kg;
                            } else kc = !1;
                            this.D = this.D || kc;
                            x.Ae = x.Ae || kc;
        ...
        if (this.context) {
            ...
            q = ak(m, n);
            r = n.g;
            if ((p = Yj[n.o]) && q.eh !== r) for (q.eh = r, C = m.l, V = C[0], q = x.pixelRatio, 
            rf = n.ia(), z = rf.bb(x.viewState.projection), r = z.Sa(V), u = bk(m, n), x = rf.Yd(V, q, x.viewState.projection), 
            u.canvas.width = x[0], u.canvas.height = x[1], x = z.La(C), C = 0, z = m.a.length; C < z; ++C) V = m.c[m.a[C]], 
            3 != V.getState() && (rf = q / r, E = We(this.ca), bf(E, rf, -rf), cf(E, -x[0], -x[3]), 
            ck(V, n, m.xa.toString()).Ma(u, E, 0, {}, p));
    ...
    k.Ga = function(a, b, c, d, e) {
        ...
        c = void 0 == c ? 0 : c;
        var h = this.a, l = h.j ? {} : null, m = {}, n = this.f;
                ...
                for (var C = r.a.length; u < C; ++u) {
                    ...
                    if (3 != z.getState()) {
                        ...
                        var E = E || z.Ga(a, f, g, c, {}, function(a) {
                            var b = w(a).toString();
                            if (!(b in m)) return m[b] = !0, d.call(e, a, h);
                        }, l);
                    }
                }
            }
    ...
    k.mf = function(a, b, c) {
        var d = this.a, e = d.j ? {} : null, f = d.ia(), g = d.o, h = Zj[g], l = b.pixelRatio, m = b.viewState.rotation, n = b.size;
        ...
        for (var p = [], q = l.length - 1; 0 <= q; --q) {
            var r = l[q];
            if (5 != r.getState()) for (var u = r.xa, x = f.La(u)[0] - f.La(r.l)[0], C = void 0, z = 0, E = r.a.length; z < E; ++z) {
                var V = r.c[r.a[z]];
                if (3 != V.getState()) {
                    var ya = ck(V, d, u.toString()), fa;
                    if (!(fa = "vector" == g)) a: {
                        fa = void 0;
                        for (fa in ya.b) for (var pa = ya.b[fa], Ja = 0, ma = h.length; Ja < ma; ++Ja) if (h[Ja] in pa) {
                            fa = !0;
                            break a;
                        }
                        fa = !1;
                    ...
                    if (fa) {
                        ...
                        pa = 0;
                        for (Ja = n.length; pa < Ja; ++pa) ma = n[pa], V < p[pa] && (a.beginPath(), a.moveTo(fa[0], fa[1]), 
                        a.lineTo(fa[2], fa[3]), a.lineTo(fa[4], fa[5]), a.lineTo(fa[6], fa[7]), a.moveTo(ma[6], ma[7]), 
                        a.lineTo(ma[4], ma[5]), a.lineTo(ma[2], ma[3]), a.lineTo(ma[0], ma[1]), a.clip());
                        ya.Ma(a, C, m, {}, h, e);
                        a.restore();
                        n.push(fa);
                        p.push(V);
        ...
        if (e) {
            ...
            h = 0;
            for (l = g.length; h < l; ++h) for (f = e[g[h].toString()], n = 0, p = f.length; n < p; ) q = f[n++], 
            r = f[n++], q.Ma(d, r, m, {});
            this.l.clear();
        }
    ...
    k.Rm = function() {
        if (qd) {
            var a = this.ii();
            a && !this.a ? this.a = y(window, "deviceorientation", this.up, this) : a || null === this.a || (Gc(this.a), 
            this.a = null);
        }
    };
    k.pg = function(a) {
    ...
    var fk = "alpha", hk = "beta", ik = "gamma", gk = "heading", ek = "tracking";
    function jk(a) {
        this.i = a.opacity;
    ...
    function lk(a, b) {
        ...
        } else m = Math.round(m), (d = !a.Ya) && (n = a.Fh.bind(a, c)), a.Wa ? (e = a.Wa, 
        void 0 === e.b && (e.b = "s", e.b = e.a ? "string" === typeof e.a ? e.b + e.a : e.b + w(e.a).toString() : e.b + "-", 
        ...
        e = e.b) : e = "-", a.Ya ? (f = a.Ya, void 0 === f.a && (f.a = f.b instanceof CanvasPattern || f.b instanceof CanvasGradient ? w(f.b).toString() : "f" + (f.b ? ni(f.b) : "-")), 
        f = f.a) : f = "-", a.c && e == a.c[1] && f == a.c[2] && a.b == a.c[3] && a.g == a.c[4] && a.j == a.c[5] && a.l == a.c[6] || (a.c = [ "r" + e + f + (void 0 !== a.b ? a.b.toString() : "-") + (void 0 !== a.g ? a.g.toString() : "-") + (void 0 !== a.j ? a.j.toString() : "-") + (void 0 !== a.l ? a.l.toString() : "-"), e, f, a.b, a.g, a.j, a.l ]), 
        n = b.add(a.c[0], m, m, a.Gh.bind(a, c), n), a.o = n.image, a.oa = [ n.offsetX, n.offsetY ], 
        b = n.image.width, a.D = d ? n.sm : a.o;
        a.B = [ m / 2, m / 2 ];
        a.qa = [ m, m ];
        a.H = [ b, b ];
    }
    ...
    function rk(a) {
        if ("function" !== typeof a) {
            if (Array.isArray(a)) var b = a; else na(a instanceof pk, 41), b = [ a ];
            a = function() {
                return b;
            };
        }
    ...
    function wk(a) {
        ...
        if ("function" === typeof a) 2 == a.length ? b = function(b) {
            ...
            if (Array.isArray(a)) var c = a; else na(a instanceof pk, 41), c = [ a ];
            b = function() {
                return c;
            };
        }
    ...
    k.Xm = function() {
        if (rd) {
            var a = this.ki();
            a && void 0 === this.c ? this.c = navigator.geolocation.watchPosition(this.Gp.bind(this), this.Hp.bind(this), this.Yh()) : a || void 0 === this.c || (navigator.geolocation.clearWatch(this.c), 
            this.c = void 0);
        }
    };
    k.Gp = function(a) {
    ...
    function yk(a, b, c, d, e, f) {
        ...
        h = (1 - e) * a[b + 1] + e * a[b + d + 1]; else if (0 !== l) {
            ...
            l = 0;
            m = g.length;
            for (n = !1; l < m; ) e = l + (m - l >> 1), h = +bc(g[e], c), 0 > h ? l = e + 1 : (m = e, 
            n = !h);
            e = n ? l : ~l;
            0 > e ? (c = (c - g[-e - 2]) / (g[-e - 1] - g[-e - 2]), b += (-e - 2) * d, g = wa(a[b], a[b + d], c), 
            h = wa(a[b + 1], a[b + d + 1], c)) : (g = a[b + e * d], h = a[b + e * d + 1]);
        }
    ...
    function zk(a, b, c, d, e, f) {
        ...
        c = [];
        var g;
        for (g = 0; g < d - 1; ++g) c.push(wa(a[(b - 1) * d + g], a[b * d + g], f));
        c.push(e);
        return c;
    }
    function Ak(a, b, c, d, e, f) {
        var g = 0;
        if (f) return zk(a, g, b[b.length - 1], c, d, e);
        ...
        for (f = b.length; e < f; ++e) {
            var h = b[e];
            if (g != h) {
                if (d < a[g + c - 1]) break; else if (d <= a[h - 1]) return zk(a, g, h, c, d, !1);
                g = h;
            }
        }
        return null;
    ...
    k.Nb = function(a, b, c, d) {
        if (d < Ga(this.C(), a, b)) return d;
        this.o != this.g && (this.D = Math.sqrt(qf(this.A, 0, this.A.length, this.a, 0)), 
        this.o = this.g);
    ...
    function Bk(a, b, c) {
        for (var d = [], e = a(0), f = a(1), g = b(e), h = b(f), l = [ f, e ], m = [ h, g ], n = [ 1, 0 ], p = {}, q = 1e5, r, u, x, C, z; 0 < --q && 0 < n.length; ) x = n.pop(), 
        e = l.pop(), g = m.pop(), f = x.toString(), f in p || (d.push(g[0], g[1]), p[f] = !0), 
        C = n.pop(), f = l.pop(), h = m.pop(), z = (x + C) / 2, r = a(z), u = b(r), sa(u[0], u[1], g[0], g[1], h[0], h[1]) < c ? (d.push(h[0], h[1]), 
        f = C.toString(), p[f] = !0) : (n.push(C, z, z, x), m.push(h, u, u, g), l.push(f, r, r, e));
        return d;
    }
    ...
    function Fk(a) {
        ...
        1 == a.showLabels && (this.aa = void 0 == a.lonLabelFormatter ? Ce.bind(this, "EW") : a.lonLabelFormatter, 
        this.Va = void 0 == a.latLabelFormatter ? Ce.bind(this, "NS") : a.latLabelFormatter, 
        this.ca = void 0 == a.lonLabelPosition ? 0 : a.lonLabelPosition, this.W = void 0 == a.latLabelPosition ? 1 : a.latLabelPosition, 
        this.H = void 0 !== a.lonLabelStyle ? a.lonLabelStyle : new Ek({
    ...
    function Pk(a, b, c, d, e, f, g) {
        ...
        h.ba("XY", c);
        fb(h.C(), f) && (a.b && (c = g, d = h.da(), f = [ d[0], oa(f[1] + Math.abs(f[1] - f[3]) * a.ca, Math.max(f[1], d[1]), Math.min(f[3], d[d.length - 1])) ], 
        c = void 0 !== a.b[c] ? a.b[c].Pd : new B(null), c.na(f), a.b[g] = {
            Pd: c,
            text: a.aa(b)
        }), a.g[g++] = h);
        return g;
    ...
    function Qk(a, b, c, d, e, f, g) {
        ...
        h.ba("XY", c);
        fb(h.C(), f) && (a.a && (c = g, d = h.da(), f = [ oa(f[0] + Math.abs(f[0] - f[2]) * a.W, Math.max(f[0], d[0]), Math.min(f[2], d[d.length - 2])), d[1] ], 
        c = void 0 !== a.a[c] ? a.a[c].Pd : new B(null), c.na(f), a.a[g] = {
            Pd: c,
            text: a.Va(b)
        }), a.c[g++] = h);
        return g;
    ...
    k.ai = function(a) {
        ...
        if (!this.i || !Wb(this.i, f)) {
            var g = Nb("EPSG:4326"), h = f.C(), l = f.ne, m = $b(l, g, f), n = l[2], p = l[1], q = l[0], r = m[3], u = m[2], x = m[1];
            m = m[0];
            this.f = l[3];
            this.j = n;
            this.l = p;
        ...
        if (-1 == d) this.g.length = this.c.length = 0, this.b && (this.b.length = 0), this.a && (this.a.length = 0); else {
            ...
            for (l = 0; u != this.s && l++ < g; ) u = Math.max(u - d, this.s), n = Pk(this, u, q, p, c, a, n);
            u = oa(e, this.s, this.j);
        ...
        if (this.b) for (a = 0, c = this.b.length; a < c; ++a) e = this.b[a], this.H.Gd(e.text), 
        b.kb(this.H), b.Hb(e.Pd);
        if (this.a) for (a = 0, c = this.a.length; a < c; ++a) e = this.a[a], this.B.Gd(e.text), 
        b.kb(this.B), b.Hb(e.Pd);
    };
    k.setMap = function(a) {
    ...
    k.load = function() {
        if (0 == this.state || 3 == this.state) this.state = 1, this.u(), this.g = [ Lc(this.N, "error", this.an, this), Lc(this.N, "load", this.bn, this) ], 
        this.c(this, this.i);
    };
    k.hh = function(a) {
        this.N = a;
    ...
    k.load = function() {
        if (0 == this.state || 3 == this.state) this.state = 1, this.u(), this.c = [ Lc(this.N, "error", this.Zm, this), Lc(this.N, "load", this.$m, this) ], 
        this.l(this, this.f);
    };
    function Wk(a) {
        a.c.forEach(Gc);
    ...
    fl.prototype.Ma = function(a, b, c, d, e, f, g, h, l, m, n) {
        ...
        p.uniform1f(f.a, g);
        if (void 0 === l) this.Nd(p, a, h, !1); else {
            m ? a = this.De(p, a, h, l, n) : (p.clear(p.COLOR_BUFFER_BIT | p.DEPTH_BUFFER_BIT), 
            this.Nd(p, a, h, !0), a = (a = l(null)) ? a : void 0);
            var fa = a;
        }
        this.Af(p, f);
        this.f && (q || p.disable(p.STENCIL_TEST), p.clear(p.STENCIL_BUFFER_BIT), p.stencilFunc(r, x, u), 
        p.stencilMask(C), p.stencilOp(z, V, E));
        return fa;
    };
    function hl(a, b, c, d) {
        a.drawElements(4, d - c, b.f ? 5125 : 5123, c * (b.f ? 4 : 2));
    }
    var il = [ 0, 0, 0, 1 ], jl = [], kl = [ 0, 0, 0, 1 ];
    function ll(a, b, c, d, e, f) {
        a = (c - a) * (f - b) - (e - a) * (d - b);
        return a <= ml && a >= -ml ? void 0 : 0 < a;
    }
    var ml = Number.EPSILON || 2220446049250313e-31;
    function nl(a) {
        this.b = void 0 !== a ? a : [];
        this.a = pl;
    }
    ...
    k.cc = function(a, b) {
        ...
        if (c) {
            ...
            this.a[b++] = this.P, this.a[b++] = a[f], this.a[b++] = a[f + 1], this.a[b++] = 1, 
            this.a[b++] = this.P, this.a[b++] = a[f], this.a[b++] = a[f + 1], this.a[b++] = 2, 
            this.a[b++] = this.P, this.a[b++] = a[f], this.a[b++] = a[f + 1], this.a[b++] = 3, 
            this.a[b++] = this.P, this.b[c++] = e, this.b[c++] = e + 1, this.b[c++] = e + 2, 
            this.b[c++] = e + 2, this.b[c++] = e + 3, this.b[c++] = e, e += 4;
        } else this.c.u && (this.l.pop(), this.l.length && (d = this.l[this.l.length - 1], 
        this.c.fillColor = d[0], this.c.strokeColor = d[1], this.c.lineWidth = d[2], this.c.u = !1));
    };
    k.eb = function() {
    ...
    k.zf = function(a, b, c, d) {
        var e = sl(b, al, bl);
        if (this.v) var f = this.v; else this.v = f = new cl(a, e);
        b.bd(e);
    ...
    k.De = function(a, b, c, d, e) {
        ...
        for (f = this.o.length - 1; 0 <= f; --f) {
            ...
            for (g = this.o[f]; 0 <= h && this.g[h] >= g; ) {
                ...
                var n = this.i[h];
                var p = w(n).toString();
                if (void 0 === c[p] && n.V() && (void 0 === e || fb(e, n.V().C())) && (a.clear(a.COLOR_BUFFER_BIT | a.DEPTH_BUFFER_BIT), 
                hl(a, b, m, l), l = d(n))) return l;
                h--;
                l = m;
            }
        }
    ...
    k.Oa = function(a, b) {
        ...
        this.c.strokeColor && gc(this.c.strokeColor, c) && this.c.fillColor && gc(this.c.fillColor, a) && this.c.lineWidth === b || (this.c.u = !0, 
        this.c.fillColor = a, this.c.strokeColor = c, this.c.lineWidth = b, this.l.push([ a, c, b ]));
    };
    var ul = new Zk("precision mediump float;varying vec2 a;varying float b;uniform float k;uniform sampler2D l;void main(void){vec4 texColor=texture2D(l,a);gl_FragColor.rgb=texColor.rgb;float alpha=texColor.a*b*k;if(alpha==0.0){discard;}gl_FragColor.a=alpha;}"), vl = new $k("varying vec2 a;varying float b;attribute vec2 c;attribute vec2 d;attribute vec2 e;attribute float f;attribute float g;uniform mat4 h;uniform mat4 i;uniform mat4 j;void main(void){mat4 offsetMatrix=i;if(g==1.0){offsetMatrix=i*j;}vec4 offsets=offsetMatrix*vec4(e,0.0,0.0);gl_Position=h*vec4(c,0.0,1.0)+offsets;a=d;b=f;}");
    function wl(a, b) {
        this.g = a.getUniformLocation(b, "h");
        this.i = a.getUniformLocation(b, "i");
        this.c = a.getUniformLocation(b, "j");
    ...
    function yl(a) {
        if (!a.i) {
            ...
            var d = zl(b, 1, 1), e = b.createRenderbuffer();
    ...
    k = Dl.prototype;
    k.Db = function(a) {
        var b = this.s, c = this.j, d = this.gg(!0), e = a.b;
        return function() {
            if (!e.isContextLost()) {
                var f;
                var g = 0;
    ...
    function El(a, b, c, d) {
        var e = a.D, f = a.B, g = a.height, h = a.oa, l = a.qa, m = a.opacity, n = a.G, p = a.O, q = a.rotateWithView ? 1 : 0, r = -a.rotation, u = a.scale, x = a.width, C = Math.cos(r);
        r = Math.sin(r);
        var z = a.b.length, E = a.a.length, V;
        for (V = 0; V < c; V += d) {
    ...
    k.zf = function(a, b) {
        var c = sl(b, ul, vl);
        if (this.Va) var d = this.Va; else this.Va = d = new wl(a, c);
        b.bd(c);
    ...
    k.De = function(a, b, c, d, e) {
        var f, g, h = this.g.length - 1, l = this.Zf();
        for (f = l.length - 1; 0 <= f; --f) {
            ...
            for (g = this.o[f]; 0 <= h && this.g[h] >= m; ) {
                ...
                var p = this.i[h];
                var q = w(p).toString();
                if (void 0 === c[q] && p.V() && (void 0 === e || fb(e, p.V().C())) && (a.clear(a.COLOR_BUFFER_BIT | a.DEPTH_BUFFER_BIT), 
                hl(a, b, n, g), g = d(p))) return g;
                g = n;
                h--;
            }
        }
    ...
    k.Zb = function(a) {
        var b = a.Uc(), c = a.Y(1), d = a.Ge(), e = a.Dg(1), f = a.i, g = a.ad(), h = a.s, l = a.f, m = a.nc();
        a = a.a;
        if (0 === this.l.length) this.l.push(c); else {
            var n = this.l[this.l.length - 1];
            w(n) != w(c) && (this.v.push(this.b.length), this.l.push(c));
        }
        0 === this.c.length ? this.c.push(e) : (n = this.c[this.c.length - 1], w(n) != w(e) && (this.o.push(this.b.length), 
        this.c.push(e)));
        this.D = b[0];
        this.B = b[1];
        this.height = m[1];
    ...
    v(Ll, fl);
    function Ml(a, b, c, d) {
        var e, f = a.a.length, g = a.b.length, h = "bevel" === a.c.lineJoin ? 0 : "miter" === a.c.lineJoin ? 1 : 2, l = "butt" === a.c.lineCap ? 0 : "square" === a.c.lineCap ? 1 : 2, m = Hl(b, c, d), n = g, p = 1;
        for (e = 0; e < c; e += d) {
            var q = f / 7;
            var r = u;
            var u = x || [ b[e], b[e + 1] ];
            if (0 === e) {
                ...
                if (m) {
                    ...
                    l && (f = Nl(a, [ 0, 0 ], u, x, p * Ol * l, f), f = Nl(a, [ 0, 0 ], u, x, -p * Ol * l, f), 
                ...
                m ? x = C : (r = r || [ 0, 0 ], f = Nl(a, r, u, [ 0, 0 ], p * Ql * (l || 1), f), 
                f = Nl(a, r, u, [ 0, 0 ], -p * Ql * (l || 1), f), a.b[g++] = q, a.b[g++] = n - 1, 
                a.b[g++] = n, a.b[g++] = n, a.b[g++] = q + 1, a.b[g++] = q, l && (f = Nl(a, r, u, [ 0, 0 ], p * Rl * l, f), 
                f = Nl(a, r, u, [ 0, 0 ], -p * Rl * l, f), a.b[g++] = q + 2, a.b[g++] = q, a.b[g++] = q + 1, 
        ...
        m && (q = q || f / 7, z = Nf([ r[0], r[1], u[0], u[1], x[0], x[1] ], 0, 6, 2) ? 1 : -1, 
        f = Nl(a, r, u, x, z * Sl * (h || 1), f), Nl(a, r, u, x, -z * Ul * (h || 1), f), 
        a.b[g++] = q, a.b[g++] = n - 1, a.b[g++] = n, a.b[g++] = q + 1, a.b[g++] = q, a.b[g++] = 0 < p * z ? n : n - 1);
    }
    ...
    k.tc = function(a, b) {
        var c = a.da();
        a = a.pa();
        Wl(c, 0, c.length, a) && (c = Te(c, 0, c.length, a, -this.origin[0], -this.origin[1]), 
        this.c.u && (this.l.push(this.b.length), this.c.u = !1), this.g.push(this.b.length), 
        this.i.push(b), Ml(this, c, c.length, a));
    };
    k.uc = function(a, b) {
        var c = this.b.length, d = a.ob();
        d.unshift(0);
        var e = a.da();
        a = a.pa();
        var f;
        if (1 < d.length) {
            var g = 1;
            for (f = d.length; g < f; ++g) if (Wl(e, d[g - 1], d[g], a)) {
                var h = Te(e, d[g - 1], d[g], a, -this.origin[0], -this.origin[1]);
                Ml(this, h, h.length, a);
            }
        }
        this.b.length > c && (this.g.push(c), this.i.push(b), this.c.u && (this.l.push(c), 
        this.c.u = !1));
    };
    function Xl(a, b, c, d) {
        ...
        if (c.length) {
            var e;
            b = 0;
            for (e = c.length; b < e; ++b) Hl(c[b], c[b].length, d) || (c[b].push(c[b][0]), 
            c[b].push(c[b][1])), Ml(a, c[b], c[b].length, d);
        }
    }
    function Yl(a, b, c) {
    ...
    k.zf = function(a, b, c, d) {
        var e = sl(b, Il, Jl);
        if (this.v) var f = this.v; else this.v = f = new Kl(a, e);
        b.bd(e);
    ...
    k.Oa = function(a, b) {
        ...
        b = b.l;
        b = void 0 !== b ? b : 10;
        this.c.strokeColor && gc(this.c.strokeColor, a) && this.c.lineWidth === c && this.c.miterLimit === b || (this.c.u = !0, 
        this.c.strokeColor = a, this.c.lineWidth = c, this.c.miterLimit = b, this.o.push([ a, c, b ]));
    };
    var Pl = 3, Ql = 5, Ol = 7, Rl = 11, Sl = 13, Tl = 17, Ul = 19, Vl = 23;
    var $l = new Zk("precision mediump float;uniform vec4 e;uniform float f;void main(void){gl_FragColor=e;float alpha=e.a*f;if(alpha==0.0){discard;}gl_FragColor.a=alpha;}"), am = new $k("attribute vec2 a;uniform mat4 b;uniform mat4 c;uniform mat4 d;void main(void){gl_Position=b*vec4(a,0.0,1.0);}");
    function bm(a, b) {
    ...
    function sm(a, b, c, d, e, f) {
        ...
        } else for (p = b.length - c, n = f = ym(a, b[p], b[p + 1], h++), p -= c, g = 0; p >= g; p -= c) q = ym(a, b[p], b[p + 1], h++), 
        m.push(zm(n, q, d)), l.push([ Math.min(n.x, q.x), Math.min(n.y, q.y), Math.max(n.x, q.x), Math.max(n.y, q.y) ]), 
        n = q;
        m.push(zm(q, f, d));
        l.push([ Math.min(n.x, q.x), Math.min(n.y, q.y), Math.max(n.x, q.x), Math.max(n.y, q.y) ]);
        e.load(l, m);
    ...
    function um(a, b, c) {
        var d = em(a), e = d, f = fm(a), g = !1;
        do {
            var h = c ? ll(f.X.x, f.X.y, e.X.x, e.X.y, e.Z.x, e.Z.y) : ll(e.Z.x, e.Z.y, e.X.x, e.X.y, f.X.x, f.X.y);
            void 0 === h ? (Am(e, f, a, b), g = !0, f === d && (d = gm(a)), f = e, hm(a)) : e.X.Kb !== h && (e.X.Kb = h, 
            g = !0);
            e = f;
            f = fm(a);
        } while (e !== d);
    ...
    function wm(a, b, c, d, e) {
        ...
        for (h = l.length; m < h; ++m) {
            var n = l[m], p = Bm(b, d, n.Z, n.X, !0), q = Math.abs(b.x - p[0]);
        ...
        l = f.X;
        if (0 < g && (f = Cm(b, r, f.X, e), f.length)) for (r = Infinity, m = 0, h = f.length; m < h; ++m) if (g = f[m], 
        n = Math.atan2(b.y - g.y, d.x - g.x), n < r || n === r && g.x < l.x) r = n, l = g;
        for (f = em(c); f.X.x !== l.x || f.X.y !== l.y; ) f = fm(c);
        d = {
            x: b.x,
            y: b.y,
            pb: b.pb,
    ...
    function xm(a, b, c) {
        for (var d = !1, e = Dm(b, c); 3 < b.c; ) if (e) {
            if (!Em(a, b, c, e, d) && !um(b, c, d) && !Fm(a, b, c, !0)) break;
        } else if (!Em(a, b, c, e, d) && !um(b, c, d) && !Fm(a, b, c)) if (e = Dm(b, c)) {
            d = b;
            var f = 2 * d.c, g = Array(f), h = em(d), l = h, m = 0;
            do {
            ...
            do {
                ...
                if (h.length) {
                    ...
                    zm(h, f.X, l, m);
                    f.X = h;
                    lm(c, [ Math.min(f.Z.x, h.x), Math.min(f.Z.y, h.y), Math.max(f.Z.x, h.x), Math.max(f.Z.y, h.y) ], f);
    ...
    function Em(a, b, c, d, e) {
        var f = a.b.length, g = em(b), h = im(b), l = g, m = fm(b), n = gm(b), p = !1;
        do {
            var q = l.Z;
            var r = l.X;
            var u = m.X;
            if (!1 === r.Kb) {
                ...
                !d && 0 !== vm({
                    Z: q,
                    X: u
                }, c).length || !x || !d && !1 !== q.Kb && !1 !== u.Kb && Nf([ h.Z.x, h.Z.y, q.x, q.y, r.x, r.y, u.x, u.y, n.X.x, n.X.y ], 0, 10, 2) !== !e || (a.b[f++] = q.pb, 
                a.b[f++] = r.pb, a.b[f++] = u.pb, Am(l, m, b, c), m === g && (g = n), p = !0);
            }
            h = im(b);
            l = jm(b);
            m = fm(b);
    ...
    function Fm(a, b, c, d) {
        ...
        do {
            ...
            if (l) {
                h = a.b.length;
                var m = a.a.length / 2, n = hm(b);
                dm(b);
                c.remove(n);
                var p = n === e;
                d ? (l[0] === f.Z.x && l[1] === f.Z.y ? (hm(b), l = f.Z, g.Z = l, c.remove(f), p = p || f === e) : (l = g.X, 
                f.X = l, c.remove(g), p = p || g === e), dm(b)) : (l = ym(a, l[0], l[1], m), f.X = l, 
                g.Z = l, lm(c, [ Math.min(f.Z.x, f.X.x), Math.min(f.Z.y, f.X.y), Math.max(f.Z.x, f.X.x), Math.max(f.Z.y, f.X.y) ], f), 
                lm(c, [ Math.min(g.Z.x, g.X.x), Math.min(g.Z.y, g.X.y), Math.max(g.Z.x, g.X.x), Math.max(g.Z.y, g.X.y) ], g));
                a.b[h++] = n.Z.pb;
                a.b[h++] = n.X.pb;
                a.b[h++] = l.pb;
                h = !0;
    ...
    function zm(a, b, c, d) {
        ...
        if (g) {
            ...
            h && (h.Eb = f);
            g === c.a && (c.a = f);
        } else c.g = f, c.a = f, c.i && (f.next = f, f.Eb = f);
        c.b = f;
        c.c++;
    ...
    function Cm(a, b, c, d, e) {
        var f, g, h = [], l = nm(d, [ Math.min(a.x, b.x, c.x), Math.min(a.y, b.y, c.y), Math.max(a.x, b.x, c.x), Math.max(a.y, b.y, c.y) ]);
        d = 0;
    ...
    function Bm(a, b, c, d, e) {
        ...
        c = ((b.x - a.x) * (a.y - c.y) - (b.y - a.y) * (a.x - c.x)) / f, !e && d > ml && d < 1 - ml && c > ml && c < 1 - ml || e && 0 <= d && 1 >= d && 0 <= c && 1 >= c)) return [ a.x + d * (b.x - a.x), a.y + d * (b.y - a.y) ];
    }
    ...
    k = qm.prototype;
    k.wc = function(a, b) {
        var c = a.rd(), d = a.pa(), e = this.b.length, f = this.f.b.length;
        a = a.da();
        var g, h, l;
        var m = h = 0;
        ...
        this.b.length > e && (this.g.push(e), this.i.push(b), this.l.u && (this.c.push(e), 
        this.l.u = !1));
        this.f.b.length > f && Yl(this.f, b, f);
    };
    k.yc = function(a, b) {
        var c = a.ob(), d = a.pa();
        if (0 < c.length) {
    ...
    k.zf = function(a, b) {
        var c = sl(b, $l, am);
        if (this.v) var d = this.v; else this.v = d = new bm(a, c);
        b.bd(c);
        a.enableVertexAttribArray(d.b);
    ...
    k.Oa = function(a, b) {
        ...
        this.l.fillColor && gc(a, this.l.fillColor) || (this.l.fillColor = a, this.l.u = !0, 
        this.o.push(a));
    ...
    Hm.prototype.add = function(a, b, c, d, e) {
        ...
        for (f = this.a.length; g < f; ++g) {
            ...
            if (h.width >= b + this.b && h.height >= c + this.b) return f = {
                ...
                offsetY: h.y + this.b,
                image: this.i
            }, this.c[a] = f, d.call(e, this.g, h.x + this.b, h.y + this.b), a = g, b += this.b, 
    ...
    function Mm(a, b, c, d, e, f, g) {
        ...
        for (l = h.length; m < l; ++m) {
            ...
            n || m !== l - 1 || (b ? (n = Math.min(2 * a.c, a.g), a.c = n) : (n = Math.min(2 * a.a, a.g), 
            a.a = n), n = new Hm(n, a.b), h.push(n), ++l);
        }
        return null;
    }
    function Nm(a, b) {
            ...
            for (g = b.length; f < g; ++f) {
                ...
                for (h = r.length; u < h; ++u) {
                    ...
                    if (x) {
                        ...
                        this.oa = z.height;
                        this.qa = z.width;
                        0 === this.c.length ? this.c.push(z) : (x = this.c[this.c.length - 1], w(x) != w(z) && (this.v.push(this.b.length), 
                        this.c.push(z)));
                        x = c;
                        C = d;
                        var E = e;
    ...
    k.kb = function(a) {
        var b = this.P, c = a.Ea(), d = a.Fa();
        if (a && a.Ka() && (c || d)) {
            c ? (c = c.b, b.fillColor = pi(c ? c : il)) : b.fillColor = null;
            d ? (c = d.a, b.strokeColor = pi(c ? c : kl), b.lineWidth = d.c || 1, b.lineCap = d.f || "round", 
            b.lineDashOffset = d.i || 0, b.lineJoin = d.j || "round", b.miterLimit = d.l || 10, 
            d = d.g, b.lineDash = d ? d.slice() : jl) : (b.strokeColor = null, b.lineWidth = 0);
            ...
            e = c;
            this.H[e] || (a = this.Ub.getContext("2d"), a.font = b.font, a = Math.ceil((1.5 * a.measureText("M").width + b.lineWidth / 2) * b.scale), 
            this.H[e] = {
                zh: new Jm({
                    space: b.lineWidth + 1
                }),
    ...
    function Um(a, b, c, d, e, f, g, h, l, m, n) {
        var p = Vm, q = Object.keys(a.a).map(Number);
        q.sort(function(a, b) {
            return b - a;
        });
        var r, u;
    ...
    k.xc = function(a, b) {
        var c = this.b, d = new Qm(1, this.c), e = d.Ja(0, "Image");
        e.Zb(this.o);
        e.xc(a, b);
        e.eb(c);
    ...
    k.tc = function(a, b) {
        var c = this.b, d = new Qm(1, this.c), e = d.Ja(0, "LineString");
        e.Oa(null, this.s);
        e.tc(a, b);
        e.eb(c);
        e.Ma(this.b, this.g, this.f, this.j, this.l, this.i, 1, {}, void 0, !1);
    ...
    k.yc = function(a, b) {
        var c = this.b, d = new Qm(1, this.c), e = d.Ja(0, "Polygon");
        e.Oa(this.v, this.s);
        e.yc(a, b);
        e.eb(c);
        e.Ma(this.b, this.g, this.f, this.j, this.l, this.i, 1, {}, void 0, !1);
    ...
    k.cc = function(a, b) {
        var c = this.b, d = new Qm(1, this.c), e = d.Ja(0, "Circle");
        e.Oa(this.v, this.s);
        e.cc(a, b);
        e.eb(c);
        e.Ma(this.b, this.g, this.f, this.j, this.l, this.i, 1, {}, void 0, !1);
    ...
    var Zm = new Zk("precision mediump float;varying vec2 a;uniform float f;uniform sampler2D g;void main(void){vec4 texColor=texture2D(g,a);gl_FragColor.rgb=texColor.rgb;gl_FragColor.a=texColor.a*f;}"), $m = new $k("varying vec2 a;attribute vec2 b;attribute vec2 c;uniform mat4 d;uniform mat4 e;void main(void){gl_Position=e*vec4(b,0.,1.);a=(d*vec4(c,0.,1.)).st;}");
    function an(a, b) {
    ...
    bn.prototype.Wi = function(a, b, c) {
        ...
        gl(c, 34962, this.W);
        var d = c.b, e = sl(c, Zm, $m);
        if (this.o) var f = this.o; else this.o = f = new an(d, e);
        c.bd(e) && (d.enableVertexAttribArray(f.b), d.vertexAttribPointer(f.b, 2, 5126, !1, 16, 0), 
    ...
    function fn(a, b, c, d) {
        ...
        void 0 !== b && (c /= b);
        b = a.C();
        if (!b || Ha(b, e)) a = Mb(a, c, e) / c, isFinite(a) && 0 < a && (c /= a);
        return c;
    }
    function gn(a, b, c, d) {
        a = c - a;
    ...
    function hn(a, b, c, d, e, f, g, h, l, m, n) {
        ...
        var r = gg(Math.round(c * ab(q) / d), Math.round(c * bb(q) / d)), u = c / d;
        l.forEach(function(a) {
        ...
        h.c.forEach(function(a) {
            ...
            a = (e[0][0] - x[0]) / f;
            var n = -(e[0][1] - x[1]) / f, u = (e[1][0] - x[0]) / f, C = -(e[1][1] - x[1]) / f, N = (e[2][0] - x[0]) / f, hc = -(e[2][1] - x[1]) / f;
            e = b[0][0];
            b = b[0][1];
            g -= e;
            h -= b;
            ...
            a: {
                ...
                for (l = 0; l < h; l++) {
                    ...
                    g[m] = g[l];
                    g[l] = ib;
                    for (m = l + 1; m < h; m++) for (ib = -g[m][l] / g[l][l], jc = l; jc < h + 1; jc++) g[m][jc] = l == jc ? 0 : g[m][jc] + ib * g[l][jc];
                }
                l = Array(h);
                for (m = h - 1; 0 <= m; m--) for (l[m] = g[m][h] / g[m][m], ib = m - 1; 0 <= ib; ib--) g[ib][h] -= g[ib][m] * l[m];
                g = l;
            }
            g && (p.save(), p.beginPath(), l = (a + u + N) / 3, m = (n + C + hc) / 3, h = gn(l, m, a, n), 
            u = gn(l, m, u, C), N = gn(l, m, N, hc), p.moveTo(u[0], u[1]), p.lineTo(h[0], h[1]), 
            p.lineTo(N[0], N[1]), p.clip(), p.transform(g[0], g[2], g[1], g[3], a, n), p.translate(q[0] - e, q[3] - b), 
            p.scale(d / c, -d / c), p.drawImage(r.canvas, 0, 0), p.restore());
        });
        n && (p.save(), p.strokeStyle = "black", p.lineWidth = 1, h.c.forEach(function(a) {
            var b = a.target;
            a = (b[0][0] - x[0]) / f;
            var c = -(b[0][1] - x[1]) / f, d = (b[1][0] - x[0]) / f, e = -(b[1][1] - x[1]) / f, g = (b[2][0] - x[0]) / f;
            b = -(b[2][1] - x[1]) / f;
            p.beginPath();
            p.moveTo(d, e);
            p.lineTo(a, c);
    ...
    function kn(a, b, c, d, e, f, g, h, l, m) {
        var n = Ba([ f, g, h, l ]), p = a.b ? ab(n) / a.b : null, q = a.b, r = a.g.g && .5 < p && 1 > p, u = !1;
        if (0 < m) {
            if (a.i.c && a.j) {
                var x = Ba([ b, c, d, e ]);
                u |= .25 < ab(x) / a.j;
        ...
        if (u || !a.f || fb(n, a.f)) {
            ...
            if (0 < m && (u || (n = a.a([ (b[0] + d[0]) / 2, (b[1] + d[1]) / 2 ]), q = r ? (va(f[0], q) + va(h[0], q)) / 2 - va(n[0], q) : (f[0] + h[0]) / 2 - n[0], 
            n = (f[1] + h[1]) / 2 - n[1], u = q * q + n * n > a.v), u)) {
                Math.abs(b[0] - d[0]) <= Math.abs(b[1] - d[1]) ? (r = [ (c[0] + d[0]) / 2, (c[1] + d[1]) / 2 ], 
                q = a.a(r), n = [ (e[0] + b[0]) / 2, (e[1] + b[1]) / 2 ], p = a.a(n), kn(a, b, c, r, n, f, g, q, p, m - 1), 
                kn(a, n, r, d, e, p, q, h, l, m - 1)) : (r = [ (b[0] + c[0]) / 2, (b[1] + c[1]) / 2 ], 
                q = a.a(r), n = [ (d[0] + e[0]) / 2, (d[1] + e[1]) / 2 ], p = a.a(n), kn(a, b, r, n, e, f, q, p, l, m - 1), 
                kn(a, r, c, d, n, q, g, h, p, m - 1));
                return;
            }
            if (r) {
                if (!a.s) return;
    ...
    mn.prototype.load = function() {
        if (0 == this.state) {
            ...
            2 == a || 3 == a ? this.fe() : (this.ie = y(this.Tb, "change", function() {
                var a = this.Tb.getState();
                if (2 == a || 3 == a) Gc(this.ie), this.ie = null, this.fe();
            }, this), this.Tb.load());
        }
    };
    function nn(a) {
    ...
    qn.prototype.Y = function(a, b, c, d) {
        ...
        if (e && d && !Wb(e, d)) {
            if (this.i) {
                if (this.va == this.g && Wb(this.i.s, d) && this.i.resolution == b && Ra(this.i.C(), a)) return this.i;
                Pc(this.i);
                this.i = null;
            }
    ...
    v(sn, Qc);
    var tn = "imageloadstart", un = "imageloadend", vn = "imageloaderror";
    function xn(a) {
        qn.call(this, {
            attributions: a.attributions,
            logo: a.logo,
    ...
    xn.prototype.Vc = function(a, b, c, d) {
        b = rn(this, b);
        var e = this.aa;
        if (e && this.ca == this.g && e.resolution == b && e.a == c && Ka(e.C(), a)) return e;
        a = a.slice();
        gb(a, this.Xa);
    ...
    k.Hk = function(a, b, c, d, e) {
        ...
        this.a.dc(a, function(a) {
            ...
            if (!(d = g)) {
                ...
                if (e) {
                    ...
                    Array.isArray(e) || (e = [ e ]);
                    d = 0;
                    for (h = e.length; d < h; ++d) p = Sj(f, a, e[d], Rj(b, c), this.Jo, this) || p;
                    d = p;
                } else d = !1;
            }
            g = d;
        ...
        Mj(f);
        if (g) return null;
        this.l[0] != d[0] || this.l[1] != d[1] ? (this.f.canvas.width = d[0], this.f.canvas.height = d[1], 
        this.l[0] = d[0], this.l[1] = d[1]) : this.f.clearRect(0, 0, d[0], d[1]);
    ...
    An.prototype.Ag = function(a, b) {
        var c = this.c.g, d = a.pixelRatio, e = a.viewState, f = e.center, g = e.resolution, h = e.rotation, l = this.N, m = this.Mb, n = this.a.ia(), p = a.viewHints, q = a.extent;
        void 0 !== b.extent && (q = eb(q, b.extent));
        p[0] || p[1] || $a(q) || (b = n.Y(q, g, d, e.projection)) && Di(this, b) && (l = b, 
        m = Bn(this, b), this.Mb && a.postRenderFunctions.push(function(a, b) {
            a.isContextLost() || a.deleteTexture(b);
        }.bind(null, c, this.Mb)));
        l && (c = this.c.i.j, Cn(this, c.width, c.height, d, f, g, h, l.C()), this.l = null, 
        d = this.v, We(d), bf(d, 1, -1), cf(d, 0, -1), this.N = l, this.Mb = m, Fi(a, n));
        return !!l;
    };
    ...
    An.prototype.yg = function(a, b, c, d) {
        if (this.N && this.N.Y()) if (this.a.ia() instanceof yn) {
            var e = $e(b.pixelToCoordinateTransform, a.slice());
            if (this.Ga(e, b, 0, Qe, this)) return c.call(d, this.a, null);
        } else {
            ...
            a = $e(this.l, a.slice());
            if (!(0 > a[0] || a[0] > e[0] || 0 > a[1] || a[1] > e[1]) && (this.i || (this.i = gg(1, 1)), 
            this.i.clearRect(0, 0, 1, 1), this.i.drawImage(this.N.Y(), a[0], a[1], 1, 1, 0, 0, 1, 1), 
    ...
    function En(a, b, c, d) {
        var e = a.g, f = b.ib();
        if (a.a.a.hasOwnProperty(f)) a = a.a.get(f), e.bindTexture(3553, a.Mb), 9729 != a.ei && (e.texParameteri(3553, 10240, 9729), 
        a.ei = 9729), 9729 != a.gi && (e.texParameteri(3553, 10241, 9729), a.gi = 9729); else {
    ...
    k.Uk = function(a, b) {
        ...
        for (var c; 1024 < this.a.i - this.f; ) {
            if (c = this.a.g.Nc) a.deleteTexture(c.Mb); else if (+this.a.g.ic == b.index) break; else --this.f;
            this.a.pop();
        }
    };
    k.T = function() {
    ...
    k.Ga = function(a, b, c, d, e, f, g) {
        ...
        for (m = l.length - 1; 0 <= m; --m) {
            var n = l[m];
            var p = n.layer;
            if (wg(n, h.resolution) && f.call(g, p) && (n = Yi(this, p).Ga(a, b, c, d, e))) return n;
        }
    };
    k.Ri = function(a, b, c, d, e) {
        c = !1;
        ...
        for (h = g.length - 1; 0 <= h; --h) {
            var l = g[h], m = l.layer;
            if (wg(l, f.resolution) && d.call(e, m) && (c = Yi(this, m).bf(a, b))) return !0;
        }
        return c;
    };
    k.Qi = function(a, b, c, d, e) {
        ...
        for (h = g.length - 1; 0 <= h; --h) {
            var l = g[h];
            var m = l.layer;
            if (wg(l, f.resolution) && e.call(d, m) && (l = Yi(this, m).yg(a, b, c, d))) return l;
        }
    };
    var Hn = new Zk("precision mediump float;varying vec2 a;uniform sampler2D e;void main(void){gl_FragColor=texture2D(e,a);}"), In = new $k("varying vec2 a;attribute vec2 b;attribute vec2 c;uniform vec4 d;void main(void){gl_Position=vec4(b*d.xy+d.zw,0.,1.);a=c;}");
    function Jn(a, b) {
        this.c = a.getUniformLocation(b, "d");
    ...
    k.Ag = function(a, b, c) {
        var d = this.c, e = c.b, f = a.viewState, g = f.projection, h = this.a, l = h.ia(), m = l.bb(g), n = m.Bc(f.resolution), p = m.Sa(n), q = l.Yd(n, a.pixelRatio, g), r = q[0] / Aa(m.Za(n), this.O)[0], u = p / r, x = l.Xc(r) * l.Xf(g), C = f.center, z = a.extent, E = tc(m, z, n);
        if (this.l && la(this.l, E) && this.s == l.g) u = this.D; else {
            var V = [ E.la - E.fa + 1, E.ka - E.ea + 1 ], ya = ra(Math.max(V[0] * q[0], V[1] * q[1]));
            V = u * ya;
            var fa = m.Gc(n), pa = fa[0] + E.fa * q[0] * u;
            u = fa[1] + E.ea * q[1] * u;
            u = [ pa, u, pa + V, u + V ];
            cn(this, a, ya);
            ...
            c = {};
            c[n] = {};
            var Ja = this.Pf(l, g, c), ma = h.i();
            ya = !0;
            pa = Ca();
            var Sa = new ia(0, 0, 0, 0), N, hc;
            for (N = E.fa; N <= E.la; ++N) for (hc = E.ea; hc <= E.ka; ++hc) {
                fa = l.$c(n, N, hc, r, g);
                if (void 0 !== b.extent) {
                    var ib = m.La(fa.xa, pa);
                    if (!fb(ib, b.extent)) continue;
                }
                ib = fa.getState();
            ...
            var jc;
            ma = 0;
            for (Sa = b.length; ma < Sa; ++ma) for (jc in N = c[b[ma]], N) fa = N[jc], ib = m.La(fa.xa, pa), 
            Ja[0] = 2 * (ib[2] - ib[0]) / V, Ja[1] = 2 * (ib[3] - ib[1]) / V, Ja[2] = 2 * (ib[0] - u[0]) / V - 1, 
            Ja[3] = 2 * (ib[1] - u[1]) / V - 1, e.uniform4fv(this.i.c, Ja), En(d, fa, q, x * r), 
            e.drawArrays(5, 0, 4);
            ya ? (this.l = E, this.D = u, this.s = l.g) : (this.D = this.l = null, this.s = -1, 
            a.animate = !0);
        }
        ...
        bf(e, a.size[0] * f.resolution / (u[2] - u[0]), a.size[1] * f.resolution / (u[3] - u[1]));
        cf(e, -.5, -.5);
        return !0;
    };
    ...
    k.Wi = function(a, b, c) {
        ...
        e && !e.wg() && (h.enable(h.SCISSOR_TEST), h.scissor(0, 0, f[0] * g, f[1] * g), 
        e.Ma(c, d.center, d.resolution, d.rotation, f, g, b.opacity, b.Se ? a.skippedFeatureUids : {}), 
    ...
    k.yg = function(a, b, c, d) {
        a = $e(b.pixelToCoordinateTransform, a.slice());
        if (this.bf(a, b)) return c.call(d, this.a, null);
    };
    k.Xi = function() {
        Ci(this);
    };
    k.Ag = function(a, b, c) {
        function d(a) {
            var b = a.fb();
            if (b) var c = b.call(a, m); else (b = e.fb()) && (c = b(a, m));
            if (c) {
                if (c) {
                    b = !1;
                    if (Array.isArray(c)) for (var d = c.length - 1; 0 <= d; --d) b = Sj(q, a, c[d], Rj(m, n), this.Xi, this) || b; else b = Sj(q, a, c, Rj(m, n), this.Xi, this) || b;
                    a = b;
                } else a = !1;
                this.s = this.s || a;
            }
        ...
        b = e.ia();
        Fi(a, b);
        var f = a.viewHints[0], g = a.viewHints[1], h = e.aa, l = e.ca;
    ...
    k.bm = function() {
        ...
        var a = this.Ue();
        a && (this.c = y(a, "postrender", this.render, this), Sn(this), a = this.stopEvent ? a.v : a.o, 
    ...
    k.hm = function() {
        ...
        if (this.get(Qn) && this.autoPan) {
            var a = this.Ue();
            if (a && a.Ac()) {
                var b = Tn(a.Ac(), a.Cb()), c = this.Qd(), d = c.offsetWidth, e = getComputedStyle(c);
                ...
                Ka(b, g) || (d = g[0] - b[0], e = b[2] - g[2], f = g[1] - b[1], g = b[3] - g[3], 
                b = [ 0, 0 ], 0 > d ? b[0] = d - c : 0 > e && (b[0] = Math.abs(e) + c), 0 > f ? b[1] = f - c : 0 > g && (b[1] = Math.abs(g) + c), 
                0 === b[0] && 0 === b[1]) || (c = a.$().wa(), c = a.Ia(c), b = [ c[0] + b[0], c[1] + b[1] ], 
                a.$().animate({
                    center: a.Pa(b),
    ...
    function Sn(a) {
        ...
        if (b && b.c && c) {
            ...
            var g = e[0];
            e = e[1];
            if ("bottom-right" == f || "center-right" == f || "top-right" == f) "" !== a.a.Re && (a.a.Re = b.left = ""), 
            g = Math.round(d[0] - c[0] - g) + "px", a.a.vf != g && (a.a.vf = b.right = g); else {
            ...
            if ("bottom-left" == f || "bottom-center" == f || "bottom-right" == f) "" !== a.a.Cf && (a.a.Cf = b.top = ""), 
            c = Math.round(d[1] - c[1] - e) + "px", a.a.ye != c && (a.a.ye = b.bottom = c); else {
    ...
    var Nn = "element", On = "map", Pn = "offset", Qn = "position", Rn = "positioning";
    ...
    Xn.prototype.B = function(a) {
        a.preventDefault();
        Zn() && (a = this.a) && (Yn() ? document.exitFullscreen ? document.exitFullscreen() : document.msExitFullscreen ? document.msExitFullscreen() : document.mozCancelFullScreen ? document.mozCancelFullScreen() : document.webkitExitFullscreen && document.webkitExitFullscreen() : (a = this.j ? "string" === typeof this.j ? document.getElementById(this.j) : this.j : a.Ac(), 
        this.D ? a.mozRequestFullScreenWithKeys ? a.mozRequestFullScreenWithKeys() : a.webkitRequestFullscreen ? a.webkitRequestFullscreen(Element.ALLOW_KEYBOARD_INPUT) : $n(a) : $n(a)));
    };
    Xn.prototype.o = function() {
        var a = this.element.firstElementChild, b = this.a;
        Yn() ? (a.className = this.c + "-true", hg(this.v, this.l)) : (a.className = this.c + "-false", 
        hg(this.l, this.v));
        b && b.Mc();
    };
    ...
    function fo(a, b) {
        ...
        if (b && a.c) {
            ...
            if (b = a.a.Pa(b)) a.j(b, b), c = (c = a.Nh()) ? c(b) : b.toString();
        }
        a.v && c == a.v || (a.element.innerHTML = c, a.v = c);
    }
    var eo = "projection", go = "coordinateFormat";
    function ho(a) {
        function b(a) {
            a = h.Rd(a);
            l.a.$().tb(a);
        ...
        var l = this, m = this.v, n = this.v.Qd();
    ...
    k.setMap = function(a) {
        var b = this.a;
        a !== b && (b && ((b = b.$()) && Mc(b, Xc("rotation"), this.Pe, this), this.c.yd(null)), 
        tg.prototype.setMap.call(this, a), a && (this.c.yd(this.B), this.s.push(y(a, "propertychange", this.cm, this)), 
        0 === this.c.We().jc() && this.c.xf(a.gc()), a = a.$())) && (y(a, Xc("rotation"), this.Pe, this), 
        $f(a) && (this.c.Mc(), jo(this)));
    };
    k.cm = function(a) {
        "view" === a.key && ((a = a.oldValue) && Mc(a, Xc("rotation"), this.Pe, this), a = this.a.$(), 
        y(a, Xc("rotation"), this.Pe, this));
    };
    k.Pe = function() {
        this.c.$().ae(this.a.$().Ra());
    };
    function io() {
        ...
        if (a.c && b.c) {
            ...
            var d = b.Cb();
            c = b.$().od(d);
            var e = b.Ia(Ya(a)), f = b.Ia(Wa(a));
            b = Math.abs(e[0] - f[0]);
            e = Math.abs(e[1] - f[1]);
            f = d[0];
            d = d[1];
            b < .1 * f || e < .1 * d || b > .75 * f || e > .75 * d ? jo(this) : Ka(c, a) || (a = this.c, 
            c = this.a.$(), a.$().tb(c.wa()));
        }
        ko(this);
    }
    ...
    function qo(a) {
        ...
        if (b) {
            ...
            var f = a.v * b;
            c = "";
            "degrees" == e ? (c = tb.degrees, "degrees" == d.a ? f *= c : b /= c, f < c / 60 ? (c = "″", 
            ...
            b *= 39.37) : 1609.344 > f ? (c = "ft", b /= .30480061) : (c = "mi", b /= 1609.3472) : na(!1, 33);
    ...
    function ro(a) {
        ...
        y(this.l, "pointerup", this.Ql, this);
    ...
    k.Rl = function(a) {
        this.o || a.b.target !== this.element.firstElementChild || (ag(this.a.$(), 1, 1), 
        this.B = a.clientX, this.H = a.clientY, this.o = !0);
    };
    k.Pl = function(a) {
        if (this.o) {
        ...
        return function(e, f, g) {
            ...
            h.onload = function() {
                if (!h.status || 200 <= h.status && 300 > h.status) {
                    var a = b.T();
                    if ("json" == a || "text" == a) var e = h.responseText; else "xml" == a ? (e = h.responseXML) || (e = Do(h.responseText)) : "arraybuffer" == a && (e = h.response);
    ...
    function Uo(a, b, c) {
        var d = c ? Nb(c.featureProjection) : null, e = c ? Nb(c.dataProjection) : null, f;
    ...
    k.Ek = function(a) {
        ...
        } else this.A = a.da().slice(), a = a.ob().slice(), this.c.push();
        this.c.push(a);
        this.u();
    };
    k.clone = function() {
    ...
    k.On = function() {
        var a = yi(this), b = this.c, c = 0, d = 0, e;
        var f = 0;
    ...
    function yi(a) {
        if (a.G != a.g) {
            ...
            a: {
                ...
                var d;
                var e = 0;
                for (d = c.length; e < d; ++e) if (!Of(b, c[e], a.a, void 0)) {
                    c = !1;
                    break a;
                }
                c = !0;
    ...
    k.$a = function(a) {
        a: {
            var b = yi(this), c = this.c, d = this.a, e = 0, f;
            var g = 0;
            for (f = c.length; g < f; ++g) {
                var h = c[g];
                if (Mf(b, e, h, d, a)) {
    ...
    k.na = function(a, b) {
        if (a) {
            ...
            var f = 0, g;
            var h = 0;
            for (g = a.length; h < g; ++h) e = yf(b, e, a[h], c, d[f]), d[f++] = e, e = e[e.length - 1];
            d.length = f;
    ...
    function $o(a, b) {
        ...
        if ("number" === typeof a.x && "number" === typeof a.y) var c = "Point"; else if (a.points) c = "MultiPoint"; else if (a.paths) c = 1 === a.paths.length ? "LineString" : "MultiLineString"; else if (a.rings) {
            ...
            for (;c.length; ) {
                d = c.shift();
                e = !1;
                for (l = g.length - 1; 0 <= l; l--) if (Ka(new Ef(g[l][0]).C(), new Ef(d).C())) {
                    g[l].push(d);
                    e = !0;
                    break;
                }
    ...
    k.Lg = function(a, b) {
        ...
        if (a.features) {
            ...
            a = 0;
            for (e = d.length; a < e; ++a) c.push(this.cd(d[a], b));
            return c;
        }
        return [ this.cd(a, b) ];
    };
    ...
    k.pe = function(a, b) {
        ...
        var c = [], d;
        var e = 0;
        for (d = a.length; e < d; ++e) c.push(this.kd(a[e], b));
        return {
            features: c
        };
    };
    ...
    k.Yb = function(a, b) {
        return Bo(a) ? zp(this, a, b) : Co(a) ? this.Kg(a, b) : "string" === typeof a ? (a = Do(a), 
        zp(this, a, b)) : null;
    };
    function zp(a, b, c) {
        a = Ap(a, b, c);
    ...
    k.Na = function(a, b) {
        return Bo(a) ? Ap(this, a, b) : Co(a) ? this.Ic(a, b) : "string" === typeof a ? (a = Do(a), 
        Ap(this, a, b)) : [];
    };
    function Ap(a, b, c) {
        var d = [];
        for (b = b.firstChild; b; b = b.nextSibling) b.nodeType == Node.ELEMENT_NODE && ec(d, a.Ic(b, c));
        return d;
    }
    k.dd = function(a, b) {
        if (Bo(a)) return null;
        if (Co(a)) return this.rj(a, b);
    ...
    k.rb = function(a) {
        return Bo(a) ? this.Rg(a) : Co(a) ? this.sf(a) : "string" === typeof a ? (a = Do(a), 
        this.Rg(a)) : null;
    };
    k.Rg = function() {
    ...
    k.ee = function(a, b) {
        ...
        if ("FeatureCollection" == c) "http://www.opengis.net/wfs" === a.namespaceURI ? d = O([], this.b, a, b, this) : d = O(null, this.b, a, b, this); else if ("featureMembers" == c || "featureMember" == c) {
            ...
            for (var u in g) {
                n = {};
                l = 0;
                for (h = f.length; l < h; ++l) (-1 === f[l].indexOf(":") ? "p0" : f[l].split(":")[0]) === u && (n[f[l].split(":").pop()] = "featureMembers" == c ? Fo(this.Jg, this) : Go(this.Jg, this));
                e[g[u]] = n;
            }
    ...
    k.pf = function(a, b) {
        ...
        if (a = O(null, this.ph, a, b, this)) return Uo(a, !1, c);
    };
    k.Jg = function(a, b) {
        var c;
        ...
        for (a = a.firstElementChild; a; a = a.nextElementSibling) {
            ...
            if (0 === a.childNodes.length || 1 === a.childNodes.length && (3 === a.firstChild.nodeType || 4 === a.firstChild.nodeType)) {
                ...
                Cp.test(g) && (g = void 0);
                d[f] = g;
            } else "boundedBy" !== f && (e = f), d[f] = this.pf(a, b);
        }
        b = new vk(d);
        e && b.Jc(e);
        c && b.pc(c);
    ...
    k.wj = function(a, b) {
        if (a = this.nf(a, b)) return b = new B(null), b.ba("XYZ", a), b;
    };
    k.uj = function(a, b) {
        if (a = O([], this.fk, a, b, this)) return new Q(a);
    };
    k.tj = function(a, b) {
        if (a = O([], this.ek, a, b, this)) return b = new P(null), Xo(b, a), b;
    };
    k.vj = function(a, b) {
        if (a = O([], this.gk, a, b, this)) return b = new R(null), Yo(b, a), b;
    };
    k.nj = function(a, b) {
        No(this.jk, a, b, this);
    };
    ...
    k.qf = function(a, b) {
        if (a = this.nf(a, b)) return b = new I(null), b.ba("XYZ", a), b;
    };
    k.Pp = function(a, b) {
        if (a = O(null, this.se, a, b, this)) return a;
    };
    k.sj = function(a, b) {
        if (a = this.nf(a, b)) return b = new Ef(null), Ff(b, "XYZ", a), b;
    };
    k.rf = function(a, b) {
        if ((a = O([ null ], this.Ef, a, b, this)) && a[0]) {
            ...
            var f = 1;
            for (e = a.length; f < e; ++f) ec(c, a[f]), d.push(c.length);
            b.ba("XYZ", c, d);
            return b;
        }
    };
    ...
    k = Op.prototype;
    k.Tp = function(a, b) {
        if (a = O([], this.dk, a, b, this)) return b = new P(null), Xo(b, a), b;
    };
    k.Up = function(a, b) {
        if (a = O([], this.hk, a, b, this)) return b = new R(null), Yo(b, a), b;
    };
    k.Dh = function(a, b) {
        No(this.$j, a, b, this);
    };
    ...
    k.pj = function(a, b) {
        if (a = O([ null ], this.ak, a, b, this)) return b = new I(null), b.ba("XYZ", a), 
        b;
    };
    k.Op = function(a, b) {
    ...
    k.$e = function(a, b, c) {
        ...
        "Polygon" === a.nodeName || "PolygonPatch" === a.nodeName ? (b = b.Td(), Oo({
            ...
            hasZ: e,
            srsName: d
        }, Rp, this.Fn, b, c, void 0, this)) : "Surface" === a.nodeName && (e = yo(a.namespaceURI, "patches"), 
        a.appendChild(e), a = yo(e.namespaceURI, "PolygonPatch"), e.appendChild(a), this.$e(a, b, c));
    };
    k.Ze = function(a, b, c) {
        var d = c[c.length - 1].srsName;
        "LineStringSegment" !== a.nodeName && d && a.setAttribute("srsName", d);
        "LineString" === a.nodeName || "LineStringSegment" === a.nodeName ? (d = yo(a.namespaceURI, "posList"), 
        a.appendChild(d), Pp(d, b, c)) : "Curve" === a.nodeName && (d = yo(a.namespaceURI, "segments"), 
        a.appendChild(d), a = yo(d.namespaceURI, "LineStringSegment"), d.appendChild(a), 
        this.Ze(a, b, c));
    };
    k.Di = function(a, b, c) {
    ...
    Op.prototype.qe = function(a, b) {
        b = To(this, b);
        var c = yo("http://www.opengis.net/gml", "geom"), d = {
            node: c,
            hasZ: this.hasZ,
    ...
    k.Xe = function(a, b, c) {
        var d = c[c.length - 1].srsName;
        "LineStringSegment" !== a.nodeName && d && a.setAttribute("srsName", d);
        "LineString" === a.nodeName || "LineStringSegment" === a.nodeName ? (d = Zp(a.namespaceURI), 
        a.appendChild(d), $p(d, b, c)) : "Curve" === a.nodeName && (d = yo(a.namespaceURI, "segments"), 
        a.appendChild(d), a = yo(d.namespaceURI, "LineStringSegment"), d.appendChild(a), 
        this.Xe(a, b, c));
    };
    function Zp(a) {
    ...
    function $p(a, b, c) {
        ...
        d = d.srsName;
        b = b.U();
        for (var e = b.length, f = Array(e), g, h = 0; h < e; ++h) g = b[h], f[h] = aq(g, d, c);
        Lp(a, f.join(" "));
    }
    k.Ye = function(a, b, c) {
        var d = c[c.length - 1], e = d.hasZ;
        ...
        "Polygon" === a.nodeName || "PolygonPatch" === a.nodeName ? (b = b.Td(), Oo({
            ...
            hasZ: e,
            srsName: d
        }, bq, this.Bn, b, c, void 0, this)) : "Surface" === a.nodeName && (e = yo(a.namespaceURI, "patches"), 
        a.appendChild(e), a = yo(e.namespaceURI, "PolygonPatch"), e.appendChild(a), this.Ye(a, b, c));
    };
    k.Bn = function(a, b) {
        a = b[b.length - 1];
        b = a.node;
    ...
    hq.prototype.Kg = function(a, b) {
        if (!cc(iq, a.namespaceURI)) return null;
    ...
    hq.prototype.Ic = function(a, b) {
        return cc(iq, a.namespaceURI) ? "gpx" == a.localName && (a = O([], vq, a, [ So(this, a, b) ])) ? (zq(this, a), 
        a) : [] : [];
    };
    function Aq(a, b, c) {
    ...
    var Cq = [ "text", "type" ], Bq = M(iq, {
        text: L(Lp),
        type: L(Lp)
    }), Hq = M(iq, "name cmt desc src link number type rtept".split(" ")), Iq = M(iq, {
        name: L(Lp),
        cmt: L(Lp),
        desc: L(Lp),
        src: L(Lp),
        ...
        type: L(Lp),
        rtept: Io(L(Dq))
    }), Eq = M(iq, [ "ele", "time" ]), Jq = M(iq, "name cmt desc src link number type trkseg".split(" ")), Mq = M(iq, {
        name: L(Lp),
        cmt: L(Lp),
        desc: L(Lp),
        src: L(Lp),
        ...
        trkpt: L(Dq)
    }), Fq = M(iq, "ele time magvar geoidheight name cmt desc src link sym type fix sat hdop vdop pdop ageofdgpsdata dgpsid".split(" ")), Gq = M(iq, {
        ele: L(Mp),
        time: L(function(a, b) {
            b = new Date(1e3 * b);
    ...
    function Oq(a, b) {
        if (a = a.V()) if (a = Nq[a.T()]) return yo(b[b.length - 1].node.namespaceURI, a);
    }
    var Pq = M(iq, {
        rte: L(function(a, b, c) {
            ...
            if (b = b.V()) b = Uo(b, !0, d), a.geometryLayout = b.ja, e.rtept = b.U();
        ...
        trk: L(function(a, b, c) {
            ...
            if (b = b.V()) b = Uo(b, !0, d), e.trkseg = b.ud();
        ...
        wpt: L(function(a, b, c) {
            ...
            e.properties = b.M();
            if (b = b.V()) b = Uo(b, !0, d), e.geometryLayout = b.ja, Dq(a, b.U(), c);
        })
    });
    ...
    k.ze = function(a) {
        Na(a);
        for (var b = this.a, c = 0, d = b.length; c < d; ++c) Ta(a, b[c].C());
        return a;
    };
    k.td = function() {
        return Sq(this.a);
    ...
    k.Vd = function(a) {
        ...
        if (e) return a = new Qq(null), Tq(a), a.a = c, Rq(a), a.u(), this.i[b] = a;
        this.f = a;
        return this;
    };
    k.T = function() {
    ...
    v(ar, Zq);
    var br = /^B(\d{2})(\d{2})(\d{2})(\d{2})(\d{5})([NS])(\d{3})(\d{5})([EW])([AV])(\d{5})(\d{5})/, cr = /^H.([A-Z]{3}).*?:(.*)/, dr = /^HFDTE(\d{2})(\d{2})(\d{2})/, er = /\r\n|\r|\n/;
    k = ar.prototype;
    k.de = function(a, b) {
        var c = this.b, d = a.split(er);
        a = {};
        ...
        for (m = d.length; n < m; ++n) {
            ...
            if ("B" == p.charAt(0)) {
                if (q = br.exec(p)) {
                    p = parseInt(q[1], 10);
                    var r = parseInt(q[2], 10), u = parseInt(q[3], 10), x = parseInt(q[4], 10) + parseInt(q[5], 10) / 6e4;
                    "S" == q[6] && (x = -x);
            ...
            } else "H" == p.charAt(0) && ((q = dr.exec(p)) ? (h = parseInt(q[1], 10), g = parseInt(q[2], 10) - 1, 
            f = 2e3 + parseInt(q[3], 10)) : (q = cr.exec(p)) && (a[q[1]] = q[2].trim()));
        }
    ...
    fr.prototype.o = function() {
        ...
        if (!this.s && null !== this.f) {
            ...
            for (var b = a.getImageData(0, 0, this.N.width, this.N.height), c = b.data, d = this.f[0] / 255, e = this.f[1] / 255, f = this.f[2] / 255, g = 0, h = c.length; g < h; g += 4) c[g] *= d, 
            c[g + 1] *= e, c[g + 2] *= f;
    ...
    function hr(a) {
        ...
        var f = this.qa, g = this.j, h = Ui.get(d, f, g);
    ...
    function ir(a) {
        ...
        jr || (kr = [ 255, 255, 255, 1 ], lr = new nk({
            color: kr
        }), mr = [ 20, 2 ], nr = or = "pixels", pr = [ 64, 64 ], qr = "https://maps.google.com/mapfiles/kml/pushpin/ylw-pushpin.png", 
        rr = .5, sr = new hr({
            anchor: mr,
    ...
    v(ir, yp);
    var yr = [ "http://www.google.com/kml/ext/2.2" ], zr = [ null, "http://earth.google.com/kml/2.0", "http://earth.google.com/kml/2.1", "http://earth.google.com/kml/2.2", "http://www.opengis.net/kml/2.2" ], Ar = {
        fraction: "fraction",
        pixels: "pixels",
        insetPixels: "pixels"
    };
    function Br(a, b) {
        ...
        null !== a.Ka() ? (e = a.Ka(), a = e.clone(), a.Ej(e.a || wr.a), a.ij(e.b || wr.b), 
        a.wf(e.Ea() || wr.Ea()), a.yf(e.Fa() || vr)) : a = wr.clone();
        a.Gd(b);
        a.Ij(c[0]);
        a.Jj(c[1]);
        a.Lj(d);
    ...
    function Cr(a, b, c, d, e) {
        return function() {
            ...
            if (a) return f ? (f = Br(a[0], g), a.concat(f)) : a;
            if (b) {
                var h = Dr(b, c, d);
    ...
    function Mr(a, b) {
        var c = O({}, Nr, a, b);
        if (a = O(null, Or, a, b)) return b = new I(null), b.ba("XYZ", a), b.I(c), b;
    }
    function Pr(a, b) {
        var c = O({}, Nr, a, b);
        if (a = O(null, Or, a, b)) return b = new D(null), b.ba("XYZ", a, [ a.length ]), 
        b.I(c), b;
    }
    function Qr(a, b) {
        a = O([], Rr, a, b);
        if (!a) return null;
        if (0 === a.length) return new Qq(a);
        var c = !0, d = a[0].T(), e;
        var f = 1;
        ...
        if (c) if ("Point" == d) {
            ...
            d = g.da();
            f = 1;
            for (e = a.length; f < e; ++f) b = a[f], ec(d, b.da());
            g = new Q(null);
            g.ba(c, d);
            Sr(g, a);
        } else "LineString" == d ? (g = new P(null), Xo(g, a), Sr(g, a)) : "Polygon" == d ? (g = new R(null), 
        Yo(g, a), Sr(g, a)) : "GeometryCollection" == d ? g = new Qq(a) : na(!1, 37); else g = new Qq(a);
        return g;
    }
    function Tr(a, b) {
        var c = O({}, Nr, a, b);
        if (a = O(null, Or, a, b)) return b = new B(null), b.ba("XYZ", a), b.I(c), b;
    }
    function Ur(a, b) {
        var c = O({}, Nr, a, b);
        if ((a = O([ null ], Vr, a, b)) && a[0]) {
            ...
            var g = 1;
            for (f = a.length; g < f; ++g) ec(d, a[g]), e.push(d.length);
            b.ba("XYZ", d, e);
            b.I(c);
            return b;
        }
    ...
    function Wr(a, b) {
        ...
        c == tr && (c = void 0);
        var d = "textStyle" in b ? b.textStyle : wr, e = "strokeStyle" in b ? b.strokeStyle : ur;
        b = b.outline;
        void 0 === b || b || (e = null);
        return [ new pk({
            fill: a,
    ...
    var bs = M(zr, {
        ...
        LatLonAltBox: function(a, b) {
            if (a = O({}, ds, a, b)) b = b[b.length - 1], b.extent = [ parseFloat(a.west), parseFloat(a.south), parseFloat(a.east), parseFloat(a.north) ], 
            b.altitudeMode = a.altitudeMode, b.minAltitude = parseFloat(a.minAltitude), b.maxAltitude = parseFloat(a.maxAltitude);
        },
        Lod: function(a, b) {
            if (a = O({}, es, a, b)) b = b[b.length - 1], b.minLodPixels = parseFloat(a.minLodPixels), 
        ...
        StyleMap: function(a, b) {
            if (a = O(void 0, ps, a, b)) b = b[b.length - 1], Array.isArray(a) ? b.Style = a : "string" === typeof a ? b.styleUrl = a : na(!1, 38);
        },
        address: K(S),
        description: K(S),
        name: K(S),
        ...
        MultiTrack: K(function(a, b) {
            if (a = O([], ls, a, b)) return b = new P(null), Xo(b, a), b;
        }, "geometry"),
        Track: K(Kr, "geometry")
    })), rs = M(zr, {
        color: K(Er),
        ...
        IconStyle: function(a, b) {
            if (a = O({}, is, a, b)) {
                ...
                if (g) {
                    ...
                    var m = g.oh;
                    f = g.origin;
                } else e === qr ? (h = mr, l = or, m = nr) : /^http:\/\/maps\.(?:google|gstatic)\.com\//.test(e) && (h = [ .5, 0 ], 
                m = l = "fraction");
                var n;
                g = c.x;
                var p = c.y;
    ...
    k.bq = function(a, b) {
        ...
        null !== c && (b = Wr(a, b)) && (a = a.baseURI, a && "about:blank" != a || (a = window.location.href), 
        c = a ? new URL("#" + c, a).href : "#" + c, this.b[c] = b);
    };
    k.aq = function(a, b) {
        var c = a.getAttribute("id");
        null !== c && (b = O(void 0, ps, a, b)) && (a = a.baseURI, a && "about:blank" != a || (a = window.location.href), 
        c = a ? new URL("#" + c, a).href : "#" + c, this.b[c] = b);
    };
    k.Kg = function(a, b) {
    ...
    k.Ic = function(a, b) {
        if (!cc(zr, a.namespaceURI)) return [];
        var c = a.localName;
        if ("Document" == c || "Folder" == c) return (c = this.Ig(a, [ So(this, a, b) ])) ? c : [];
        if ("Placemark" == c) return (b = this.Qg(a, [ So(this, a, b) ])) ? [ b ] : [];
        if ("kml" == c) {
            c = [];
            for (a = a.firstElementChild; a; a = a.nextElementSibling) {
                var d = this.Ic(a, b);
    ...
    k.Vp = function(a) {
        if (Bo(a)) return ss(this, a);
        if (Co(a)) return ts(this, a);
        if ("string" === typeof a) return a = Do(a), ss(this, a);
    };
    function ss(a, b) {
    ...
    function ts(a, b) {
        var c;
        for (c = b.firstElementChild; c; c = c.nextElementSibling) if (cc(zr, c.namespaceURI) && "name" == c.localName) return S(c);
        for (c = b.firstElementChild; c; c = c.nextElementSibling) if (b = c.localName, 
        cc(zr, c.namespaceURI) && ("Document" == b || "Folder" == b || "Placemark" == b || "kml" == b) && (b = ts(a, c))) return b;
    }
    k.Wp = function(a) {
        var b = [];
        Bo(a) ? ec(b, us(this, a)) : Co(a) ? ec(b, vs(this, a)) : "string" === typeof a && (a = Do(a), 
        ec(b, us(this, a)));
        return b;
    };
    function us(a, b) {
        var c = [];
        for (b = b.firstChild; b; b = b.nextSibling) b.nodeType == Node.ELEMENT_NODE && ec(c, vs(a, b));
        return c;
    }
    function vs(a, b) {
        var c, d = [];
        for (c = b.firstElementChild; c; c = c.nextElementSibling) if (cc(zr, c.namespaceURI) && "NetworkLink" == c.localName) {
            var e = O({}, ns, c, []);
            d.push(e);
        }
        for (c = b.firstElementChild; c; c = c.nextElementSibling) b = c.localName, !cc(zr, c.namespaceURI) || "Document" != b && "Folder" != b && "kml" != b || ec(d, vs(a, c));
        return d;
    }
    k.Zp = function(a) {
        var b = [];
        Bo(a) ? ec(b, ws(this, a)) : Co(a) ? ec(b, this.tf(a)) : "string" === typeof a && (a = Do(a), 
        ec(b, ws(this, a)));
        return b;
    };
    function ws(a, b) {
        var c = [];
        for (b = b.firstChild; b; b = b.nextSibling) b.nodeType == Node.ELEMENT_NODE && ec(c, a.tf(b));
        return c;
    }
    k.tf = function(a) {
        var b, c = [];
        for (b = a.firstElementChild; b; b = b.nextElementSibling) if (cc(zr, b.namespaceURI) && "Region" == b.localName) {
            var d = O({}, as, b, []);
            c.push(d);
        }
        for (b = a.firstElementChild; b; b = b.nextElementSibling) a = b.localName, !cc(zr, b.namespaceURI) || "Document" != a && "Folder" != a && "kml" != a || ec(c, this.tf(b));
        return c;
    };
    function xs(a, b) {
        b = li(b);
    ...
    function ys(a, b, c) {
        ...
        if ("GeometryCollection" == d) {
            var e = b.td();
            var f = zs;
        } else "MultiPoint" == d ? (e = b.be(), f = As) : "MultiLineString" == d ? (e = b.ud(), 
        f = Bs) : "MultiPolygon" == d ? (e = b.Ud(), f = Cs) : na(!1, 39);
        Oo(a, Ds, f, e, c);
    }
    function Es(a, b, c) {
        Oo({
    ...
    function Hs(a, b, c) {
        ...
        if (f = b.fb()) if (f = f.call(b, 0)) f = Array.isArray(f) ? f[0] : f, this.j && (a.Style = f), 
        (f = f.Ka()) && (a.name = f.Ka());
    ...
    var Ts = M(zr, [ "Document", "Placemark" ]), Ws = M(zr, {
        ...
        Data: L(function(a, b, c) {
            ...
            b = b.value;
            "object" == typeof b ? (null !== b && b.displayName && Oo(a, Xs, Lo, [ b.displayName ], c, [ "displayName" ]), 
            null !== b && b.value && Oo(a, Xs, Lo, [ b.value ], c, [ "value" ])) : Oo(a, Xs, Lo, [ b ], c, [ "value" ]);
        }),
    ...
    }, Zs = M(zr, [ "href" ], M(yr, [ "x", "y", "w", "h" ])), $s = M(zr, {
        href: L(Lp)
    }, M(yr, {
        x: L(Mp),
        y: L(Mp),
        w: L(Mp),
        h: L(Mp)
    })), at = M(zr, [ "scale", "heading", "Icon", "hotSpot" ]), ct = M(zr, {
        Icon: L(function(a, b, c) {
            a = {
                node: a
            };
            var d = Zs[c[c.length - 1].node.namespaceURI], e = Mo(b, d);
            Oo(a, $s, Lo, e, c, d);
            d = Zs[yr[0]];
            e = Mo(b, d);
            Oo(a, $s, bt, e, c, d);
        ...
        scale: L(Ss)
    }), dt = M(zr, [ "color", "scale" ]), et = M(zr, {
        color: L(xs),
        scale: L(Ss)
    }), ft = M(zr, [ "color", "width" ]), gt = M(zr, {
        color: L(xs),
        width: L(Mp)
    }), Fs = M(zr, {
        LinearRing: L(Ls)
    ...
    }), Ks = M(zr, "name open visibility address phoneNumber description styleUrl Style".split(" ")), Is = M(zr, {
        ExtendedData: L(function(a, b, c) {
            ...
            var d = b.names;
            b = b.values;
            for (var e = d.length, f = 0; f < e; f++) Oo(a, Xs, ht, [ {
                name: d[f],
                value: b[f]
            } ], c);
        }),
        ...
        styleUrl: L(Lp),
        visibility: L(Kp)
    }), Ms = M(zr, [ "extrude", "tessellate", "altitudeMode", "coordinates" ]), Ns = M(zr, {
        extrude: L(Kp),
        tessellate: L(Kp),
        altitudeMode: L(Lp),
        ...
        color: L(xs)
    }), it = M(zr, [ "IconStyle", "LabelStyle", "LineStyle", "PolyStyle" ]), jt = M(zr, {
        IconStyle: L(function(a, b, c) {
            a = {
                node: a
            };
            var d = {}, e = b.nc(), f = b.Ge(), g = {
                href: b.b.l
            };
            if (e) {
                g.w = e[0];
    ...
    function zs(a, b) {
        if (a) return yo(b[b.length - 1].node.namespaceURI, Ys[a.T()]);
    }
    var lt = Jo("color"), ht = Jo("Data"), Js = Jo("ExtendedData"), Qs = Jo("innerBoundaryIs"), As = Jo("Point"), Bs = Jo("LineString"), Gs = Jo("LinearRing"), Cs = Jo("Polygon"), Rs = Jo("outerBoundaryIs");
    ...
    (function(a) {
        ...
        var e = {
            ...
            write: function(a, b, c, d, e, n) {
                ...
                n = d ? 0 : n - 1;
                var C = d ? 1 : -1, z = 0 > b || 0 === b && 0 > 1 / b ? 1 : 0;
                b = Math.abs(b);
        ...
        b.prototype = {
            ...
            Aq: function(a) {
                a &= 7;
                if (a === b.c) for (;127 < this.sc[this.ga++]; ) ; else if (a === b.b) this.ga = this.Ta() + this.ga; else if (a === b.a) this.ga += 4; else if (a === b.g) this.ga += 8; else throw Error("Unimplemented type: " + a);
            }
        };
        a["default"] = b;
    })(gj.Kd = gj.Kd || {});
    ...
    function pt(a, b, c) {
        if (15 === a) b.version = c.Ta(); else if (1 === a) b.name = c.Ug(); else if (5 === a) b.extent = c.Ta(); else if (2 === a) b.features.push(c.ga); else if (3 === a) b.keys.push(c.Ug()); else if (4 === a) {
            a = null;
            for (var d = c.Ta() + c.ga; c.ga < d; ) a = c.Ta() >> 3, a = 1 === a ? c.Ug() : 2 === a ? c.Rp() : 3 === a ? c.Np() : 4 === a ? c.cq() : 5 === a ? c.Ta() : 6 === a ? c.Tg() : 7 === a ? c.Lp() : null;
            b.values.push(a);
        }
    }
    function qt(a, b, c) {
        if (1 == a) b.id = c.Ta(); else if (2 == a) for (a = c.Ta() + c.ga; c.ga < a; ) {
            var d = b.layer.keys[c.Ta()], e = b.layer.values[c.Ta()];
            b.properties[d] = e;
        } else 3 == a ? b.type = c.Ta() : 4 == a && (b.geometry = c.ga);
    }
    function rt(a, b, c) {
        var d = c.type;
        if (0 === d) return null;
        ...
        b.ga = c.geometry;
        c = b.Ta() + b.ga;
        for (var m = 1, n = 0, p = 0, q = 0, r = 0, u = 0; b.ga < c; ) n || (n = b.Ta(), 
        m = n & 7, n >>= 3), n--, 1 === m || 2 === m ? (p += b.Tg(), q += b.Tg(), 1 === m && r > u && (l.push(r), 
        u = r), g.push(p, q), r += 2) : 7 === m ? r > u && (g.push(g[u], g[u + 1]), r += 2) : na(!1, 59);
        r > u && l.push(r);
        b = h.length;
        var x;
        1 === d ? x = 1 === b ? "Point" : "MultiPoint" : 2 === d ? x = 1 === b ? "LineString" : "MultiLineString" : 3 === d && (x = "Polygon");
        d = x;
        if (a.b === mt) g = new a.b(d, g, h, f, e); else {
            if ("Polygon" == d) {
                d = [];
                l = b = x = 0;
                for (c = h.length; l < c; ++l) m = h[l], Nf(g, x, m, 2) || (d.push(h.slice(b, l)), 
                b = l), x = m;
                1 < d.length ? (h = d, d = new R(null)) : d = new D(null);
            } else d = "Point" === d ? new B(null) : "LineString" === d ? new I(null) : "Polygon" === d ? new D(null) : "MultiPoint" === d ? new Q(null) : "MultiLineString" === d ? new P(null) : null;
            d.ba("XY", g, h);
            g = new a.b();
            a.g && g.Jc(a.g);
    ...
    st.prototype.Ic = function(a, b) {
        ...
        if ("osm" == a.localName) {
            ...
            for (var c = 0; c < a.kh.length; c++) {
                for (var d = a.kh[c], e = [], f = 0, g = d.xd.length; f < g; f++) ec(e, a.hi[d.xd[f]]);
                d.xd[0] == d.xd[d.xd.length - 1] ? (f = new D(null), f.ba("XY", e, [ e.length ])) : (f = new I(null), 
                f.ba("XY", e));
                Uo(f, !1, b);
                e = new vk(f);
                e.pc(d.id);
    ...
    function Gt(a, b, c, d, e, f, g) {
        ...
        var h = [], l;
        var m = 0;
        for (l = a.length; m < l; ++m) h[m] = Ht(a[m], b, c, d, e, f, g);
        return h;
    }
    ...
    Et.prototype.Lg = function(a, b) {
        if ("Topology" == a.type) {
            ...
            a = a.objects;
            g = this.a;
            for (var z in a) this.b && -1 == this.b.indexOf(z) || ("GeometryCollection" === a[z].type ? (l = a[z], 
            e.push.apply(e, Gt(l, f, c, d, g, z, b))) : (l = a[z], e.push(Ht(l, f, c, d, g, z, b))));
            return e;
        }
        return [];
    };
    ...
    var It = {
        ...
        Polygon: function(a, b) {
            var c = [], d;
            var e = 0;
            for (d = a.arcs.length; e < d; ++e) c[e] = Ft(a.arcs[e], b);
            return new D(c);
        },
        MultiPoint: function(a, b, c) {
            ...
            if (b && c) {
                var e = 0;
                for (d = a.length; e < d; ++e) Jt(a[e], b, c);
            }
            return new Q(a);
        },
        ...
        MultiPolygon: function(a, b) {
            ...
            for (e = a.arcs.length; f < e; ++f) {
                ...
                var h = [];
                var l = 0;
                for (d = g.length; l < d; ++l) h[l] = Ft(g[l], b);
                c[f] = h;
            }
            return new R(c);
        }
    ...
    uu.prototype.j = function(a) {
        if (Bo(a)) return wu(a);
        if (Co(a)) return O({}, xu, a, []);
        if ("string" === typeof a) return a = Do(a), wu(a);
    };
    uu.prototype.f = function(a) {
        if (Bo(a)) return yu(this, a);
        if (Co(a)) return zu(this, a);
        if ("string" === typeof a) return a = Do(a), yu(this, a);
    };
    function yu(a, b) {
        for (b = b.firstChild; b; b = b.nextSibling) if (b.nodeType == Node.ELEMENT_NODE) return zu(a, b);
    }
    var Au = {
        "http://www.opengis.net/gml": {
    ...
    function zu(a, b) {
        var c = {}, d = Jp(b.getAttribute("numberOfFeatures"));
    ...
    function wu(a) {
        for (a = a.firstChild; a; a = a.nextSibling) if (a.nodeType == Node.ELEMENT_NODE) return O({}, xu, a, []);
    }
    var Eu = {
        "http://www.opengis.net/wfs": {
            PropertyName: L(Lp)
    ...
    function Fu(a, b) {
        var c = yo("http://www.opengis.net/ogc", "Filter"), d = yo("http://www.opengis.net/ogc", "FeatureId");
        c.appendChild(d);
    ...
    var Hu = {
        "http://www.opengis.net/wfs": {
            ...
            Property: L(function(a, b, c) {
                var d = yo("http://www.opengis.net/wfs", "Name"), e = c[c.length - 1].gmlVersion;
                a.appendChild(d);
                Lp(d, b.name);
                void 0 !== b.value && null !== b.value && (d = yo("http://www.opengis.net/wfs", "Value"), 
                a.appendChild(d), b.value instanceof ff ? 2 === e ? Xp.prototype.ri(d, b.value, c) : Op.prototype.Yc(d, b.value, c) : Lp(d, b.value));
            }),
    ...
    var Ju = {
        "http://www.opengis.net/wfs": {
            Query: L(function(a, b, c) {
                ...
                if (d = d.filter) g = yo("http://www.opengis.net/ogc", "Filter"), a.appendChild(g), 
                Oo({
                    node: g
                }, Ju, Jo(d.qc), [ d ], c);
            })
        ...
        "http://www.opengis.net/ogc": {
            During: L(function(a, b) {
                var c = yo("http://www.opengis.net/fes", "ValueReference");
                Lp(c, b.b);
                a.appendChild(c);
    ...
    uu.prototype.v = function(a, b, c, d) {
        var e = [], f = yo("http://www.opengis.net/wfs", "Transaction"), g = d.version ? d.version : "1.1.0", h = "1.0.0" === g ? 2 : 3;
        ...
        d.nativeElements && Oo({
            ...
            gmlVersion: h,
            srsName: d.srsName
        }, Hu, Jo("Native"), d.nativeElements, e);
        return f;
    };
    uu.prototype.Rg = function(a) {
        for (a = a.firstChild; a; a = a.nextSibling) if (a.nodeType == Node.ELEMENT_NODE) return this.sf(a);
        return null;
    };
    ...
    function Su(a) {
        var b = [];
        a = a.Td();
        for (var c = 0, d = a.length; c < d; ++c) b.push("(" + Ru(a[c]) + ")");
        return b.join(",");
    }
    function Tu(a) {
        var b = a.T(), c = (0, Uu[b])(a);
        b = b.toUpperCase();
        if (a instanceof gf) {
            a = a.ja;
            var d = "";
    ...
    var Uu = {
        ...
        MultiPoint: function(a) {
            var b = [];
            a = a.be();
            for (var c = 0, d = a.length; c < d; ++c) b.push("(" + Qu(a[c]) + ")");
            return b.join(",");
        },
        MultiLineString: function(a) {
            var b = [];
        ...
        MultiPolygon: function(a) {
            var b = [];
            a = a.Ud();
            for (var c = 0, d = a.length; c < d; ++c) b.push("(" + Su(a[c]) + ")");
            return b.join(",");
        },
        GeometryCollection: function(a) {
            var b = [];
            a = a.td();
            for (var c = 0, d = a.length; c < d; ++c) b.push(Tu(a[c]));
            return b.join(",");
        }
    };
    k = Pu.prototype;
    ...
    k.Mg = function(a, b) {
        ...
        b = [];
        for (var d = 0, e = c.length; d < e; ++d) a = new vk(), a.Ua(c[d]), b.push(a);
        return b;
    };
    k.Fd = function(a, b) {
        a = new Vu(new Wu(a));
    ...
    k.mh = function(a, b) {
        if (1 == a.length) return this.oe(a[0], b);
    ...
    k.Gg = function() {
        if ($u(this, 2)) {
            var a = ev(this);
            if ($u(this, 3)) return a;
        } else if (av(this)) return null;
        throw Error(bv(this));
    };
    k.Fg = function() {
        if ($u(this, 2)) {
    ...
    k.yp = function() {
        if ($u(this, 2)) {
            var a;
            if (2 == this.b.type) for (a = [ this.Gg() ]; $u(this, 5); ) a.push(this.Gg()); else a = fv(this);
            if ($u(this, 3)) return a;
        } else if (av(this)) return [];
        throw Error(bv(this));
    };
    ...
    k.zp = function() {
        if ($u(this, 2)) {
            for (var a = [ this.Hg() ]; $u(this, 5); ) a.push(this.Hg());
            if ($u(this, 3)) return a;
        } else if (av(this)) return [];
        throw Error(bv(this));
    };
    function ev(a) {
        for (var b = [], c = a.a.length, d = 0; d < c; ++d) {
            var e = a.b;
            if ($u(a, 4)) b.push(e.value); else break;
        }
        if (b.length == c) return b;
        throw Error(bv(a));
    }
    function fv(a) {
        for (var b = [ ev(a) ]; $u(a, 5); ) b.push(ev(a));
        return b;
    }
    function gv(a) {
        for (var b = [ a.Fg() ]; $u(a, 5); ) b.push(a.Fg());
        return b;
    }
    function av(a) {
    ...
    iv.prototype.read = function(a) {
        return Bo(a) ? this.a(a) : Co(a) ? this.b(a) : "string" === typeof a ? (a = Do(a), 
        this.a(a)) : null;
    };
    function jv() {
        this.version = void 0;
    ...
    function pv(a, b) {
        if (b = lv(a, b)) return a = [ Jp(a.getAttribute("width")), Jp(a.getAttribute("height")) ], 
        b.size = a, b;
    }
    function qv(a, b) {
        return O([], rv, a, b);
    }
    var sv = [ null, "http://www.opengis.net/wms" ], kv = M(sv, {
        ...
        BoundingBox: Ho(function(a) {
            var b = [ Hp(a.getAttribute("minx")), Hp(a.getAttribute("miny")), Hp(a.getAttribute("maxx")), Hp(a.getAttribute("maxy")) ], c = [ Hp(a.getAttribute("resx")), Hp(a.getAttribute("resy")) ];
            return {
        ...
        AuthorityURL: Ho(function(a, b) {
            if (b = lv(a, b)) return b.name = a.getAttribute("name"), b;
        }),
        Identifier: Ho(S),
        MetadataURL: Ho(function(a, b) {
            if (b = lv(a, b)) return b.type = a.getAttribute("type"), b;
        }),
        DataURL: Ho(lv),
        ...
        Layer: Ho(function(a, b) {
            var c = b[b.length - 1], d = O({}, xv, a, b);
            if (d) return b = Ep(a.getAttribute("queryable")), void 0 === b && (b = c.queryable), 
            d.queryable = void 0 !== b ? b : !1, b = Jp(a.getAttribute("cascaded")), void 0 === b && (b = c.cascaded), 
            d.cascaded = b, b = Ep(a.getAttribute("opaque")), void 0 === b && (b = c.opaque), 
            d.opaque = void 0 !== b ? b : !1, b = Ep(a.getAttribute("noSubsets")), void 0 === b && (b = c.noSubsets), 
            d.noSubsets = void 0 !== b ? b : !1, (b = Hp(a.getAttribute("fixedWidth"))) || (b = c.fixedWidth), 
            d.fixedWidth = b, (a = Hp(a.getAttribute("fixedHeight"))) || (a = c.fixedHeight), 
    ...
    var Jv = [ null, "http://www.opengis.net/ows/1.1" ], Iv = M(Jv, {
    ...
    var $v = [ null, "http://www.opengis.net/wmts/1.0" ], aw = [ null, "http://www.opengis.net/ows/1.1" ], Yv = M($v, {
        ...
        Style: Ho(function(a, b) {
            if (b = O({}, ew, a, b)) return a = "true" === a.getAttribute("isDefault"), b.isDefault = a, 
            b;
        }),
        Format: Ho(S),
    ...
    k.Nb = function(a, b, c, d) {
        ...
        b = a * a + f * f;
        if (b < d) {
            if (0 === b) for (d = 0; d < this.a; ++d) c[d] = e[d]; else for (d = this.zd() / Math.sqrt(b), 
    ...
    function Bw(a, b, c) {
        var d = !0, e = c.c;
        void 0 !== e ? e.toString() in a.j ? d = !1 : a.j[e.toString()] = c : (na(!(b in a.l), 30), 
        a.l[b] = c);
        return d;
    }
    k.Oc = function(a) {
    ...
    function zw(a, b) {
        ...
        g = 0;
        for (c = e.length; g < c; g++) h = e[g], l = w(h).toString(), Cw(a, l, h), (b = h.V()) ? (l = b.C(), 
        d.push(l), f.push(h)) : a.f[l] = h;
        a.a && a.a.load(d, f);
        g = 0;
        for (c = e.length; g < c; g++) a.b(new Dw("addfeature", e[g]));
    }
    function Aw(a, b) {
        var c = !1;
    ...
    function Ew(a, b, c) {
        a.dc([ b[0], b[1], b[0], b[1] ], function(a) {
            if (a.V().Bb(b)) return c.call(void 0, a);
        });
    }
    k.dc = function(a, b, c) {
        if (this.a) return pm(this.a, a, b, c);
        if (this.i) return this.i.forEach(b, c);
    };
    k.Jh = function(a, b, c) {
        return this.dc(a, function(d) {
            if (d.V().$a(a) && (d = b.call(c, d))) return d;
        });
    };
    k.Qh = function() {
        return this.i;
    ...
    k.ce = function() {
        if (this.i) var a = this.i.a; else this.a && (a = mm(this.a), mb(this.f) || ec(a, lb(this.f)));
        return a;
    };
    k.Ph = function(a) {
        var b = [];
    ...
    k.Lh = function(a, b) {
        var c = a[0], d = a[1], e = null, f = [ NaN, NaN ], g = Infinity, h = [ -Infinity, -Infinity, Infinity, Infinity ], l = b ? b : Qe;
    ...
    k.dj = function(a) {
        ...
        c ? (c = c.C(), b in this.f ? (delete this.f[b], this.a && this.a.Ca(c, a)) : this.a && lm(this.a, c, a)) : b in this.f || (this.a && this.a.remove(a), 
        this.f[b] = a);
        c = a.c;
        void 0 !== c ? (c = c.toString(), b in this.l ? (delete this.l[b], this.j[c] = a) : this.j[c] !== a && (Fw(this, a), 
        this.j[c] = a)) : b in this.l || (Fw(this, a), this.l[b] = a);
        this.u();
    ...
    function Gw(a) {
        ...
        this.Gf = a.freehand ? Qe : a.freehandCondition ? a.freehandCondition : $g;
    ...
    function Hw(a) {
        this.W = !this.o;
        return this.o ? (this.ca = a.pixel, this.s || Rw(this, a), !0) : this.Sk(a) ? (this.ca = a.pixel, 
        !0) : !1;
    }
    function Jw(a) {
        var b = !0;
        Qw(this, a);
        var c = this.f === Sw;
        this.W ? (this.s ? this.o || c ? this.Od() : Tw(this, a) ? this.Ld(a) && this.Od() : Pw(this, a) : (Rw(this, a), 
        this.f === Mw && this.Od()), b = !1) : this.o && (this.s = null, Uw(this));
        return b;
    }
    function Qw(a, b) {
        ...
        a.s ? (e = b.coordinate, c = a.j.V(), a.f === Mw ? d = a.a : a.f === Lw ? (d = a.a[0], 
        d = d[d.length - 1], Tw(a, b) && (e = a.s.slice())) : (d = a.a, d = d[d.length - 1]), 
        d[0] = e[0], d[1] = e[1], a.ab(a.a, c), a.H && a.H.V().na(e), c instanceof D && a.f !== Lw ? (a.B || (a.B = new vk(new I(null))), 
        e = c.Th(0), b = a.B.V(), b.ba(e.ja, e.da())) : a.G && (b = a.B.V(), b.na(a.G)), 
        Vw(a)) : (b = b.coordinate.slice(), a.H ? a.H.V().na(b) : (a.H = new vk(new B(b)), 
        Vw(a)));
        return !0;
    }
    function Tw(a, b) {
    ...
    function Rw(a, b) {
        b = b.coordinate;
        a.s = b;
        a.f === Mw ? a.a = b.slice() : a.f === Lw ? (a.a = [ [ b.slice(), b.slice() ] ], 
    ...
    function Pw(a, b) {
        ...
        if (a.f === Nw) {
            ...
            e.push(b.slice());
            a.ab(e, c);
        } else a.f === Lw && (e = a.a[0], e.length >= a.va && (a.o ? e.pop() : d = !0), 
        e.push(b.slice()), d && (a.s = e[0]), a.ab(a.a, c));
        Vw(a);
        d && a.Od();
    }
    k.fq = function() {
    ...
    k.Od = function() {
        var a = Uw(this), b = this.a, c = a.V();
        this.f === Nw ? (b.pop(), this.ab(b, c)) : this.f === Lw && (b[0].pop(), this.ab(b, c), 
        b = c.U());
    ...
    var Mw = "Point", Nw = "LineString", Lw = "Polygon", Sw = "Circle";
    function Ww(a, b) {
        Qc.call(this, a);
        this.feature = b;
    }
    ...
    function $w(a) {
        ...
        if ("pointermove" == a.type && !this.D) {
            var b = a.pixel, c = a.map, d = dx(this, b, c);
            d || (d = c.Pa(b));
            ex(this, d);
        }
        eh.call(this, a);
    ...
    function Yw(a) {
        ...
        var c = a.pixel, d = a.map, e = this.C();
        (a = dx(this, c, d)) && e ? (c = a[0] == e[0] || a[0] == e[2] ? a[0] : null, d = a[1] == e[1] || a[1] == e[3] ? a[1] : null, 
        null !== c && null !== d ? this.a = fx(b(a)) : null !== c ? this.a = gx(b([ c, e[1] ]), b([ c, e[3] ])) : null !== d && (this.a = gx(b([ e[0], d ]), b([ e[2], d ])))) : (a = d.Pa(c), 
        this.f([ a[0], a[1], a[0], a[1] ]), this.a = fx(a));
        return !0;
    }
    function Zw(a) {
    ...
    function dx(a, b, c) {
        ...
        if (f) {
            ...
            if (Ie(b, h) <= a.B) return b = c.Ia(f[0]), c = c.Ia(f[1]), b = He(h, b), c = He(h, c), 
            a.H = Math.sqrt(Math.min(b, c)) <= a.B, a.H && (g = b > c ? f[1] : f[0]), g;
        }
        return null;
    }
    function ex(a, b) {
    ...
    Xw.prototype.f = function(a) {
        this.j = a ? a : null;
        var b = this.s;
        b ? a ? b.Ua(Sf(a)) : b.Ua(void 0) : (this.s = b = a ? new vk(Sf(a)) : new vk({}), 
        this.o.ia().Gb(b));
    ...
    function ix(a) {
        ...
        this.W = null;
        a.source ? (this.W = a.source, a = new A(this.W.ce()), y(this.W, "addfeature", this.mm, this), 
        y(this.W, "removefeature", this.om, this)) : a = a.features;
        if (!a) throw Error("The modify interaction requires features or a source");
        this.o = a;
        this.o.forEach(this.vg, this);
    ...
    k.Un = function(a, b) {
        var c = b.a;
        for (b = 0; b < c.length; ++b) this.ca[c[b].T()].call(this, a, c[b]);
    };
    function tx(a, b) {
        var c = a.f;
    ...
    function jx(a) {
        ...
        if (c) {
            ...
            for (var g = 0, h = e.length; g < h; ++g) {
                ...
                p && (n += "-" + p.join("-"));
                f[n] || (f[n] = Array(2));
                if ("Circle" === l.geometry.T() && 1 === l.index) m = vx(b, l), Ee(m, c) && !f[n][0] && (this.j.push([ l, 0 ]), 
                f[n][0] = l); else if (Ee(m[0], c) && !f[n][0]) this.j.push([ l, 0 ]), f[n][0] = l; else if (Ee(m[1], c) && !f[n][1]) {
                    if ("LineString" !== l.geometry.T() && "MultiLineString" !== l.geometry.T() || !f[n][0] || 0 !== f[n][0].index) this.j.push([ l, 1 ]), 
                    f[n][1] = l;
                } else this.rc(a) && w(m) in this.Xa && !f[n][0] && !f[n][1] && d.push([ l, c ]);
            }
            d.length && px(this, a);
    ...
    function kx(a) {
        ...
        for (var b = 0, c = this.j.length; b < c; ++b) {
            ...
            switch (g.T()) {
              ...
              case "Circle":
                h[0] = h[1] = a, 0 === e.index ? (this.s = !0, g.tb(a)) : (this.s = !0, g.ed(Ie(g.wa(), a))), 
                this.s = !1;
            }
    ...
    function ox(a, b, c) {
        ...
        var e = c.Pa(b), f = Ea(Oa(e), c.$().Qa() * a.ua);
        f = nm(a.a, f);
        if (0 < f.length) {
            f.sort(d);
            var g = f[0], h = g.ma, l = vx(e, g), m = c.Ia(l), n = Ie(b, m);
            if (n <= a.ua) {
                b = {};
                if ("Circle" === g.geometry.T() && 1 === g.index) a.va = !0, tx(a, l); else for (n = c.Ia(h[0]), 
                g = c.Ia(h[1]), c = He(m, n), m = He(m, g), n = Math.sqrt(Math.min(c, m)), a.va = n <= a.ua, 
                a.va && (l = c > m ? h[1] : h[0]), tx(a, l), m = 1, c = f.length; m < c; ++m) if (l = f[m].ma, 
                Ee(h[0], l[0]) && Ee(h[1], l[1]) || Ee(h[0], l[1]) && Ee(h[1], l[0])) b[w(l)] = !0; else break;
                b[w(h)] = !0;
                a.Xa = b;
                return;
            }
    ...
    function wx(a, b) {
        var c = b.geometry;
        return "Circle" === c.T() && 1 === b.index ? (a = He(c.wa(), a), c = Math.sqrt(a) - c.zd(), 
        c * c) : Je(a, b.ma);
    }
    function vx(a, b) {
        var c = b.geometry;
    ...
    k.yj = function() {
        if (this.O && "pointerdrag" != this.O.type) {
            ...
            for (h in c) {
                ...
                q && (q = f, this.s = !0, q.na(d), this.s = !1, d = [], void 0 !== m && (this.a.remove(m), 
                d.push(m.ma[0])), void 0 !== l && (this.a.remove(l), d.push(l.ma[1])), void 0 !== m && void 0 !== l && (m = {
                    depth: g.depth,
                    feature: g.feature,
                    geometry: g.geometry,
                    index: n,
                    ma: d
                }, this.a.Ca(Ba(m.ma), m)), xx(this, f, e, g.depth, -1), this.f && (this.H.ia().Lb(this.f), 
                this.f = null), b.length = 0);
            }
    ...
    function zx(a) {
        ...
        var b = this.D(a), c = this.H(a), d = this.G(a), e = !b && !c && !d, f = a.map, g = this.f.ia().i, h = [], l = [];
        if (e) {
            kb(this.a);
            f.Sc(a.pixel, function(a, b) {
                if (this.l(a, b)) return l.push(a), a = w(a), this.a[a] = b, !this.s;
            }.bind(this), {
                layerFilter: this.o,
                hitTolerance: this.j
            });
    ...
    k.Ki = function(a) {
        if (a instanceof Dw) var b = a.feature; else a instanceof cd && (b = a.element);
        this.Gb(b);
    };
    k.Li = function(a) {
        if (a instanceof Dw) var b = a.feature; else a instanceof cd && (b = a.element);
    ...
    k.setMap = function(a) {
        var b = this.v, c = this.ua, d;
        this.j ? d = this.j : this.s && (d = this.s.ce());
        b && (c.forEach(Gc), c.length = 0, d.forEach(this.Yk, this));
        dh.prototype.setMap.call(this, a);
        a && (this.j ? c.push(y(this.j, "add", this.Ki, this), y(this.j, "remove", this.Li, this)) : this.s && c.push(y(this.s, "addfeature", this.Ki, this), y(this.s, "removefeature", this.Li, this)), 
        d.forEach(this.Xk, this));
    };
    k.hd = Re;
    function Hx(a, b, c, d) {
        var e = d.Pa([ b[0] - a.f, b[1] + a.f ]), f = d.Pa([ b[0] + a.f, b[1] - a.f ]);
        e = Ba([ e, f ]);
        var g = nm(a.a, e);
        ...
        if (0 < g.length) {
            ...
            if (a.O && !a.B) {
                if (c = d.Ia(m[0]), h = d.Ia(m[1]), c = He(b, c), b = He(b, h), h = Math.sqrt(Math.min(c, b)), 
                h = h <= a.f) e = !0, f = c > b ? m[1] : m[0], l = d.Ia(f);
            } else a.B && (f = h ? Ae(c, g[0].feature.V()) : Be(c, m), l = d.Ia(f), Ie(b, l) <= a.f && (e = !0, 
            a.O && !h && (c = d.Ia(m[0]), h = d.Ia(m[1]), c = He(l, c), b = He(l, h), h = Math.sqrt(Math.min(c, b)), 
            h = h <= a.f))) && (f = c > b ? m[1] : m[0], l = d.Ia(f));
    ...
    function Kx(a) {
        if (this.a) {
            a = a.coordinate;
            var b = a[0] - this.a[0], c = a[1] - this.a[1], d = this.j || new A([ this.f ]);
    ...
    k.Ul = function() {
        for (var a = this.Rh(), b = gg(1, 256), c = b.createLinearGradient(0, 0, 1, 256), d = 1 / (a.length - 1), e = 0, f = a.length; e < f; ++e) c.addColorStop(e * d, a[e]);
        b.fillStyle = c;
    ...
    var Sx = "blur", Qx = "gradient", Tx = "radius";
    function Ux(a) {
        vg.call(this, a ? a : {});
        this.type = "IMAGE";
    }
    ...
    function Xx(a, b) {
        for (var c = a.length, d = Array(c), e = 0; e < c; ++e) d[e] = Wx(a[e], b);
        return Yx(d);
    }
    function Yx(a) {
    ...
    by.prototype.qd = function(a) {
        for (var b, c; $h(this); ) {
            ...
            c = b.xa[0].toString();
            var d;
            if (d = c in a) b = b.xa, d = ka(a[c], b[1], b[2]);
    ...
    function dy(a, b, c, d, e, f, g, h, l, m, n) {
        ...
        e = this.c.C();
        f = h ? eb(f, h) : f;
        if (0 === Za(f)) this.state = 4; else if ((h = a.C()) && (e ? e = eb(e, h) : e = h), 
        d = fn(a, c, cb(f), d.Sa(this.v[0])), !isFinite(d) || 0 >= d) this.state = 4; else if (this.o = new jn(a, c, f, e, d * (void 0 !== m ? m : .5)), 
        0 === this.o.c.length) this.state = 4; else if (this.f = b.Bc(d), c = ln(this.o), 
        e && (a.g ? (c[1] = oa(c[1], e[1], e[3]), c[3] = oa(c[3], e[1], e[3])) : c = eb(c, e)), 
        Za(c)) {
            a = tc(b, c, this.f);
    ...
    dy.prototype.fe = function() {
        ...
        if (0 === a.length) this.state = 3; else {
            ...
            b = this.l.Sa(b);
            var e = this.c.Sa(this.f), f = this.l.La(this.v);
            ...
            this.a.forEach(function(b) {
                ...
                if (0 == c || 1 == c) {
                    ...
                    var d = y(b, "change", function() {
                        var c = b.getState();
                        if (2 == c || 3 == c || 4 == c) Gc(d), a--, 0 === a && (this.Hd.forEach(Gc), this.Hd = null, 
                        this.fe());
                    }, this);
                    this.Hd.push(d);
                }
    ...
    function Bi(a, b, c, d, e) {
        ...
        if (!a) return !1;
        b = !0;
        for (var f, g, h = d.fa; h <= d.la; ++h) for (var l = d.ea; l <= d.ka; ++l) f = c + "/" + h + "/" + l, 
    ...
    function jy(a) {
        ...
        this.f = {};
        this.s = {};
        this.xb = a.reprojectionErrorThreshold;
        this.O = !1;
    }
    v(jy, iy);
    k = jy.prototype;
    k.$i = function() {
        if ($h(this.a)) return !0;
    ...
    k.bb = function(a) {
        var b = this.c;
        return !this.tileGrid || b && !Wb(b, a) ? (b = w(a).toString(), b in this.s || (this.s[b] = zc(a)), 
        this.s[b]) : this.tileGrid;
    };
    k.Xd = function(a) {
        var b = this.c;
        if (!b || Wb(b, a)) return this.a;
        a = w(a).toString();
    ...
    k.$c = function(a, b, c, d, e) {
        ...
        if (f && e && !Wb(f, e)) {
            ...
            var l = this.bb(f), m = this.bb(e), n = gy(this, c, e);
    ...
    function my(a, b, c, d, e, f) {
        ...
        } else l = ly(a, b, c, d, e, f, h), a.a.set(g, l);
        return l;
    }
    k.Qb = function(a) {
        if (this.O != a) {
    ...
    k.Rb = function(a, b) {
        if (a = Nb(a)) a = w(a).toString(), a in this.s || (this.s[a] = b);
    };
    function ky(a, b) {
        a.Y().src = b;
    }
    function ny(a) {
        ...
        this.l = a.key;
        this.G = a.imagerySet;
        ay("https://dev.virtualearth.net/REST/v1/Imagery/Metadata/" + this.G + "?uriScheme=https&include=ImageryProviders&key=" + this.l + "&c=" + this.o, this.Xa.bind(this), void 0, "jsonp");
    }
    v(ny, jy);
    ...
    ny.prototype.Xa = function(a) {
        if (200 != a.statusCode || "OK" != a.statusDescription || "ValidCredentials" != a.authenticationResultCode || 1 != a.resourceSets.length || 1 != a.resourceSets[0].resources.length) pn(this, "error"); else {
            ...
            this.tileUrlFunction = Yx(c.imageUrlSubdomains.map(function(a) {
                ...
                return function(a) {
                    if (a) return oc(a[0], a[1], -a[2] - 1, b), a = d, f && (a += "&dpi=d1&device=mobile"), 
                ...
                this.ta(function(a) {
                    ...
                    c.imageryProviders.map(function(c) {
                        for (var e = !1, f = c.coverageAreas, h = 0, l = f.length; h < l; ++h) {
                            var m = f[h];
                            if (d >= m.zoomMin && d <= m.zoomMax && (m = m.bbox, m = hb([ m[1], m[0], m[3], m[2] ], g), 
                            fb(m, a.extent))) {
                                e = !0;
                                break;
                            }
    ...
    function sy(a) {
        if (void 0 !== a.resolution) {
            ...
            for (var b = Ca(), c = a.distance * a.resolution, d = a.source.ce(), e = {}, f = 0, g = d.length; f < g; f++) {
                var h = d[f];
                w(h).toString() in e || !(h = a.geometryFunction(h)) || (h = h.U(), Oa(h, b), Ea(b, c, b), 
                h = a.source.Wf(b), h = h.filter(function(a) {
                    a = w(a).toString();
    ...
    k.Vc = function(a, b, c, d) {
        ...
        if (1 != this.G) {
            var h = this.G * ab(a) / 2, l = this.G * bb(a) / 2;
            a[0] = f - h;
            a[1] = g - l;
            a[2] = f + h;
            a[3] = g + l;
    ...
    k.Vc = function(a, b, c) {
        ...
        if (void 0 !== this.O) {
            d = this.O;
            var f = cb(a), g = this.ca, h = ab(a), l = bb(a), m = e[0], n = e[1], p = .0254 / this.l;
            e = {
    ...
    function xy(a) {
        var b = a.imageExtent, c = void 0 !== a.crossOrigin ? a.crossOrigin : null, d = void 0 !== a.imageLoadFunction ? a.imageLoadFunction : wn;
        qn.call(this, {
            attributions: a.attributions,
            logo: a.logo,
    ...
    k.Vc = function(a, b, c, d) {
        ...
        var e = b / c, f = cb(a), g = db(f, e, 0, [ Math.ceil(ab(a) / e), Math.ceil(bb(a) / e) ]);
    ...
    (function(a) {
        ...
        function f(a) {
            ...
            var c = [];
            if (b) for (var f = 0; f < b; ++f) c[f] = d(a, this.wh.bind(this, f)); else c[0] = e(a, this.wh.bind(this, 0));
            this.ve = c;
            this.Md = [];
        ...
        f.prototype.uk = function(a) {
            for (this.Md.push(a); this.Md.length > this.wk; ) this.Md.shift().callback(null, null);
        };
        f.prototype.th = function() {
            if (0 === this.ue && 0 < this.Md.length) {
                var a = this.If = this.Md.shift(), b = a.inputs[0].width, c = a.inputs[0].height, d = a.inputs.map(function(a) {
                    return a.data.buffer;
                }), e = this.ve.length;
                this.ue = e;
                if (1 === e) this.ve[0].postMessage({
                    buffers: d,
                    meta: a.fi,
                    imageOps: this.Hf,
                    width: b,
                    ...
                    for (var h = g * f, C = [], z = 0, E = d.length; z < E; ++z) C.push(d[g].slice(h, h + f));
        ...
        f.prototype.xk = function() {
            var a = this.If, c = this.ve.length;
            if (1 === c) {
    ...
    Dy.prototype.Y = function(a, b, c, d) {
        c = !0;
        for (var e, f = 0, g = this.f.length; f < g; ++f) if (e = this.f[f].a.ia(), "ready" !== e.getState()) {
            c = !1;
            break;
        }
        if (!c) return null;
    ...
    Dy.prototype.ca = function(a, b, c, d) {
        if (!b && c) {
            ...
            if (e === this.l.viewState.resolution && Ra(b, this.l.extent)) {
                if (this.a) var f = this.a.Y().getContext("2d"); else f = gg(Math.round(ab(b) / e), Math.round(bb(b) / e)), 
                this.a = new en(b, e, 1, f.canvas);
    ...
    var Iy = "beforeoperations", Jy = "afteroperations";
    function Ky(a) {
    ...
    v(Ky, oy);
    var Ny = [ 'Map tiles by <a href="https://stamen.com/">Stamen Design</a>, under <a href="https://creativecommons.org/licenses/by/3.0/">CC BY 3.0</a>.', '&copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors.' ], My = {
        terrain: {
            Ob: "jpg",
            opaque: !0
        },
    ...
    Oy.prototype.Rc = function(a, b, c) {
        ...
        d || (d = this.bb(c));
        if (!(d.b.length <= a[0])) {
            var e = d.La(a, this.l), f = Aa(d.Za(a[0]), this.j);
            1 != b && (f = za(f, b, this.j));
            d = {
                F: "image",
                FORMAT: "PNG32",
            ...
            jb(d, this.i);
            var g = this.urls;
            g ? (c = c.ub.split(":").pop(), d.SIZE = f[0] + "," + f[1], d.BBOX = e.join(","), 
            d.BBOXSR = c, d.IMAGESR = c, d.DPI = Math.round(d.DPI ? d.DPI * b : 90 * b), a = (1 == g.length ? g[0] : g[va((a[1] << a[0]) + a[2], g.length)]).replace(/MapServer\/?$/, "MapServer/export").replace(/ImageServer\/?$/, "ImageServer/exportImage"), 
            a = uy(a, d)) : a = void 0;
            return a;
        }
    };
    ...
    function Sy(a) {
        ...
        if (a.url) if (a.jsonp) ay(a.url, this.Bg.bind(this), this.cf.bind(this)); else {
    ...
    function Ty(a) {
        ...
        this.f = void 0;
        this.i = a.jsonp || !1;
        if (a.url) if (this.i) ay(a.url, this.Cg.bind(this), this.df.bind(this)); else {
            var b = new XMLHttpRequest();
    ...
    function Wy(a) {
        if (0 == a.state) if (a.state = 1, a.o) ay(a.v, a.Zi.bind(a), a.Me.bind(a)); else {
            var b = new XMLHttpRequest();
    ...
    k.Yo = function(a, b, c, d) {
        ...
        b = f.Ke(a, b);
        if (!(f.b.length <= b[0])) {
            var g = f.Sa(b[0]), h = f.La(b, this.ca);
    ...
    function $y(a, b, c, d, e, f, g) {
        ...
        if (h) {
            ...
            d[3] = a);
            g.BBOX = d.join(",");
            return uy(1 == h.length ? h[0] : h[va((b[1] << b[0]) + b[2], h.length)], g);
        }
    }
    k.Xc = function(a) {
    ...
    k.Rc = function(a, b, c) {
        ...
        if (!(d.b.length <= a[0])) {
            ...
            var e = d.Sa(a[0]), f = d.La(a, this.ca);
    ...
    function az(a, b, c, d, e, f, g, h, l, m, n, p, q, r, u) {
        ...
        this.P = [];
        if (f) {
            var x = l.La(f), C = l.Sa(a[0]);
            h.Tf(x, h.Bc(C), function(a) {
                var b = eb(x, h.La(a)), c = h.C();
                c && (b = eb(b, c));
                .5 <= ab(b) / C && .5 <= bb(b) / C && (b = a.toString(), c = m[b], c || (c = g(a, n, p), 
                c = m[b] = new q(a, void 0 == c ? 4 : 0, void 0 == c ? "" : c, d, e), this.P.push(y(c, "change", r))), 
                c.c++, this.a.push(b));
            }.bind(this));
        }
    }
    ...
    function ez(a, b, c) {
        ...
        var m = c.Wc(), n = "ne" == c.b.substr(0, 2);
    ...
    function Z(a) {
        ...
        var d = this.ca = void 0 !== a.requestEncoding ? a.requestEncoding : "KVP", e = a.tileGrid, f = {
            layer: this.G,
            style: this.aa,
        ...
        var g = this.i, h = c && 0 < c.length ? Yx(c.map(b)) : Zx;
        jy.call(this, {
            attributions: a.attributions,
            cacheSize: a.cacheSize,
            crossOrigin: a.crossOrigin,
    ...
    t("ol.loadingstrategy.tile", function(a) {
        return function(b, c) {
            ...
            var d = [];
            c = [ c, 0, 0 ];
            for (c[1] = b.fa; c[1] <= b.la; ++c[1]) for (c[2] = b.ea; c[2] <= b.ka; ++c[2]) d.push(a.La(c));
            return d;
        };
    });
    t("ol.Map", J);
    ...
    t("ol.proj.toLonLat", function(a, b) {
        ...
        b = a[0];
        if (-180 > b || 180 < b) a[0] = va(b + 180, 360) - 180;
        return a;
    });
    t("ol.proj.get", Nb);
    ...
    t("ol.source.WMTS.optionsFromCapabilities", function(a, b) {
        ...
        var e = 1 < c.TileMatrixSetLink.length ? "projection" in b ? mc(c.TileMatrixSetLink, function(a) {
            ...
            }).SupportedCRS.replace(/urn:ogc:def:crs:(\w+):(.*:)?(\w+)$/, "$1:$3"), e = Nb(c), f = Nb(b.projection);
        ...
        var n = "projection" in b ? Nb(b.projection) : Nb(m.SupportedCRS.replace(/urn:ogc:def:crs:(\w+):(.*:)?(\w+)$/, "$1:$3"));
        ...
        r = 0, p = a.length; r < p; ++r) {
            var x = fc(a[r].Constraint, function(a) {
                return "GetEncoding" == a.name;
            }).AllowedValues.Value;
            "" === m && (m = x[0]);
            if ("KVP" === m) cc(x, "KVP") && u.push(a[r].href); else break;
        }
