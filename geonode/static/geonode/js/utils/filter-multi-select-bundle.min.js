(function ($) {
    ...
    var FilterMultiSelect = (function () {
        ...
        FilterMultiSelect.createEvent = function (e, n, v, l) {
            var event = new CustomEvent(e, { detail: { name: n, value: v, label: l }, bubbles: true, cancelable: true, composed: false });
            return event;
        };
        FilterMultiSelect.prototype.initialize = function () {
            ...
            this.items.className = "items dropdown-item msgapi gn-primary";
        ...
        FilterMultiSelect.prototype.incrementItemFocus = function () {
            ...
            do {
                i++;
            } while ((i == -1 && (this.selectAllOption.isDisabled() || this.selectAllOption.isHidden())) || (i >= 0 && i < this.options.length && (this.options[i].isDisabled() || this.options[i].isHidden())));
        ...
        FilterMultiSelect.EventType = { SELECTED: "optionselected", DESELECTED: "optiondeselected" };
