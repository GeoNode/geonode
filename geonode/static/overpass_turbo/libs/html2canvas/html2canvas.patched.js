        ...
        loadImage: function( src ) {
            ...
            if ( src && images[src] === undefined ) {
                ...
                if ( src.match(/data:image\/.*;base64,/i) ) {
                    ...
                    // tyr_asd: begin of hacky hacks
                    img.src = src+"?"; // opera hack: this prevents from cache-hits without crossOrigin information

                    // hack: this is not needed as far as I can tell and potentially breaks when images are acutally cached
