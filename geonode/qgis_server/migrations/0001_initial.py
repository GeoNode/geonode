...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal(u'qgis_server', ['QGISServerLayer'])
    ...
    models = {
        ...
        u'qgis_server.qgisserverlayer': {
            'Meta': {'object_name': 'QGISServerLayer'},
            'base_layer_path': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
