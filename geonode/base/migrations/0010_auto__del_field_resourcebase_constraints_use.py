...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ResourceBase.constraints_use'
        db.delete_column('base_resourcebase', 'constraints_use')


    def backwards(self, orm):
        
        # Adding field 'ResourceBase.constraints_use'
        db.add_column('base_resourcebase', 'constraints_use', self.gf('django.db.models.fields.CharField')(default='copyright', max_length=255), keep_default=False)
    ...
    models = {
        'actstream.action': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 11, 3, 59, 21, 10636)'}),
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 11, 3, 59, 21, 9883)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 11, 3, 59, 21, 9807)'}),
