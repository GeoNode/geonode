...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        "Remove SRID from WKT in default value."
        db.alter_column('base_resourcebase', 'csw_wkt_geometry', models.TextField(_('CSW WKT geometry'), null=False, default='POLYGON((-180 -90,-180 90,180 90,180 -90,-180 -90))'))

    def backwards(self, orm):
        "Add SRID from WKT in default value."
        db.alter_column('base_resourcebase', 'csw_wkt_geometry', models.TextField(_('CSW WKT geometry'), null=False, default='SRID=4326;POLYGON((-180 -90,-180 90,180 90,180 -90,-180 -90))'))
    ...
    models = {
        'actstream.action': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 3, 3, 12, 28, 256204)'}),
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 3, 3, 12, 28, 255413)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 3, 3, 12, 28, 255339)'}),
