...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('base_topiccategory', 'layers_count', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'TopicCategory.maps_count'
        db.add_column('base_topiccategory', 'maps_count', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'TopicCategory.documents_count'
        db.add_column('base_topiccategory', 'documents_count', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TopicCategory.layers_count'
        db.delete_column('base_topiccategory', 'layers_count')

        # Deleting field 'TopicCategory.maps_count'
        db.delete_column('base_topiccategory', 'maps_count')

        # Deleting field 'TopicCategory.documents_count'
        db.delete_column('base_topiccategory', 'documents_count')
    ...
    models = {
        'actstream.action': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 27, 8, 9, 10, 912461)'}),
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 27, 8, 9, 10, 904167)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 5, 27, 8, 9, 10, 904072)'}),
