...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ResourceBase.license'
        db.add_column(u'base_resourcebase', 'license', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.License'], null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ResourceBase.license'
        db.delete_column(u'base_resourcebase', 'license_id')
