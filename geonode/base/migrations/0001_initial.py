    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(default=b'', verbose_name='Field description')),
                ('description_en', models.TextField(default=b'', null=True, verbose_name='Field description')),
                ...
                ('is_choice', models.BooleanField(default=True, verbose_name='Is active')),
            ],
            options={
                'ordering': ('identifier',),
        ...
        migrations.AddField(
            model_name='resourcebase',
            name='regions',
            field=models.ManyToManyField(help_text='keyword identifies a location', to='base.Region', null=True, verbose_name='keywords region', blank=True),
        ),
        migrations.AddField(
            model_name='resourcebase',
