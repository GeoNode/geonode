...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Region'
        db.create_table('base_region', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('code', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('base', ['Region'])

        # Adding M2M table for field regions on 'ResourceBase'
        db.create_table('base_resourcebase_regions', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('resourcebase', models.ForeignKey(orm['base.resourcebase'], null=False)),
            ('region', models.ForeignKey(orm['base.region'], null=False))
        ))
        db.create_unique('base_resourcebase_regions', ['resourcebase_id', 'region_id'])


    def backwards(self, orm):
        
        # Deleting model 'Region'
        db.delete_table('base_region')
    ...
    models = {
        'actstream.action': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 11, 5, 13, 13, 474802)'}),
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 11, 5, 13, 13, 471418)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 11, 5, 13, 13, 471349)'}),
