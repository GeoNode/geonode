...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('base_topiccategory', 'gn_description', self.gf('django.db.models.fields.TextField')())
    ...
    def backwards(self, orm):
        ...
        # Changing field 'TopicCategory.gn_description'
        db.alter_column('base_topiccategory', 'gn_description', self.gf('django.db.models.fields.CharField')(max_length=255))
    ...
    models = {
        'actstream.action': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 13, 9, 0, 26, 233563)'}),
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 13, 9, 0, 26, 226715)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 13, 9, 0, 26, 226653)'}),
        ...
        'base.topiccategory': {
            ...
            'gn_description': ('django.db.models.fields.TextField', [], {'default': "''"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
