...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TopicCategory.identifier'
        ...
        # Changing field 'TopicCategory.description'
        db.alter_column('base_topiccategory', 'description', self.gf('django.db.models.fields.CharField')(max_length=255))


    def backwards(self, orm):
        
        # Deleting field 'TopicCategory.identifier'
        db.delete_column('base_topiccategory', 'identifier')

        # Deleting field 'TopicCategory.gn_description'
        db.delete_column('base_topiccategory', 'gn_description')

        # Deleting field 'TopicCategory.is_choice'
        db.delete_column('base_topiccategory', 'is_choice')

        # Changing field 'TopicCategory.description'
        db.alter_column('base_topiccategory', 'description', self.gf('django.db.models.fields.TextField')())
    ...
    models = {
        'actstream.action': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 13, 8, 7, 40, 917656)'}),
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 13, 8, 7, 40, 916823)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 13, 8, 7, 40, 916760)'}),
        ...
        'base.topiccategory': {
            ...
            'gn_description': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
