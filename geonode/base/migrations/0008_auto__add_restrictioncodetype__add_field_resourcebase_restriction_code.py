...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('base_restrictioncodetype', (
        ...
        db.send_create_signal('base', ['RestrictionCodeType'])

        # Adding field 'ResourceBase.restriction_code_type'
        db.add_column('base_resourcebase', 'restriction_code_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.RestrictionCodeType'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'RestrictionCodeType'
        db.delete_table('base_restrictioncodetype')

        # Deleting field 'ResourceBase.restriction_code_type'
        db.delete_column('base_resourcebase', 'restriction_code_type_id')
    ...
    models = {
        'actstream.action': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 11, 3, 48, 22, 734316)'}),
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 11, 3, 48, 22, 736190)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 11, 3, 48, 22, 736132)'}),
