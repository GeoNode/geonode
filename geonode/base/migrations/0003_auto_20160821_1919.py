...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='category',
            field=models.ForeignKey(blank=True, to='base.TopicCategory',
                                    help_text='high-level geographic data thematic'
                                              'classification to assist in the grouping and'
                                              'search of available geographic data sets.',
                                    null=True),
        ),
    ]
