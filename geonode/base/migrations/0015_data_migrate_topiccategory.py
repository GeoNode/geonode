...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        """Move slug to identifier, name to description and to gn_description."""
        for tc in orm.TopicCategory.objects.all():
            tc.identifier = tc.slug
            tc.description = tc.name
            tc.gn_description = tc.name
            tc.save()
    ...
    models = {
        'actstream.action': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 13, 8, 10, 59, 692928)'}),
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 13, 8, 10, 59, 684563)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 13, 8, 10, 59, 684495)'}),
