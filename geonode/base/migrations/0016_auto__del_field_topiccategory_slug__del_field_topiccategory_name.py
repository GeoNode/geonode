...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'TopicCategory.slug'
        db.delete_column('base_topiccategory', 'slug')

        # Deleting field 'TopicCategory.name'
        db.delete_column('base_topiccategory', 'name')


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'TopicCategory.slug'
        raise RuntimeError("Cannot reverse this migration. 'TopicCategory.slug' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'TopicCategory.name'
        raise RuntimeError("Cannot reverse this migration. 'TopicCategory.name' and its values cannot be restored.")
    ...
    models = {
        'actstream.action': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 13, 8, 36, 57, 222401)'}),
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 13, 8, 36, 57, 218518)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 13, 8, 36, 57, 218450)'}),
