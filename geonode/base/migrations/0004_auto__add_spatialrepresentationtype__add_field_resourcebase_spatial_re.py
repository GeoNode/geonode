...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('base_spatialrepresentationtype', (
        ...
        db.send_create_signal('base', ['SpatialRepresentationType'])

        # Adding field 'ResourceBase.spatial_representation_type_new'
        db.add_column('base_resourcebase', 'spatial_representation_type_new', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.SpatialRepresentationType'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'SpatialRepresentationType'
        db.delete_table('base_spatialrepresentationtype')

        # Deleting field 'ResourceBase.spatial_representation_type_new'
        db.delete_column('base_resourcebase', 'spatial_representation_type_new_id')
    ...
    models = {
        'actstream.action': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 7, 5, 8, 20, 633186)'}),
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 7, 5, 8, 20, 635369)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 6, 7, 5, 8, 20, 635305)'}),
        ...
        'base.resourcebase': {
            ...
            'spatial_representation_type_new': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['base.SpatialRepresentationType']", 'null': 'True', 'blank': 'True'}),
