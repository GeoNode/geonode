...
class TestRegions(GeoNodeBaseTestSupport):
    def setUp(self):
        self.dataset_inside_region = GEOSGeometry(
            "POLYGON ((-4.01799226543944599 57.18451093931114571, 8.89409253052255622 56.91828238681708285, 9.29343535926363984 47.73339732577194638, -3.75176371294537603 48.13274015451304422, -4.01799226543944599 57.18451093931114571))",
            srid=4326,
        )

        self.dataset_overlapping_region = GEOSGeometry(
            "POLYGON ((15.28357779038003628 33.6232840435866791, 28.19566258634203848 33.35705549109261625, 28.5950054150831221 24.17217043004747978, 15.54980634287410624 24.57151325878857762, 15.28357779038003628 33.6232840435866791))",
            srid=4326,
        )

        self.dataset_outside_region = GEOSGeometry(
            "POLYGON ((-3.75176371294537603 23.10725622007123548, 9.16032108301662618 22.84102766757717262, 9.5596639117577098 13.65614260653203615, -3.48553516045130607 14.05548543527313399, -3.75176371294537603 23.10725622007123548))",
            srid=4326,
        )
