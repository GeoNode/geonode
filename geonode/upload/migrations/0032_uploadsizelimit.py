# Generated by Django 2.2.24 on 2022-01-21 14:22
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('max_size', models.BigIntegerField(default=104857600, help_text='The maximum file size allowed for upload (bytes).', validators=[django.core.validators.MinValueValidator(limit_value=0)])),
            ],
            options={
                'ordering': ('slug',),
            },
