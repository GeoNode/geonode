...
class SystemSettings(models.Model):
    ...
    modified_by = models.ForeignKey(settings.AUTH_USER_MODEL, verbose_name=_('Modified by'), related_name='layer_style_modified_by', help_text=_('Designates user who updates the record.'), )
