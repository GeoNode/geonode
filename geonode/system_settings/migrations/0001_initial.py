    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified_by', models.ForeignKey(related_name='system_settings_modified_by', verbose_name='Modified by', to=settings.AUTH_USER_MODEL, help_text='Designates user who updates the record.')),
            ],
        ),
    ]
