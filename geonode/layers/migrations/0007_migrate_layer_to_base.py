...
for layerorm in orm.Layer.objects.all():
    ...
    def forwards(self, orm):
        ...
        for layer in orm.Layers.objects.all():
            rbase = ResourceBase()
            #bbox = layer.geographic_bounding_box.split('((')[1].split(',')
            rbase = ResourceBase.create(
                id=layer.id,
                uuid=layer.uuid,
                owner=layer.owner,
                title=layer.title,
    ...
    models = {
        u'actstream.action': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 13, 8, 1, 11, 326388)'}),
        ...
        u'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 13, 8, 1, 11, 327479)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 13, 8, 1, 11, 327013)'}),
