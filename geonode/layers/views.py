...
def layer_download_csv(request):
    ...
    for auth in auth_list:
        ...
        organization = if getprofile.organization is not None: unidecode(getprofile.organization)
    ...
    for anon in anon_list:
        ...
        organization = if anon.anon_organization is not None: unidecode(anon.anon_organization)
    ...
    for ftp_request in FTPRequest.objects.all():
        ...
        organization = if ftp_detail['organization'] is not None: unidecode(ftp_detail['organization'])
