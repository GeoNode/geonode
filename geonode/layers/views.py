...
def layer_download_csv(request):
    ...
    for auth in auth_list:
        ...
        organization = unidecode(getprofile.organization) if getprofile.organization is not None
    ...
    for anon in anon_list:
        ...
        organization = unidecode(anon.anon_organization) if anon.anon_organization is not None
    ...
    for ftp_request in FTPRequest.objects.all():
        ...
        organization = unidecode(ftp_detail['organization']) if ftp_detail['organization'] is not None
