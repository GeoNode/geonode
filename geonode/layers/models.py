...
class Layer(models.Model, PermissionLevelMixin):
    ...
    # section 1
    title = models.CharField(_('title'), max_length=255, help_text='name by which the cited resource is known')
    date = models.DateTimeField(_('date'), default = datetime.now, help_text='reference date for the cited resource') # passing the method itself, not the result
    
    date_type = models.CharField(_('date type'), max_length=255, choices=VALID_DATE_TYPES, default='publication', help_text='identification of when a given event occurred')

    edition = models.CharField(_('edition'), max_length=255, blank=True, null=True, help_text='version of the cited resource')
    abstract = models.TextField(_('abstract'), blank=True, help_text='brief narrative summary of the content of the resource(s)')
    purpose = models.TextField(_('purpose'), null=True, blank=True, help_text='summary of the intentions with which the resource(s) was developed')

    maintenance_frequency = models.CharField(_('maintenance frequency'), max_length=255, choices=UPDATE_FREQUENCIES, blank=True, null=True, help_text='frequency with which modifications and deletions are made to the data after it is first produced')
    ...
    keywords_region = models.CharField(_('keywords region'), max_length=3, choices=COUNTRIES, default='USA', help_text='keyword identifies a location')
    constraints_use = models.CharField(_('constraints use'), max_length=255, choices=[(x, x) for x in CONSTRAINT_OPTIONS], default='copyright', help_text='constraints applied to assure the protection of privacy or intellectual property, and any special restrictions or limitations or warnings on using the resource or metadata')
    constraints_other = models.TextField(_('constraints other'), blank=True, null=True, help_text='other restrictions and legal prerequisites for accessing and using the resource or metadata')
    spatial_representation_type = models.CharField(_('spatial representation type'), max_length=255, choices=SPATIAL_REPRESENTATION_TYPES, blank=True, null=True, help_text='method used to represent geographic information in the dataset')

    # Section 4
    language = models.CharField(_('language'), max_length=3, choices=ALL_LANGUAGES, default='eng', help_text='language used within the dataset')
    topic_category = models.CharField(_('topic_category'), max_length=255, choices=TOPIC_CATEGORIES, default='location', help_text='high-level geographic data thematic classification to assist in the grouping and search of available geographic data sets.')

    # Section 5
    temporal_extent_start = models.DateField(_('temporal extent start'), blank=True, null=True, help_text='time period covered by the content of the dataset (start)')
    temporal_extent_end = models.DateField(_('temporal extent end'), blank=True, null=True, help_text='time period covered by the content of the dataset')

    supplemental_information = models.TextField(_('supplemental information'), default=DEFAULT_SUPPLEMENTAL_INFORMATION, help_text='any other descriptive information about the dataset')

    # Section 6
    distribution_url = models.TextField(_('distribution URL'), blank=True, null=True, help_text='information about on-line sources from which the dataset, specification, or community profile name and extended metadata elements can be obtained')
    distribution_description = models.TextField(_('distribution description'), blank=True, null=True, help_text='detailed text description of what the online resource is/does')

    # Section 8
    data_quality_statement = models.TextField(_('data quality statement'), blank=True, null=True, help_text='general explanation of the data producer\'s knowledge about the lineage of a dataset')
