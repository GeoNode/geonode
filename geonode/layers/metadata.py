...
def iso2dict(exml):
    ...
    if hasattr(mdata, "identification"):
        ...
        if hasattr(mdata.identification, "keywords") and len(mdata.identification[0].keywords) > 0:
            ...
            keywords = convert_keyword(mdata.identification[0].keywords, iso2dict=True)
