...
from .views import (proxy, ajax_snapshot_history, layer_searchable_fields,
...
urlpatterns = patterns('',
                        ...
                        url(r'^layers/(?P<layername>[^/]*)/searchable-fields$', layer_searchable_fields, name = 'layer_searchable_fields'),
