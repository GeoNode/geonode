...
class GeoAppsApiTests(APITestCase):
    ...
    def test_geoapps_crud(self):
        ...
        self.assertEqual(response.json()["geoapp"].get("extent")[-1], "EPSG:3857")
        self.assertEqual(response.json()["geoapp"].get("extent")[:4], [1123692.0, 5338214.0, 1339852.0, 5482615.0])
