...
ACCOUNT_LOGIN_METHODS = ast.literal_eval(os.environ.get("ACCOUNT_LOGIN_METHODS", "{'email', 'username'}"))

ACCOUNT_SIGNUP_FIELDS = ast.literal_eval(
    os.environ.get("ACCOUNT_SIGNUP_FIELDS", "['email*', 'username*', 'password1*', 'password2*']")
)
