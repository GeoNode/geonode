{% load search_tags %}
{% raw %}
<article class="{{type}} {{storeType}}" data-category="{{category_slug}}" data-modified="{{last_modified}}" data-modified-date="{{last_modified_date}}" data-popular="{{popular}}" data-keywords="{{keywords}}">
  <h6>{{display_type}}</h6>
  <a href="{{url}}">
