...
class CommonField(models.Model):
    ...
    created_date = models.DateTimeField(_('Created Date'), default=timezone.now, help_text='Created Date')
    last_modified = models.DateTimeField(_('Last Modified'), auto_now_add=True, help_text='Last Modified')
