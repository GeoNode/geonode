...
class TestManagmentCommands(TestCase):
    def setUp(self) -> None:
    ...
    def test_get_all_lang_available_should_return_all_the_lang_available_int_the_file(self):
        ...
        expected = [('it', 'Registro dei dati di interesse generale per il RNDT'), ('en', 'Register of the reference data sets for RNDT'), (None, 'Mocked Title')]
        self.assertListEqual(expected, actual)

    def test_determinate_title_should_return_the_title_without_lang_if_available(self):
        titles = [('it', 'Registro dei dati di interesse generale per il RNDT'), ('en', 'Register of the reference data sets for RNDT'), (None, 'Mocked Title')]
    ...
    def test_determinate_title_should_return_the_italian_lang_if_none_is_not_available(self):
        titles = [('it', 'Registro dei dati di interesse generale per il RNDT'), ('en', 'Register of the reference data sets for RNDT')]
