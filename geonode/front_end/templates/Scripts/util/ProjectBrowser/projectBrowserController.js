appModule.controller('projectBrowserController',
    ['$scope', '$window', '$rootScope', 'showProjectNameInput', 'projectService', '$modalInstance', 'surfToastr', '$modal', 'mapService', 'dirtyManager', 'urlResolver', 'subscriptionStatus', 'helperService', '$http',
    function ($scope, $window, $rootScope, showProjectNameInput, projectService, $modalInstance, surfToastr, $modal, mapService, dirtyManager, urlResolver, subscriptionStatus, helperService, $http) {
        ...
        $scope.save = function () {
            ...
            function executeSave() {
                projectService.saveProject(projectName).success(function (data) {
