repositoryModule.factory('layerRepository', [
    '$http', 'urlResolver', 'dirtyManager', '$window', 'surfFeatureFactory', '$q',
    function ($http, urlResolver, dirtyManager, $window, surfFeatureFactory, $q) {
        return {
            ...
            getRanges: function (dataId, attributeId, divisions, algorithm) {
                return $http.post(urlResolver.resolveClassification('GetRanges'),
                { dataId: dataId, attributeId: attributeId, divisions: divisions, algorithm: algorithm });
            },
