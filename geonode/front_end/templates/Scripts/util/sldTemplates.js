    ...
    return {
        ...
        pointTemplateForTextGraphic:
            '{8}' +
                ...
                '</Fill>' +
                '</TextSymbolizer>',
        pointTemplateForFontAwosomeTextGraphic:
          '{8}' +
              '<PointSymbolizer> ' +
              '<Graphic> ' +
              '<Mark> ' +
          ...
          '</Graphic>' +
          '</PointSymbolizer>',
        pointWithExternalGraphicTemplate:
            '{4}' +
                '<PointSymbolizer>' +
                '<Graphic> ' +
                '<ExternalGraphic> ' +
        ...
        heatmapTemplate:
            '<StyledLayerDescriptor xmlns="http://www.opengis.net/sld" xmlns:ogc="http://www.opengis.net/ogc" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" version="1.0.0" xsi:schemaLocation="http://www.opengis.net/sld StyledLayerDescriptor.xsd"><UserStyle><FeatureTypeStyle>' +
                '<Transformation>' +
