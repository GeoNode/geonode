...
urlpatterns = patterns('geonode.maps.views',
                       ...
                       url(r'^new/story$', 'new_story_json', name='new_story_json'),
                       url(r'^checkurl/?$', 'ajax_url_lookup'),
                       url(r'^snapshot/create/?$', 'snapshot_create'),
                       url(r'^(?P<storyid>[^/]+)/draft','draft_view',name='draft_view'),
                       url(r'^(?P<storyid>[^/]+)/save$', 'save_story', name='save_story'),
                       url(r'^(?P<mapid>[^/]+)$', 'map_detail', name='map_detail'),
                       url(r'^(?P<mapid>[^/]+)/view$', 'map_view', name='map_view'),
                       url(r'^(?P<mapid>[^/]+)/viewer$', 'map_viewer', name='map_viewer'),
