...
if 'geonode.geoserver' in settings.INSTALLED_APPS:
    urlpatterns = patterns('geonode.maps.views',
                           ...
                           url(r'^new/data$', 'new_map_json',
                               name='new_map_json'),
                           url(r'^checkurl/?$', 'ajax_url_lookup'),
                           url(r'^snapshot/create/?$', 'snapshot_create'),
                           url(r'^(?P<mapid>[^/]+)$', 'map_detail',
                               name='map_detail'),
                           url(r'^(?P<mapid>[^/]+)/view$', 'map_view',
                               name='map_view'),
                           url(r'^(?P<mapid>[^/]+)/data$', 'map_json',
                               name='map_json'),
                           url(r'^(?P<mapid>[^/]+)/download$', 'map_download',
                               name='map_download'),
                           url(r'^(?P<mapid>[^/]+)/wmc$', 'map_wmc',
                               name='map_wmc'),
                           url(r'^(?P<mapid>[^/]+)/wms$', 'map_wms',
                               name='map_wms'),
                           url(r'^(?P<mapid>[^/]+)/remove$', 'map_remove',
                               name='map_remove'),
                           url(r'^(?P<mapid>[^/]+)/metadata$', 'map_metadata',
                               name='map_metadata'),
                           url(r'^(?P<mapid>[^/]+)/embed$', 'map_embed',
                               name='map_embed'),
                           url(r'^(?P<mapid>[^/]+)/history$',
                               'ajax_snapshot_history'),
                           url(r'^(?P<mapid>\d+)/thumbnail$', 'map_thumbnail',
                               name='map_thumbnail'),
                           url(
                           ...
                           url(
                               ...
                               'map_json', name='map_json'),
                           url(r'^check/$', 'map_download_check',
    ...
    urlpatterns = patterns(
        ...
        url(
            r'^new$',
            MapCreateView.as_view(),
            name='new_map'
        ),
        url(r'^$',
            TemplateView.as_view(
            template_name='new_maps/map_list.html'),
            name='maps_browse'),
    )
