...
urlpatterns = [
    ...
    url(r'^$',
        ...
        {'facet_type': 'maps'},
        name='maps_browse'),
    url(r'^add_declaracao$', views.add_declaracao_maps, name='embrapa_declaracao'),
    url(r'^add_autor$', views.add_autor_maps, name='embrapa_add_teste'),
    url(r'^save_finalidade$', views.save_finalidade_maps, name='embrapa_save_finalidade'),
