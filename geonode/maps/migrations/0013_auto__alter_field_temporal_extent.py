...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Layer.temporal_extent_end'
        db.alter_column('maps_layer', 'temporal_extent_end', self.gf('django.db.models.fields.CharField')(max_length=24, null=True))

        # Changing field 'Layer.temporal_extent_start'
        db.alter_column('maps_layer', 'temporal_extent_start', self.gf('django.db.models.fields.CharField')(max_length=24, null=True))


    def backwards(self, orm):
        
        # Changing field 'Layer.temporal_extent_end'
        db.alter_column('maps_layer', 'temporal_extent_end', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Layer.temporal_extent_start'
        db.alter_column('maps_layer', 'temporal_extent_start', self.gf('django.db.models.fields.DateField')(null=True))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 4, 13, 41, 33, 419103)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 4, 13, 41, 33, 419039)'}),
        ...
        'maps.contact': {
            ...
            'member_expiration_dt': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 12, 4, 13, 41, 33, 350193)'}),
