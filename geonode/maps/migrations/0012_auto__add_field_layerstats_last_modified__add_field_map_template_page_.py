...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Map.template_page'
        db.add_column('maps_map', 'template_page', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)

        # Changing field 'Map.urlsuffix'
        db.alter_column('maps_map', 'urlsuffix', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'Map.officialurl'
        db.alter_column('maps_map', 'officialurl', self.gf('django.db.models.fields.CharField')(default='', max_length=255))

        # Changing field 'Map.group_params'
        db.alter_column('maps_map', 'group_params', self.gf('django.db.models.fields.TextField')(default=''))
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Map.template_page'
        db.delete_column('maps_map', 'template_page')

        # Changing field 'Map.urlsuffix'
        db.alter_column('maps_map', 'urlsuffix', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Map.officialurl'
        db.alter_column('maps_map', 'officialurl', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Map.group_params'
        db.alter_column('maps_map', 'group_params', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 5, 9, 9, 44, 484300)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 8, 5, 9, 9, 44, 483993)'}),
        ...
        'maps.contact': {
            ...
            'member_expiration_dt': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 8, 5, 9, 9, 44, 194114)'}),
