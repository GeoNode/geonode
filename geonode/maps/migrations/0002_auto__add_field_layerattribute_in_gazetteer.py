...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LayerAttribute.in_gazetteer'
        db.add_column('maps_layerattribute', 'in_gazetteer', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'LayerAttribute.in_gazetteer'
        db.delete_column('maps_layerattribute', 'in_gazetteer')
    ...
    models = {
        ...
        'maps.contact': {
            ...
            'member_expiration_dt': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2012, 4, 27, 8, 48, 30, 413564)'}),
