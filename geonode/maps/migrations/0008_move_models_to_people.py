...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # move people stuff from maps to people app
        
        # 1. people_role renamed from maps_role
        ...
        # 2. people_role_permissions from maps_role_permissions
        db.rename_table('maps_role_permissions', 'people_role_permissions') 
            
        # 3. people_profile from maps_contact
