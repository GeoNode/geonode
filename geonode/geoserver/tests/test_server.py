...
class UtilsTests(GeoNodeBaseTestSupport):
    ...
    def test_ogc_server_defaults(self):
        ...
        route = resolve('/gs/rest/layers')
        self.assertIsNotNone(route)

        route = resolve('/gs/rest/imports')
        self.assertIsNotNone(route)

        route = resolve('/gs/rest/sldservice')
        self.assertIsNotNone(route)
        ...
        identifier = urllib.urlencode({'coverageid': instance.alternate.replace(':', '__', 1)})
