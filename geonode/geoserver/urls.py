...
urlpatterns = [  # 'geonode.geoserver.views',
    ...
    url(r'^(?P<layername>[^/]*)/style$',
        views.dataset_style, name="dataset_style"),
    url(r'^(?P<layername>[^/]*)/style/upload$',
        views.dataset_style_upload, name='dataset_style_upload'),
    url(r'^(?P<layername>[^/]*)/style/manage$',
        views.dataset_style_manage, name='dataset_style_manage'),
    url(r'^acls/?$', views.dataset_acls, name='dataset_acls'),
    url(r'^resolve_user/?$', views.resolve_user,
        name='dataset_resolve_user'),
