...
urlpatterns = [  # 'geonode.geoserver.views',
    ...
    url(r'^rest/br', views.geoserver_proxy, dict(proxy_path='/gs/rest/br',
                                                 downstream_path='rest/br')),
    ...
    url(r'^kml', views.geoserver_proxy, dict(proxy_path='/gs/kml',
                                             downstream_path='kml'), name='kml_endpoint'),
