            ...
            try:
                ...
                if import_session and import_session.state == enumerations.STATE_COMPLETE:
                    ...
                    if 'defaults' in kwargs:
                        ...
                        kwargs['defaults']['subtype'] = _gs_import_session_info.spatial_files_type.layer_type
                    ...
                    instance.get_real_instance().subtype = _gs_import_session_info.spatial_files_type.layer_type
