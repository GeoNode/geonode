...
texts = [
    _(
        "Flora and/or fauna in natural environment. Examples: wildlife, vegetation, biological sciences, ecology, "
    ...
    _("Boundaries"),
    _(
        "Processes and phenomena of the atmosphere. Examples: cloud cover, weather, climate, atmospheric conditions, "
        "climate change, precipitation."
    ),
    _("Climatology Meteorology Atmosphere"),
    _(
        "Economic activities, conditions and employment. Examples: production, labour, revenue, commerce, industry, "
    ...
    _("Economy"),
    _(
        "Height above or below sea level. Examples: altitude, bathymetry, digital elevation models, slope, "
        "derived products."
    ),
    _("Elevation"),
    _(
        "Environmental resources, protection and conservation. Examples: environmental pollution, waste storage and "
        "treatment, environmental impact assessment, monitoring environmental risk, nature reserves, landscape."
    ),
    _("Environment"),
    _(
        "Rearing of animals and/or cultivation of plants. Examples: agriculture, irrigation, aquaculture, "
        "plantations, herding, pests and diseases affecting crops and livestock."
    ),
    _("Farming"),
    _(
        "Information pertaining to earth sciences. Examples: geophysical features and processes, geology, minerals, "
    ...
    _(
        "Health, health services, human ecology, and safety. Examples: disease and illness, factors affecting health, "
    ...
    _("Inland Waters"),
    _(
        "Military bases, structures, activities. Examples: barracks, training grounds, military transportation, "
        "information collection."
    ),
    _("Intelligence Military"),
    _(
        "Positional information and services. Examples: addresses, geodetic networks, control points, postal zones "
        "and services, place names."
    ),
    _("Location"),
    _(
        "Features and characteristics of salt water bodies (excluding inland waters). Examples: tides, tidal waves, "
    ...
    _("Planning Cadastre"),
    _(
        "Settlements, anthropology, archaeology, education, traditional beliefs, manners and customs, demographic "
    ...
    _("Population"),
    _(
        "Characteristics of society and cultures. Examples: settlements, anthropology, archaeology, education, "
    ...
    _("Structure"),
    _(
        "Means and aids for conveying persons and/or goods. Examples: roads, airports/airstrips, shipping routes, "
        "tunnels, nautical charts, vehicle or vessel location, aeronautical charts, railways."
    ),
    _("Transportation"),
    _(
        "Energy, water and waste systems and communications infrastructure and services. Examples: hydroelectricity, "
