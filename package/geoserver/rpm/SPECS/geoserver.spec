...
JVM_OPTS='JAVA_OPTS="-Djava.awt.headless=true -Xms256m -Xmx768m -Xrs -Dgwc.context.suffix=gwc -XX:PerfDataSamplingInterval=500 -XX:MaxPermSize=128m -DGEOSERVER_CSRF_DISABLED=true"'
