...
@app.task(name='headless.tasks.inasafe_wrapper.filter_impact_function', queue='inasafe-headless')
...
@app.task(name='headless.tasks.inasafe_wrapper.run_analysis', queue='inasafe-headless')
...
@app.task(name='headless.tasks.inasafe_wrapper.read_keywords_iso_metadata', queue='inasafe-headless')
