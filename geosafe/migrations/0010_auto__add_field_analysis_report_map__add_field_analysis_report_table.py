...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Analysis.report_map'
        db.add_column(u'geosafe_analysis', 'report_map',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Analysis.report_table'
        db.add_column(u'geosafe_analysis', 'report_table',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Analysis.report_map'
        db.delete_column(u'geosafe_analysis', 'report_map')

        # Deleting field 'Analysis.report_table'
        db.delete_column(u'geosafe_analysis', 'report_table')
