...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'geosafe_analysis', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('exposure_layer', self.gf('django.db.models.fields.related.ForeignKey')(related_name='exposure_layer', to=orm['layers.Layer'])),
            ('hazard_layer', self.gf('django.db.models.fields.related.ForeignKey')(related_name='hazard_layer', to=orm['layers.Layer'])),
            ('aggregation_layer', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='aggregation_layer', null=True, to=orm['layers.Layer'])),
            ('impact_function_id', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('extent_option', self.gf('django.db.models.fields.IntegerField')(default=1)),
        ))
        db.send_create_signal(u'geosafe', ['Analysis'])


    def backwards(self, orm):
        # Deleting model 'Analysis'
        db.delete_table(u'geosafe_analysis')
    ...
    models = {
        ...
        u'geosafe.metadata': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.utcnow', 'auto_now': 'True', 'null': 'True', 'blank': 'True'}),
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['people.Profile']", 'null': 'True', 'blank': 'True'})
        },
        u'layers.layer': {
