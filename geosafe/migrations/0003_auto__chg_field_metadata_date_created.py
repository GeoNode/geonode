...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Metadata.date_created'
        db.alter_column(u'geosafe_metadata', 'date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, null=True))

    def backwards(self, orm):

        # Changing field 'Metadata.date_created'
        db.alter_column(u'geosafe_metadata', 'date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
    ...
    models = {
        ...
        u'geosafe.metadata': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['people.Profile']", 'null': 'True'})
        },
        u'layers.layer': {
