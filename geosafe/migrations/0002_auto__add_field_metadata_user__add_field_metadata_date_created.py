...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'geosafe_metadata', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['people.Profile'], null=True),
                      keep_default=False)

        # Adding field 'Metadata.date_created'
        db.add_column(u'geosafe_metadata', 'date_created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 10, 19, 0, 0), auto_now=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'geosafe.metadata': {
            ...
            'date_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 10, 19, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
