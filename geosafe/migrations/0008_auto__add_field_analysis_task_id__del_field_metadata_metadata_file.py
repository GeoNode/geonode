...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Analysis.task_id'
        db.add_column(u'geosafe_analysis', 'task_id',
                      self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Metadata.metadata_file'
        db.delete_column(u'geosafe_metadata', 'metadata_file')


    def backwards(self, orm):
        # Deleting field 'Analysis.task_id'
        db.delete_column(u'geosafe_analysis', 'task_id')

        # Adding field 'Metadata.metadata_file'
        db.add_column(u'geosafe_metadata', 'metadata_file',
