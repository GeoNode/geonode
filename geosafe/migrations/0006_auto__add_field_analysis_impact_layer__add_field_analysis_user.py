...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Analysis.impact_layer'
        db.add_column(u'geosafe_analysis', 'impact_layer',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='impact_layer', null=True, to=orm['layers.Layer']),
                      keep_default=False)

        # Adding field 'Analysis.user'
        db.add_column(u'geosafe_analysis', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['people.Profile'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Analysis.impact_layer'
        db.delete_column(u'geosafe_analysis', 'impact_layer_id')

        # Deleting field 'Analysis.user'
        db.delete_column(u'geosafe_analysis', 'user_id')
