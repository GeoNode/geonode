...
Derived resources are built from existing content already in GeoNode. Instead of uploading new data, you combine and present what you have already published as Datasets and Documents. These include **Maps**, **Dashboards**, and **GeoStories**, which are curated outputs that reference previously uploaded resources as their inputs.
...
Documents can be uploaded directly from your disk.
