...
Beware that in case of use of postgres 9.2 as described in :ref:`install_postgresql` and :ref:`install_postgis` all the postgres and postgis references must be remove from the above command.
