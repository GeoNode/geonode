...
if (window.GeoExplorer) {
    Ext.apply(GeoExplorer.prototype, {
        ...
        metaDataMapURL: gettext("Custom URL"),
        ...
        urlCharErrorLabel: gettext("URL\'s can only contain letters, numbers, dashes & underscores."),
        urlDupeErrorLabel: gettext("The following URL\'s already exist:"),
