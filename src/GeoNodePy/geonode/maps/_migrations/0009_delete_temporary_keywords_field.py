...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Layer.keywords_temp'
        db.delete_column('maps_layer', 'keywords_temp')


    def backwards(self, orm):
        
        # Adding field 'Layer.keywords_temp'
        db.add_column('maps_layer', 'keywords_temp', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)
    ...
    models = {
        ...
        'maps.layer': {
            ...
            'topic_category': ('django.db.models.fields.related.ForeignKey',[], {'to': "orm['maps.Layer']", 'null': 'True', 'blank': 'True'}),
