...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('maps_thumbnail', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('thumb_spec', self.gf('django.db.models.fields.TextField')()),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'])),
            ('object_id', self.gf('django.db.models.fields.PositiveIntegerField')()),
        ))
        db.send_create_signal('maps', ['Thumbnail'])
        ...
        # Deleting field 'Layer.keywords'
        db.delete_column('maps_layer', 'keywords')
    ...
    def backwards(self, orm):
        ...
        db.delete_table('maps_thumbnail')
        ...
        # Adding field 'Layer.keywords'
        db.add_column('maps_layer', 'keywords', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Deleting field 'Layer.bbox_left'
        db.delete_column('maps_layer', 'bbox_left')

        # Deleting field 'Layer.bbox_right'
        db.delete_column('maps_layer', 'bbox_right')

        # Deleting field 'Layer.bbox_bottom'
        db.delete_column('maps_layer', 'bbox_bottom')

        # Deleting field 'Layer.bbox_top'
        db.delete_column('maps_layer', 'bbox_top')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 31, 11, 23, 16, 513567)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 31, 11, 23, 16, 513420)'}),
