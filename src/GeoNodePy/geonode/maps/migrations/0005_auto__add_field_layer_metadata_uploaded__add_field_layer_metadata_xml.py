...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('maps_layer', 'metadata_uploaded', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Layer.metadata_xml'
        db.add_column('maps_layer', 'metadata_xml', self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Layer.metadata_uploaded'
        db.delete_column('maps_layer', 'metadata_uploaded')

        # Deleting field 'Layer.metadata_xml'
        db.delete_column('maps_layer', 'metadata_xml')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 25, 10, 24, 8, 514640)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 5, 25, 10, 24, 8, 514533)'}),
        ...
        'maps.layer': {
            ...
            'metadata_xml': ('django.db.models.fields.TextField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
