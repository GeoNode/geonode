...
urlpatterns = patterns('geonode.maps.views',
    ...
    (r'^(?P<mapid>\d+)/edit/?$', 'maps_controller'),
    (r'^(?P<mapid>\d+)/edit/describe/?$', 'describemap'),
    (r'^(?P<mapid>\d+)/download/?$', 'maps_download'),
    ...
    url(r'^(?P<mapid>\d+)/ajax-permissions/?$', 'ajax_map_permissions', name='ajax_map_perm'),
    url(r'^change-poc/(?P<ids>\w+)/?$', 'change_poc', name="change_poc", name='maps_change_poc'),
    url(r'^(?P<mapid>\d+)/ajax-permissions-email/?$', 'ajax_map_permissions_by_email', name='ajax_map_perm_email'),
    ...
    url(r'^(?P<mapid>[A-Za-z0-9_\-]+)/?$', 'view', name='maps_view'),
)
...
datapatterns = patterns('geonode.maps.views',
    ...
    url(r'^api/batch_permissions_by_email/?$', 'batch_permissions_by_email', name='data_batch_perm_email'),
