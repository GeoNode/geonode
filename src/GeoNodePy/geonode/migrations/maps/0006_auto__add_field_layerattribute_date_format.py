...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LayerAttribute.date_format'
        db.add_column('maps_layerattribute', 'date_format', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'LayerAttribute.date_format'
        db.delete_column('maps_layerattribute', 'date_format')
