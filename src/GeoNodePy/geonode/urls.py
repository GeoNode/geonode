...
urlpatterns = patterns('',
    ...
    (r'^geoserver/(?P<path>.*)','geonode.proxy.views.geoserver'),
    url(r'^data/$', 'geonode.maps.views.browse_data', name='data'),
    (r'^data/search/?$', 'geonode.maps.views.metadata_search'),
    (r'^data/search/detail', 'geonode.maps.views.search_result_detail'),
