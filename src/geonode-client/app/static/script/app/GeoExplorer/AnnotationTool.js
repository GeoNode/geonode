...
GeoExplorer.plugins.AnnotationTool = Ext
		.extend(
				gxp.plugins.Tool,
				{
					...
					addActions : function() {
						...
						function featureSelected(evt) {
							...
							if (selectAnnoControl) {
								...
								var newPanel = new Ext.Panel({
									autoLoad : {
										url : "/annotations/" + evt.feature.fid
												+ "/details",
										scripts : true
									}
								})
												...
												items : [
														{
															...
															fieldLabel : "Title",
															id : "popup_form_title",
															value : this.currentFeature
																	&& this.currentFeature.attributes["title"] ? this.currentFeature.attributes["title"]
																	: ""
														},
														{
															xtype : 'textarea',
															...
															value : this.currentFeature
																	&& this.currentFeature.attributes["content"] ? this.currentFeature.attributes["content"]
																	: ""
														} ]
											} ],
											bbar : [
						...
						return GeoExplorer.plugins.AnnotationTool.superclass.addActions
								.apply(
										this,
										[ {
											text : this.notesText,
...
Ext.preg(GeoExplorer.plugins.AnnotationTool.prototype.ptype,
		GeoExplorer.plugins.AnnotationTool);