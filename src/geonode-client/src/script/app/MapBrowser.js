var MapBrowser = Ext.extend(Page, {
    ...
    /**
     *  The default store preprocessor method; doesn't modify the map store at
     *  all. Subclasses should override to provide more specific map listings.
     */
